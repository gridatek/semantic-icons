...
@Component({
  selector: 'svg[si-face-grin-tongue-squint-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiFaceGrinTongueSquintIcon {
