...
@Component({
  selector: 'svg[si-face-grin-beam-sweat-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiFaceGrinBeamSweatIcon {
