...
@Component({
  ...
  template: `
    ...
    <svg:path
      fill="currentColor"
      d="M320 112C205.1 112 112 205.1 112 320C112 434.9 205.1 528 320 528C434.9 528 528 434.9 528 320C528 205.1 434.9 112 320 112zM576 320C576 461.4 461.4 576 320 576C178.6 576 64 461.4 64 320C64 178.6 178.6 64 320 64C461.4 64 576 178.6 576 320zM216 416C216 427.9 224.6 437.8 236 439.7L236 392.4C224.6 394.3 216 404.2 216 416.1zM300 440L300 392L276 392L276 440L300 440zM364 440L364 392L340 392L340 440L364 440zM404 439.7C415.4 437.8 424 427.9 424 416C424 404.1 415.4 394.2 404 392.3L404 439.6zM240 352L400 352C435.3 352 464 380.7 464 416C464 451.3 435.3 480 400 480L240 480C204.7 480 176 451.3 176 416C176 380.7 204.7 352 240 352zM240 240C257.7 240 272 254.3 272 272C272 289.7 257.7 304 240 304C222.3 304 208 289.7 208 272C208 254.3 222.3 240 240 240zM368 272C368 254.3 382.3 240 400 240C417.7 240 432 254.3 432 272C432 289.7 417.7 304 400 304C382.3 304 368 289.7 368 272z"
    />
  `,
  host: {
    '[attr.xmlns]': 'xmlns',
