...
@Component({
  selector: 'svg[si-creative-commons-nc-eu-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiCreativeCommonsNcEuIcon {
