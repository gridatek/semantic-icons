...
@Component({
  selector: 'svg[si-odnoklassniki-square-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiOdnoklassnikiSquareIcon {
