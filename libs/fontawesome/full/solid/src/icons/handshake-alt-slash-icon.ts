...
@Component({
  selector: 'svg[si-handshake-alt-slash-icon]',
  standalone: true,
  imports: [],
  template: `
    ...
    <svg:path
      fill="currentColor"
      d="M73 39.1C63.6 29.7 48.4 29.7 39.1 39.1C29.8 48.5 29.7 63.7 39 73.1L567 601.1C576.4 610.5 591.6 610.5 600.9 601.1C610.2 591.7 610.3 576.5 600.9 567.2L312.9 279.2L327.1 265C331.3 260.8 336.6 258.5 342 258.1C348.8 257.5 355.8 259.8 361 265L537.6 440L608 384L608 96L496 160L472.2 144.1C456.4 133.6 437.9 128 418.9 128L348.5 128C347.4 128 346.2 128 345.1 128.1C328.2 129 312.3 136.6 300.9 149.2L245.1 211.3L211.1 177.3L255.4 128.1L215.7 128.1C200.4 128.1 185.6 131.7 172.2 138.5L73 39.1zM32 133.8L32 384L188.4 514.3C211.4 533.5 240.4 544 270.3 544L286 544L279 537C269.6 527.6 269.6 512.4 279 503.1C288.4 493.8 303.6 493.7 312.9 503.1L353.9 544.1L362.9 544.1C385.1 544.1 406.7 538.3 425.7 527.7L32 133.8z"
    />
  `,
  host: {
    '[attr.xmlns]': 'xmlns',
...
export class SiHandshakeAltSlashIcon {
