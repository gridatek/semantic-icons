...
@Component({
  selector: 'svg[si-person-military-pointing-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiPersonMilitaryPointingIcon {
