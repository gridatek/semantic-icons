...
@Component({
  selector: 'svg[si-tent-arrow-left-right-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiTentArrowLeftRightIcon {
