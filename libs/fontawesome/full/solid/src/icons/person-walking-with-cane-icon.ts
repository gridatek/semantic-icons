...
@Component({
  selector: 'svg[si-person-walking-with-cane-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiPersonWalkingWithCaneIcon {
