...
@Component({
  selector: 'svg[si-road-circle-exclamation-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiRoadCircleExclamationIcon {
