...
@Component({
  selector: 'svg[si-smoking-ban-icon]',
  standalone: true,
  imports: [],
  template: `
    ...
    <svg:path
      fill="currentColor"
      d="M163.5 208.8L242.7 288L192 288C174.3 288 160 302.3 160 320L160 352C160 369.7 174.3 384 192 384L338.7 384L431.2 476.5C399.8 498.9 361.4 512 320 512C214 512 128 426 128 320C128 278.5 141.1 240.1 163.5 208.8zM397.3 352L365.3 320L448 320L448 352L397.3 352zM429.3 384L448 384C465.7 384 480 369.7 480 352L480 320C480 302.3 465.7 288 448 288L333.3 288L208.8 163.5C240.2 141.1 278.6 128 320 128C426 128 512 214 512 320C512 361.5 498.9 399.9 476.5 431.2L429.3 384zM320 576C461.4 576 576 461.4 576 320C576 178.6 461.4 64 320 64C178.6 64 64 178.6 64 320C64 461.4 178.6 576 320 576zM336 160C327.2 160 320 167.2 320 176C320 202.5 341.5 224 368 224L400 224C408.8 224 416 231.2 416 240C416 248.8 423.2 256 432 256C440.8 256 448 248.8 448 240C448 213.5 426.5 192 400 192L368 192C359.2 192 352 184.8 352 176C352 167.2 344.8 160 336 160z"
    />
  `,
  host: {
    '[attr.xmlns]': 'xmlns',
