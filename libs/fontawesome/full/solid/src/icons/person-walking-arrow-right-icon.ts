...
@Component({
  selector: 'svg[si-person-walking-arrow-right-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiPersonWalkingArrowRightIcon {
