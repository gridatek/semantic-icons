...
@Component({
  selector: 'svg[si-person-dots-from-line-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiPersonDotsFromLineIcon {
