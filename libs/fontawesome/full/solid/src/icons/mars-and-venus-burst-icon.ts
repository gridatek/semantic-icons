...
@Component({
  selector: 'svg[si-mars-and-venus-burst-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiMarsAndVenusBurstIcon {
