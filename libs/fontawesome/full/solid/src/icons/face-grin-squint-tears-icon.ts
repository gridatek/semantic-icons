...
@Component({
  selector: 'svg[si-face-grin-squint-tears-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiFaceGrinSquintTearsIcon {
