...
@Component({
  selector: 'svg[si-microphone-lines-slash-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiMicrophoneLinesSlashIcon {
