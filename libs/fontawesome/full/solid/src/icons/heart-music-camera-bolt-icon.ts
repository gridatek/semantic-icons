...
@Component({
  selector: 'svg[si-heart-music-camera-bolt-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiHeartMusicCameraBoltIcon {
