...
@Component({
  selector: 'svg[si-sort-numeric-down-alt-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiSortNumericDownAltIcon {
