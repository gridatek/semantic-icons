...
@Component({
  selector: 'svg[siPlugCircleExclamationIcon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiPlugCircleExclamationIcon {
