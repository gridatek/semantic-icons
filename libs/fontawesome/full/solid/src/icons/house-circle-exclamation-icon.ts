...
@Component({
  selector: 'svg[si-house-circle-exclamation-icon]',
  standalone: true,
  imports: [],
  template: `
    ...
    <svg:path
      fill="currentColor"
      d="M496 608C416.5 608 352 543.5 352 464C352 384.5 416.5 320 496 320C575.5 320 640 384.5 640 464C640 543.5 575.5 608 496 608zM268.6 70.5C280.8 61.2 298.3 61.8 309.8 72.5L527.4 274.5C517.2 272.8 506.7 271.9 496.1 271.9C417.5 271.9 350 319.1 320.3 386.7C315.2 384.9 309.8 383.9 304.1 383.9L272.1 383.9C245.6 383.9 224.1 405.4 224.1 431.9L224.1 527.9L315.1 527.9C321.2 545.2 329.7 561.3 340.2 575.9L144 576C108.7 576 80 547.3 80 512L80 336L64 336C50.8 336 39 327.9 34.2 315.7C29.4 303.5 32.6 289.5 42.2 280.6L266.2 72.6L268.6 70.6zM496 508C485 508 476 517 476 528C476 539 485 548 496 548C507 548 516 539 516 528C516 517 507 508 496 508zM496 368C487.2 368 480 375.2 480 384L480 464C480 472.8 487.2 480 496 480C504.8 480 512 472.8 512 464L512 384C512 375.2 504.8 368 496 368z"
    />
  `,
  host: {
    '[attr.xmlns]': 'xmlns',
...
export class SiHouseCircleExclamationIcon {
