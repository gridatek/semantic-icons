...
@Component({
  selector: 'svg[si-tent-arrow-down-to-line-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiTentArrowDownToLineIcon {
