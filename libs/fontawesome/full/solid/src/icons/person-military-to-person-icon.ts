...
@Component({
  selector: 'svg[siPersonMilitaryToPersonIcon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiPersonMilitaryToPersonIcon {
