...
@Component({
  selector: 'svg[si-bridge-circle-exclamation-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiBridgeCircleExclamationIcon {
