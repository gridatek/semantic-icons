...
@Component({
  selector: 'svg[si-person-arrow-down-to-line-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiPersonArrowDownToLineIcon {
