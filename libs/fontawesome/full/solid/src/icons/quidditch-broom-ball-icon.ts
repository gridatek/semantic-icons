...
@Component({
  selector: 'svg[si-quidditch-broom-ball-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiQuidditchBroomBallIcon {
