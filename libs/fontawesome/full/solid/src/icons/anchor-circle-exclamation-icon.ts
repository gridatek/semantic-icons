...
@Component({
  selector: 'svg[si-anchor-circle-exclamation-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiAnchorCircleExclamationIcon {
