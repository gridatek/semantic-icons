...
@Component({
  selector: 'svg[si-school-circle-exclamation-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiSchoolCircleExclamationIcon {
