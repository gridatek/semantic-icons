...
@Component({
  selector: 'svg[si-arrows-up-down-left-right-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiArrowsUpDownLeftRightIcon {
