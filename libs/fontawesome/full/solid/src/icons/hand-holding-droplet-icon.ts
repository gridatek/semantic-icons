...
@Component({
  selector: 'svg[si-hand-holding-droplet-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiHandHoldingDropletIcon {
