...
@Component({
  selector: 'svg[siPersonWalkingDashedLineArrowRightIcon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiPersonWalkingDashedLineArrowRightIcon {
