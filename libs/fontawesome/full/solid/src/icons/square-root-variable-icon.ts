...
@Component({
  selector: 'svg[si-square-root-variable-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiSquareRootVariableIcon {
