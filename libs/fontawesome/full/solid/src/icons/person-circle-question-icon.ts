...
@Component({
  selector: 'svg[si-person-circle-question-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiPersonCircleQuestionIcon {
