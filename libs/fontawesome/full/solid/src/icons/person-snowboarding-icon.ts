...
@Component({
  selector: 'svg[si-person-snowboarding-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiPersonSnowboardingIcon {
