...
@Component({
  selector: 'svg[siBatteryThreeQuartersIcon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiBatteryThreeQuartersIcon {
