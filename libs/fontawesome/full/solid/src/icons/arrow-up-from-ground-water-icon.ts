...
@Component({
  selector: 'svg[si-arrow-up-from-ground-water-icon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiArrowUpFromGroundWaterIcon {
