...
@Component({
  selector: 'svg[siMichelinBibGourmandIcon]',
  standalone: true,
  imports: [],
  template: `
    ...
    />
    <svg:path d="M8 11a1 2 0 1 0 2 0a1 2 0 1 0 -2 0" />
    <svg:path d="M14 11a1 2 0 1 0 2 0a1 2 0 1 0 -2 0" />
...
export class SiMichelinBibGourmandIcon {
