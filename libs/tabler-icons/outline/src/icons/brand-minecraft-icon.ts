...
@Component({
  selector: 'svg[si-brand-minecraft-icon]',
  standalone: true,
  imports: [],
  template: `
    ...
    <svg:path d="M12 17l3.003 -1.668m3 -1.667l2.997 -1.665m-9 5l-9 -5" />
    <svg:path d="M15 17l3 -1.67v-3l-3 1.67l0 3" />
  `,
  host: {
    role: 'img',
    '[attr.xmlns]': 'xmlns',
...
export class SiBrandMinecraftIcon {
