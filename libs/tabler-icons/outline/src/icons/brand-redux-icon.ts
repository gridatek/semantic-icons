...
@Component({
  ...
  template: `
    ...
    />
    <svg:path d="M8.5 15.5a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" />
    <svg:path d="M14.5 14a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" />
  `,
  host: {
    role: 'img',
    '[attr.xmlns]': 'xmlns',
