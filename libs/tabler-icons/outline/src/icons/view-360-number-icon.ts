...
@Component({
  selector: 'svg[si-view-360-number-icon]',
  standalone: true,
  imports: [],
  template: `
    ...
    />
    <svg:path d="M17 7v4a2 2 0 1 0 4 0v-4a2 2 0 1 0 -4 0" />
    <svg:path d="M3 16c0 1.657 4.03 3 9 3s9 -1.343 9 -3" />
  `,
  host: {
    role: 'img',
    '[attr.xmlns]': 'xmlns',
...
export class SiView360NumberIcon {
