...
@Component({
  selector: 'svg[siBrandDiscordIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:path stroke="none" d="M0 0h24v24H0z" fill="none" />
    <svg:path d="M8 12a1 1 0 1 0 2 0a1 1 0 0 0 -2 0" />
    <svg:path d="M14 12a1 1 0 1 0 2 0a1 1 0 0 0 -2 0" />
    <svg:path
    ...
    />
    <svg:path d="M7 16.5c3.5 1 6.5 1 10 0" />
  `,
  host: {
    role: 'img',
...
export class SiBrandDiscordIcon {
