...
@Component({
  selector: 'svg[si-sitemap-off-icon]',
  standalone: true,
  imports: [],
  template: `
    ...
    />
    <svg:path d="M9 5a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v2a2 2 0 0 1 -2 2" />
    <svg:path d="M6 15v-1a2 2 0 0 1 2 -2h4m4 0a2 2 0 0 1 2 2" />
