...
@Component({
  selector: 'svg[si-shopping-cart-heart-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:path stroke="none" d="M0 0h24v24H0z" fill="none" />
    <svg:path d="M4 19a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" />
    <svg:path d="M10 17h-4v-14h-2" />
    <svg:path d="M6 5l14 1l-.717 5.016m-7.783 1.984h-5.5" />
    <svg:path
...
export class SiShoppingCartHeartIcon {
