...
@Component({
  selector: 'svg[siBrandAdobeAfterEffectsIcon]',
  standalone: true,
  imports: [],
  template: `
    ...
    />
    <svg:path
      d="M13.895 12.824v1.07a1.895 1.895 0 0 0 3.54 .942m-3.54 -2.012v-.824a1.895 1.895 0 1 1 3.79 0v.824l-3.79 0"
    />
  `,
  host: {
    role: 'img',
...
export class SiBrandAdobeAfterEffectsIcon {
