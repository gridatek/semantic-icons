...
@Component({
  selector: 'svg[siHandThreeFingersIcon]',
  standalone: true,
  imports: [],
  template: `
    ...
    />
    <svg:path d="M11 5.5v-2a1.5 1.5 0 1 1 3 0v8.5" />
    <svg:path d="M14 5.5a1.5 1.5 0 0 1 3 0v6.5" />
  `,
  host: {
    role: 'img',
    '[attr.xmlns]': 'xmlns',
...
export class SiHandThreeFingersIcon {
