...
@Component({
  selector: 'svg[si-file-type-sql-icon]',
  standalone: true,
  imports: [],
  template: `
    ...
    <svg:path d="M18 15v6h2" />
    <svg:path d="M13 15a2 2 0 0 1 2 2v2a2 2 0 1 1 -4 0v-2a2 2 0 0 1 2 -2" />
    <svg:path d="M14 20l1.5 1.5" />
  `,
  host: {
    role: 'img',
    '[attr.xmlns]': 'xmlns',
...
export class SiFileTypeSqlIcon {
