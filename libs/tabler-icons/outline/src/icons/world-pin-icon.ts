...
@Component({
  selector: 'svg[si-world-pin-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:path stroke="none" d="M0 0h24v24H0z" fill="none" />
    <svg:path d="M20.972 11.291a9 9 0 1 0 -8.322 9.686" />
    <svg:path d="M3.6 9h16.8" />
    <svg:path d="M3.6 15h8.9" />
    <svg:path d="M11.5 3a17 17 0 0 0 0 18" />
    <svg:path d="M12.5 3a16.986 16.986 0 0 1 2.578 9.018" />
    <svg:path
