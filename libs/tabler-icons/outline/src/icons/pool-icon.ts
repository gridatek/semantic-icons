...
@Component({
  ...
  template: `
    ...
    />
    <svg:path d="M15 12v-7.5a1.5 1.5 0 0 1 3 0" />
    <svg:path d="M9 12v-7.5a1.5 1.5 0 0 0 -3 0" />
    <svg:path d="M15 5l-6 0" />
    <svg:path d="M9 10l6 0" />
  `,
  host: {
    role: 'img',
    '[attr.xmlns]': 'xmlns',
