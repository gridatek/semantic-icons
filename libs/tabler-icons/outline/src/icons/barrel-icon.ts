...
@Component({
  ...
  template: `
    ...
    />
    <svg:path d="M14 4c.667 2.667 1 5.333 1 8s-.333 5.333 -1 8" />
    <svg:path d="M10 4c-.667 2.667 -1 5.333 -1 8s.333 5.333 1 8" />
    <svg:path d="M4.5 16h15" />
    <svg:path d="M19.5 8h-15" />
  `,
  host: {
    role: 'img',
    '[attr.xmlns]': 'xmlns',
