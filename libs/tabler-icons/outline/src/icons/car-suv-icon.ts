...
@Component({
  selector: 'svg[siCarSuvIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:path stroke="none" d="M0 0h24v24H0z" fill="none" />
    <svg:path d="M5 17a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" />
    <svg:path d="M16 17a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" />
    <svg:path
