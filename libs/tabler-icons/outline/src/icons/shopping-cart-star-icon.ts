...
@Component({
  selector: 'svg[si-shopping-cart-star-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:path stroke="none" d="M0 0h24v24H0z" fill="none" />
    <svg:path d="M4 19a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" />
    <svg:path d="M9.5 17h-3.5v-14h-2" />
    <svg:path d="M6 5l14 1l-.615 4.302m-6.885 2.698h-6.5" />
    <svg:path
...
export class SiShoppingCartStarIcon {
