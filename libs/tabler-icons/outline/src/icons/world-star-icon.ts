...
@Component({
  selector: 'svg[si-world-star-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:path stroke="none" d="M0 0h24v24H0z" fill="none" />
    <svg:path d="M21 12a9 9 0 1 0 -9.968 8.948" />
    <svg:path d="M3.6 9h16.8" />
    <svg:path d="M3.6 15h6.4" />
    <svg:path d="M11.5 3a17.001 17.001 0 0 0 -1.886 13.802" />
    <svg:path d="M12.5 3a16.982 16.982 0 0 1 2.549 8.01" />
    <svg:path
