...
@Component({
  selector: 'svg[si-library-photo-icon]',
  standalone: true,
  imports: [],
  template: `
    ...
    <svg:path d="M7 13l3.644 -3.644a1.21 1.21 0 0 1 1.712 0l3.644 3.644" />
    <svg:path d="M15 12l1.644 -1.644a1.21 1.21 0 0 1 1.712 0l2.644 2.644" />
  `,
  host: {
    role: 'img',
    '[attr.xmlns]': 'xmlns',
...
export class SiLibraryPhotoIcon {
