...
@Component({
  selector: 'svg[si-mood-pin-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:path stroke="none" d="M0 0h24v24H0z" fill="none" />
    <svg:path d="M21 12a9 9 0 1 0 -8.352 8.977" />
    <svg:path d="M9 10h.01" />
    <svg:path d="M15 10h.01" />
    <svg:path d="M9.5 15c.658 .672 1.56 1 2.5 1c.102 0 .203 -.004 .304 -.012" />
    <svg:path
