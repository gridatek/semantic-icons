...
@Component({
  ...
  template: `
    ...
    />
    <svg:path d="M3 16l5 -5c.928 -.893 2.072 -.893 3 0l3.993 3.993" />
    <svg:path d="M14 14l1 -1c.47 -.452 .995 -.675 1.52 -.67" />
    <svg:path
