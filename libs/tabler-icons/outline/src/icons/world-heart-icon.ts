...
@Component({
  selector: 'svg[si-world-heart-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:path stroke="none" d="M0 0h24v24H0z" fill="none" />
    <svg:path d="M21 12a9 9 0 1 0 -9.679 8.974" />
    <svg:path d="M3.6 9h16.8" />
    <svg:path d="M3.6 15h6.9" />
    <svg:path d="M11.5 3a17 17 0 0 0 0 18" />
    <svg:path d="M12.5 3a16.983 16.983 0 0 1 2.556 8.136" />
    <svg:path
