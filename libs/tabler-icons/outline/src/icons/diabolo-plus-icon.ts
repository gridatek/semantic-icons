...
@Component({
  selector: 'svg[si-diabolo-plus-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:path stroke="none" d="M0 0h24v24H0z" fill="none" />
    <svg:path d="M4 6a8 3 0 1 0 16 0a8 3 0 1 0 -16 0" />
    <svg:path
    ...
    />
    <svg:path d="M6 12c0 1.105 2.686 2 6 2s6 -.895 6 -2" />
    <svg:path d="M16 19h6" />
    <svg:path d="M19 16v6" />
  `,
  host: {
...
export class SiDiaboloPlusIcon {
