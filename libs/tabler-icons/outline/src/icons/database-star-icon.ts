...
@Component({
  selector: 'svg[si-database-star-icon]',
  standalone: true,
  imports: [],
  template: `
    ...
    />
    <svg:path d="M4 6v6c0 1.43 2.67 2.627 6.243 2.927" />
    <svg:path d="M20 10.5v-4.5" />
    <svg:path d="M4 12v6c0 1.546 3.12 2.82 7.128 2.982" />
    <svg:path
...
export class SiDatabaseStarIcon {
