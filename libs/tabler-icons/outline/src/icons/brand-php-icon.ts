...
@Component({
  selector: 'svg[si-brand-php-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:path stroke="none" d="M0 0h24v24H0z" fill="none" />
    <svg:path d="M2 12a10 9 0 1 0 20 0a10 9 0 1 0 -20 0" />
    <svg:path
    ...
    />
    <svg:path d="M12 7.5l-1 5.5" />
    <svg:path d="M11.6 10h2.4l-.5 3" />
  `,
  host: {
    role: 'img',
    '[attr.xmlns]': 'xmlns',
