...
@Component({
  selector: 'svg[siWatchSquareAlarmIcon]',
  standalone: true,
  imports: [],
  template: `
    ...
    <svg:path d="M12 10v2l1 1" />
    <svg:path d="M2 16c0 2.1 1.1 4 2.7 5" />
    <svg:path d="M22 8c0-2.1-1.1-4-2.7-5" />
  `,
  host: {
...
export class SiWatchSquareAlarmIcon {
