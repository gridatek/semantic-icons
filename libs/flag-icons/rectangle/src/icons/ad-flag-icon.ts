...
@Component({
  ...
  template: `
    ...
    <svg:path fill="#fedf00" d="M0 0h435.2v480H0z" />
    <svg:path fill="#0018a8" d="M0 0h204.8v480H0z" />
    <svg:path
      fill="#c7b37f"
    ...
    <svg:g fill="none" stroke="#703d29">
      ...
      <svg:g stroke-width=".6">
        ...
        />
        <svg:path stroke-linecap="round" d="M314.4 332.6a10 10 0 0 1-2.2 4.2" />
        <svg:path
        ...
        />
        <svg:path d="m339 336.6-.7 1.2-1.1 1-1.7.7h-1.6" />
        <svg:path
        ...
        />
        <svg:path d="M408.4 265.3a3.9 3.9 0 1 0-6.3 2.4" />
        <svg:path
          stroke-linecap="round"
        ...
        />
        <svg:path d="M385.1 224.1c-2.3.8-3.9 4.2-3.9 7.5a8 8 0 0 0 4 7.5" />
        <svg:path
          stroke-linecap="round"
          d="M387.6 236.4c-4 5.1-6.3 8.1-6.4 14.1 0 5.7 1.7 9.6 5.1 13.7"
        />
        <svg:path
          d="m365.9 152 .3-.5c1.7-2.4 4.7-3.1 6.9-1.5 2.6 2 3.3 5.4 2.6 9q-.9 3.3-4 5.5"
        />
        <svg:path
          stroke-linecap="round"
        ...
        />
        <svg:path
          d="M258.6 152a6 6 0 0 0-8.3 1.6 9 9 0 0 0-1.6 6.1c.2 4.2 2.8 7.6 5.8 9.2"
        />
        <svg:path
        ...
        />
        <svg:path
          d="M232.2 261.4a4 4 0 0 1 3.7-3 3.7 3.7 0 0 1 3.6 3.7 4 4 0 0 1-1 2.6"
        />
        <svg:path d="M239.4 261.3a16 16 0 0 0 6.2-12.4c0-4.1-1.6-8.4-3.6-10" />
        <svg:path stroke-linecap="round" d="M244.7 259.4a17 17 0 0 1-6.3 6" />
        <svg:path
        ...
        />
        <svg:path
          d="M390.1 154.8c3.2 0 6 3.6 6 7.2 0 4.3-2.2 6.9-3.9 8.8q-1.9 2.3-4.4 4.7"
        />
        <svg:path
          stroke-linecap="round"
        ...
        />
        <svg:path d="M234.6 260.7c2.1 0 4.1 2 4.1 4.2a4 4 0 0 1-1.4 3" />
        <svg:path
          stroke-linecap="round"
          d="M254 239.5a18 18 0 0 1 3.8 7.7m0 8.5a17 17 0 0 1-1.5 4 18 18 0 0 1-3.6 4.7"
        />
        <svg:path d="M254.3 224.3q2.7 2.2 3.5 4.8" />
        <svg:path
          stroke-linecap="round"
        ...
        />
        <svg:path stroke-linecap="round" d="M253 189.8c-.3 1.3-1 2.9-3 2.7" />
        <svg:path
    ...
    <svg:g fill="#fedf00" transform="matrix(.64 0 0 .64 0 16)">
    ...
    <svg:g fill="#d52b1e">
      <svg:path fill="#fedf00" d="M322.3 175.5h52.6V228h-52.6z" />
      <svg:path
    ...
    <svg:g transform="matrix(.64 0 0 .64 0 16)">
      <svg:path
        fill="#fedf00"
