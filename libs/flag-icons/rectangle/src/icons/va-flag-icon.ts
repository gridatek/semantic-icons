...
@Component({
  ...
  template: `
    ...
    <svg:g stroke="#000" stroke-linejoin="round" stroke-width="3.2">
      <svg:g
        fill="#ce9d09"
      ...
      <svg:g fill="#ccc" transform="translate(123)scale(.192)">
        <svg:g id="va-b">
          <svg:path
          ...
          />
          <svg:path d="m1494.7 985.4-.6 30 15.6-15.3z" />
          <svg:path
            fill="none"
          ...
          />
          <svg:circle cx="2154.7" cy="1480.1" r="129.7" />
          <svg:path
            fill="#fff"
          ...
          />
          <svg:circle cx="2154.7" cy="1446.1" r="14.6" />
          <svg:circle cx="2189.4" cy="1480.1" r="14.6" />
          <svg:circle cx="2155.3" cy="1511.2" r="14.6" />
          <svg:circle cx="2119.3" cy="1480.1" r="14.6" />
          <svg:path
            fill="#fff"
        ...
        <svg:g fill="#ce9d09">
          <svg:g id="va-c">
            ...
            />
            <svg:circle cx="1457.3" cy="865.3" r="16" />
            <svg:path
            ...
            />
            <svg:circle cx="2254.5" cy="1375.4" r="17.7" />
            <svg:circle cx="2260.6" cy="1580" r="17.7" />
            <svg:circle cx="2062.1" cy="1591.6" r="17.7" />
          </svg:g>
        </svg:g>
      </svg:g>
      <svg:g fill="#ce9d09" transform="matrix(-.192 0 0 .192 837 0)">
        <svg:use xlink:href="#va-b" width="100%" height="100%" />
        <svg:use xlink:href="#va-c" width="100%" height="100%" fill="#ccc" />
      </svg:g>
      <svg:g fill="#fa0204" transform="translate(123)scale(.192)">
        <svg:path
          id="va-d"
      ...
      <svg:g transform="translate(123)scale(.192)">
        <svg:path
          fill="#fa0204"
        ...
        />
        <svg:circle cx="1872.9" cy="1723" r="12.9" fill="#ce9d09" />
        <svg:path
          fill="#fa0204"
      ...
      <svg:g transform="translate(123)scale(.192)">
        ...
        />
        <svg:circle cx="1843.4" cy="1738.3" r="12.9" fill="#ce9d09" />
        <svg:path
          fill="#ce9d09"
