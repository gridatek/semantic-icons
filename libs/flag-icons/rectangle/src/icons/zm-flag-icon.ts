  ...
  template: `
    <svg:defs>
      <svg:clipPath id="zm-a">
        <svg:path fill-opacity=".7" d="M-170.7 0H512v512h-682.7z" />
      </svg:clipPath>
    </svg:defs>
    <svg:g
      fill-rule="evenodd"
    ...
    >
      <svg:path fill="#198a00" d="M-256 0h768v512h-768z" />
      <svg:path fill="#ef7d00" d="M421.9 184H512v328h-90.1z" />
      <svg:path fill="#000001" d="M331.9 183.8h90v328h-90z" />
      <svg:path fill="#de2010" d="M240 184h91.9v328h-92z" />
