...
@Component({
  ...
  template: `
    <svg:g font-size="12">
      <svg:path fill="#fff" fill-rule="evenodd" d="M0 0h640v480H0z" />
      <svg:path fill="#09c" d="M640 410.1 91.7-.1H0v68.4L550.4 480H640z" />
    </svg:g>
    <svg:g font-size="12">
      <svg:path
        fill="#005bbf"
      ...
      <svg:path
        ...
        transform="matrix(1.06667 0 0 1.06758 0 -76)"
      />
      <svg:path fill="#fff" d="m315.7 176-7.4 3.8 6.7 4.3 8-4z" />
      <svg:path
        fill="none"
        stroke="#000"
        stroke-width=".5"
      ...
      <svg:path
        ...
        transform="matrix(1.06667 0 0 1.06758 0 -76)"
      />
      <svg:path fill="red" d="m273 188.5 4.5-3.7-5-1s.7.8.6 1.5v3.2" />
      <svg:path
        fill="none"
        stroke="#000"
        stroke-width=".5"
      ...
      <svg:path
        ...
        transform="matrix(1.06667 0 0 1.06758 0 -76)"
      />
      <svg:path fill="red" d="m315.7 177.9-4 2 3.6 2.2 4.3-2z" />
      <svg:path
        fill="none"
        stroke="#000"
        stroke-width=".5"
