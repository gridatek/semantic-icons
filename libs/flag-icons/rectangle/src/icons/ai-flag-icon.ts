...
@Component({
  ...
  template: `
    ...
    <svg:path
      ...
      clip-path="url(#ai-a)"
    />
    <svg:path stroke="#fff" stroke-width="75" d="M160 0v280M0 120h373.3" />
    <svg:path stroke="#c8102e" stroke-width="50" d="M160 0v280M0 120h373.3" />
    <svg:path fill="#012169" d="M0 240h320V0h106.7v320H0z" />
    <svg:path
      fill="#fff"
