...
@Component({
  ...
  template: `
    ...
    >
      <svg:path fill="#0000d6" d="M0 507.2 987.4 0H0z" />
      <svg:path fill="#006000" d="M1024 0 27.2 512H1024z" />
      <svg:path fill="#fc0" d="M1024 0h-54.9L0 485.4V512h54.9L1024 27.6z" />
      <svg:path
        fill="#fff"
