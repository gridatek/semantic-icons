...
@Component({
  ...
  template: `
    ...
    <svg:g stroke="#000" stroke-width="2.5">
      <svg:path
        fill="#a77b3b"
        fill-rule="evenodd"
    ...
    />
    <svg:path fill="red" fill-rule="evenodd" d="M248.1 175.6h146.5v70H248.1z" />
    <svg:path
      fill="#564dff"
      fill-rule="evenodd"
    ...
    />
    <svg:g fill="#ff0" fill-rule="evenodd" stroke="#000" stroke-width=".5">
      <svg:path
