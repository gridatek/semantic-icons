...
@Component({
  ...
  template: `
    ...
    <svg:path fill="#bd1021" d="m-.6 240 640-240v480Z" />
    <svg:path fill="#fff" d="m59.7 240 580-214.3v428.6" />
    <svg:path
    ...
    />
    <svg:path fill="#5a3719" d="M582.1 286s0 1 .9 2.2l-45.2-1.3s.6-.4.8-2.2z" />
    <svg:path
      fill="#ffc221"
    ...
    />
    <svg:path d="M556.4 201.3s-1.5 1.1.5.6 5.9-1.4 5.2-2.4-3.4.2-5.7 1.8" />
    <svg:path
      fill="#7b3c20"
