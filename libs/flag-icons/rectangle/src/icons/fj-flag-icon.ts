...
@Component({
  ...
  imports: [],
  template: `
    <svg:path fill="#68bfe5" d="M0 0v480h640V0z" />
    <svg:g stroke-miterlimit="4.8">
      ...
      />
      <svg:path fill="#d21034" d="M420.9 193.2H582V246H420.8z" />
      <svg:g stroke-miterlimit="3">
        ...
        />
        <svg:path
          d="M432.4 231.7c-.8.6-.7 2.2-.7 2.3h.3s0-1.6.6-2q.4-.3 1 0l.1-.4q-.8-.3-1.3 0z"
        />
        <svg:g transform="translate(-96.9 97.5)scale(.66486)">
          <svg:path
      ...
      <svg:g stroke="#000" stroke-width=".5">
        ...
        />
        <svg:path
          d="M548.7 276.5q-.1 1.6-1.4 1.6-1.3-.1-1.4-1.6.1-1.5 1.4-1.6 1.3.1 1.4 1.6z"
        />
        <svg:path
          d="M546.4 278q-.1 1.5-1.4 1.6-1.3-.1-1.4-1.6.1-1.5 1.4-1.6 1.3.1 1.4 1.6z"
        />
        <svg:path
          d="M548.5 279.3q-.1 1.4-1.4 1.6-1.2-.1-1.4-1.6.2-1.6 1.4-1.7 1.3.1 1.4 1.6z"
        />
      </svg:g>
      <svg:path
        fill="#00a651"
      ...
      />
      <svg:path d="m443 341.3.2 2.2h.4l-.3-2.2 1-4.9h-.4l-1 4.9z" />
      <svg:path
      ...
      <svg:path
        d="M450 359.6s-.7 1.2-.3 2c.3.7 2 1 2.1 2s.8 1 1.5 1l.9-.3s-3.1-1.6-4-4.3z"
      />
      <svg:g fill="#964b36" stroke="#000" stroke-width=".5">
        ...
        />
        <svg:path d="M528.2 370.4s-1.6 1.6-.9 2 2.1 0 2.1-.6-1-1.6-1.2-1.4z" />
        <svg:path
