...
@Component({
  ...
  template: `
    ...
    />
    <svg:path fill="#fff" d="M476.4 153.6s1.4-2.5 6-2c0 0-1.3 3.6-6 2" />
    <svg:ellipse cx="479.4" cy="152.8" fill="#784421" rx=".8" ry="1.1" />
    <svg:ellipse cx="479.4" cy="152.8" rx=".5" ry=".7" />
    <svg:path
    ...
    />
    <svg:path fill="#fff" d="M470.8 153.6s-1.5-2.5-6-2c0 0 1.2 3.6 6 2" />
    <svg:ellipse cx="467.7" cy="152.8" fill="#784421" rx=".8" ry="1.1" />
    <svg:ellipse cx="467.7" cy="152.8" rx=".5" ry=".7" />
    <svg:path
      fill="none"
      stroke="#000"
      stroke-width="1.2"
    ...
    />
    <svg:path fill="#006" d="M0 0h320v240H0z" />
    <svg:path
      fill="#fff"
