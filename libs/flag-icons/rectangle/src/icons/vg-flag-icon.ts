...
@Component({
  ...
  template: `
    ...
    <svg:g transform="translate(-217.5 -9.4)scale(.77497)">
      <svg:path
        fill="#fff"
      ...
      />
      <svg:g id="vg-b" fill="#ffc72c" stroke="#000" stroke-width=".9">
        <svg:path
          fill="none"
          stroke="#ffc72c"
          stroke-width="1.9"
        ...
        />
        <svg:path d="M831.7 174a2.8 2.8 0 1 1-5.6 0 2.8 2.8 0 0 1 5.6 0z" />
        <svg:path
        ...
        />
        <svg:path d="M810.7 182s1.4 8.5 8.2 10.5" />
        <svg:path
          fill="url(#vg-a)"
      ...
      <svg:g fill="none" stroke="#000" stroke-width="1.9">
        <svg:path
          fill="#ffc72c"
        ...
        />
        <svg:path d="M748.9 422.6s5.5-1.4 7.5.9 16 16 16 16" />
        <svg:path
          d="m761.5 429.1-5.6 4.1s14 2.8 10.8 12m285.6-23s-2.7-1.5-7 1.7c-4.4 3.3-15.3 15.5-15.3 15.5"
        />
        <svg:path d="m1039.9 428.7 6 4.6s-12.5.9-9.8 12.7" />
      </svg:g>
      <svg:path
