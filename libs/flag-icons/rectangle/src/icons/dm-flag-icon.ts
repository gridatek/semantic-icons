...
@Component({
  selector: 'svg[siDmFlagIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:defs>
      <svg:clipPath id="dm-a">
        <svg:path fill-opacity=".7" d="M-85 0h682.7v512H-85z" />
      </svg:clipPath>
    </svg:defs>
    <svg:g
      fill-rule="evenodd"
    ...
    >
      ...
      <svg:g transform="translate(-250.6 359.4)scale(1.04)">
        <svg:g
          fill="#009200"
          stroke="#000"
          stroke-width="2.5"
