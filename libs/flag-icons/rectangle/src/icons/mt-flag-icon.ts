...
@Component({
  ...
  template: `
    ...
    <svg:path fill="#cf142b" d="M320 0h320v480H320Z" />
    <svg:g
      fill="#fff"
      stroke="#000"
      stroke-width="96"
    ...
    <svg:g transform="translate(161.8 201.5)scale(.0147)">
      <svg:path
    ...
    <svg:g
      ...
      stroke-width="36"
    >
      <svg:path stroke-width=".7" d="M137.9 185.8a588 588 0 0 1 48 0" />
      <svg:path
        stroke-width=".4"
      ...
      />
      <svg:path stroke-width=".4" d="m166.7 135 9.5 5" />
      ...
      />
      <svg:path stroke-width=".1" d="m149.8 160.6-7.6-7.6" />
      <svg:path
        fill="#fff"
        stroke-width=".5"
