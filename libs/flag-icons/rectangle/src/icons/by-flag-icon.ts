...
@Component({
  selector: 'svg[siByFlagIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:defs>
      <svg:clipPath id="by-a">
        <svg:path d="M0 0h200v608h8v284l-8 8H0z" />
      </svg:clipPath>
    </svg:defs>
    <svg:path fill="#ce1720" d="M0 0h640v480H0Z" />
    <svg:g
      fill="#fff"
      clip-path="url(#by-a)"
    ...
    >
      <svg:g id="by-c">
        ...
        />
        <svg:use xlink:href="#by-b" transform="matrix(-1 0 0 1 200 0)" />
        <svg:path
      ...
      <svg:use xlink:href="#by-c" transform="matrix(1 0 0 -1 0 900)" />
      <svg:path
    ...
    <svg:path fill="#007c30" d="M110 320h530v160H110Z" />
  `,
  host: {
    '[attr.xmlns]': 'xmlns',
