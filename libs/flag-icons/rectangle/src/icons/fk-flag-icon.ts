...
@Component({
  ...
  template: `
    ...
    <svg:path fill="#012169" fill-rule="evenodd" d="M0 0h400v200H0z" />
    <svg:path
      fill="url(#fk-b)"
      fill-rule="evenodd"
      stroke="#fff"
    ...
    <svg:g fill-rule="evenodd">
      ...
      />
      <svg:path
        d="M425.3 119.7q0 1.2-1.2 1.4c-1.2.2-1.2-.7-1.2-1.4q.2-1.3 1.2-1.4 1.1 0 1.2 1.4"
      />
    </svg:g>
    <svg:g
      fill="#005120"
    ...
    />
    <svg:g transform="matrix(.86465 0 0 .97062 -175.4 2.5)">
      <svg:path
        fill="none"
        stroke="#512007"
        stroke-width=".5"
