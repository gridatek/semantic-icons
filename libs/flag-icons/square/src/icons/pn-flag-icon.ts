...
@Component({
  ...
  template: `
    ...
    <svg:path
      ...
      stroke="#000"
      stroke-width=".4"
      d="M343.3 238.4c-9.9 6.2-28 3.6-29.6-11.7-1.7-15.4 10.8-22.2 14.2-24.2 5.2-3.1 9.3 2.4 7.6 8.9 5.8-2.5 7-10.5 4.3-15.1 7.6.7 14.7-6.2 17.7-16-2.7 3-10 1-16 .5 1.8-2.4 1.8-7.1 1.2-9.6-6.3 7.7-15.4 4.2-27.5 26.6a1166 1166 0 0 0 8-36.6c.7-14.6-12.4-15-15.2-8.2 3 4 1.4 8.9.3 16.2-1.3 8.6-4 28.6-6.5 35.3-.7-10.5-6.5-11.2-7.6-16.2-1.7 1.3-2.6 4.8-2.3 7.3-2-2.7-9.1.6-11.7-3.4-2.8 6.7 1.7 13.3 6.3 16.2-2.7.2-3.3 4.1-6.3 4.1 4 5.6 8.1 7.8 12.8 8.3 4.8.4 8.3 2.5 11.2 9.4 4.7 11.1 22.4 18.3 39.1 8.2z"
    />
    <svg:path
      fill="#f7e017"
      stroke="#000"
      stroke-width=".4"
      d="M367.9 224.9c-5.6 18.4-20.9 31.5-27.8 33.5a134 134 0 0 0-42 24.4q-1.6-.4-2.6-1.3c-3.2-2.7-5.8-11.3-.2-18.7 17.5-19.5 36.3-11 48-24.4-9.8 6.2-27.9 3.6-29.6-11.8 10.6 3.4 29.8 3.6 45-16 2.1 2.7 8 11.2 9.2 14.3z"
    />
    <svg:path
      fill="#337321"
      stroke="#000"
      stroke-width=".4"
      d="M332.2 268.1c-8.9 9-13.5 31-12.5 45.8q.4 6.2 2.7 8.6c.6-8.4 5.6-30.2 18.1-40A104 104 0 0 0 374 235c-1.2-3.8-3-6.5-6.6-9.1-6 19.9-22.4 29.4-35.1 42.3z"
    />
    <svg:path
      fill="#316d3a"
      stroke="#000"
      stroke-width=".4"
      d="M362.2 216.3A44 44 0 0 1 345 233c1.5-2 2-4.6 2-6.7-8.7 4-26.2 3.6-33.3.5 10.6 3.3 29.8 3.5 45-16q2.3 2.9 3.5 5.6z"
    />
    <svg:path
      fill="#337321"
      stroke="#000"
    ...
    <svg:path
      ...
      stroke="#000"
      stroke-width=".4"
      d="M326 363.8c-1.5 1-1.3 3.5-.4 5 2 3.1-1.4 10.2 5 11.7q2.8.4 4-3.5c1.9-7-4.3-7.7-4.9-11-.5-3.4-2.3-3-3.6-2.2z"
    />
    <svg:path
      fill="#f7e017"
      stroke="#000"
      stroke-width=".4"
      d="M331.4 377c-2 1-4 2.7-3 10.7.3 3.3.1 11.3-2.3 11.4 1.5.9 4.6 1.8 6-.2 1.2 2.5 4 1.8 5.2-1.3 1.4 1.4 3.5-1 3.5-3.1 1.3 1 4-.5 3.2-5.2 1.6.6 3.7-.7 4.4-2-2.3-.5-8.2-4.3-9.6-7.3s-5-4.4-7.4-3z"
    />
    <svg:path
      fill="none"
      stroke="#000"
      stroke-width=".4"
      d="M299.1 152.4q1.4-2.5 3.2-4.5m32.3 33.9q2.5-1.5 6.9-1M332 398.9c-.6-1.1-.9-5.8-.4-8.6m5.7 7.3c-1-1-3-4.2-3.4-7m6.9 3.9a20 20 0 0 1-5.2-8.8m8.4 3.5c-1.5-.4-6.2-4-8.2-7.9"
    />
    <svg:path
      fill="#f7e017"
      stroke="#000"
    ...
    <svg:path
      ...
      stroke="#000"
      stroke-width=".4"
      d="M431.4 250.2V310q-.2 23.1-5.9 40.7l-42.1-92.2-42.2 92.2a136 136 0 0 1-5.9-40.7v-60z"
    />
    <svg:path
      fill="#f7e017"
    ...
    <svg:path
      ...
      stroke="#000"
      stroke-width=".4"
      d="m402.5 379.2 4 2.4a42 42 0 0 0 2-19.5c-2.5 7.3-10.7 7-12.9 11.5q2 1.3 3.7 2.8a42 42 0 0 1-13 10.3V339c0-3.4-1-6.2-1-9v-9.8c0-2.2-.3-5.4-2-5.4s-2 3.2-2 5.4v9.9c0 2.7-1 6-1 8.9v47.6c-2-7.1-10-4.7-13.8-11.8q2.3-.7 4.5-.2c-2.8-11.3-10.4-12.2-11.9-15.6 0 4.7-1.7 15.6 1 20.3q.8-1.4 2.5-2.5c3.1 8.2 17.4 8.2 20.7 21.8 2.7-5 12.4-10.8 19.2-19.5z"
    />
    <svg:path
      fill="#f7e017"
      stroke="#000"
    ...
    <svg:path
      ...
      stroke="#000"
      stroke-width=".4"
      d="M367.9 338.4c1 0 1.7-1.7 1.7-3.8s-.8-3.7-1.7-3.7m9.1 8.3c1.2 0 2.1-2 2.1-4.6s-.9-4.5-2-4.5m2.1 9.3c1.2 0 2.2-2.2 2.2-4.8s-1-4.7-2.2-4.7m7.2 9.5c1.2 0 2.1-2.1 2.1-4.8s-1-4.8-2.1-4.8m2.2 9.5c1.2 0 2.2-2 2.2-4.7 0-2.5-1-4.6-2.2-4.6m10 8.5c1 0 1.8-1.7 1.8-3.9 0-2.1-.8-3.8-1.8-3.8m-36 46.1q1.7-1.3 4-2m33.9 2.5-1.1-1m3.1 2.8a32 32 0 0 0 6-11.4"
    />
    <svg:path
      fill="#fff"
      stroke="#000"
      stroke-width=".4"
      d="M374.8 292.6c0-1.1.7-1.6 1.6-2.4 1-.9 1.5-1.4 2.4-1.4h12.3q1.1-.1 1 1.3V310q.2 1.4-1 1.3h-16.3v-18.9"
    />
    <svg:path
      fill="#e5e5e5"
      stroke="#000"
      stroke-width=".4"
      d="M388 313c1.6 0 1.4-.1 2.5-1.5s1-1.2 1-2.5v-18.2q.1-1.3-1-1.2h-11.3c-.9 0-1.3.5-2.2 1.4-.8.7-1.5 1.1-1.5 2.1V313z"
    />
    <svg:path
      fill="#fff"
      stroke="#000"
      stroke-width=".4"
      d="M389.2 312.5q.1 1.4-1 1.3h-12.3c-1 0-1.1-.3-1.1-1.3v-19.8q-.1-1.4 1.1-1.3h12.2c1 0 1.1.3 1.1 1.3z"
    />
    <svg:path
      fill="#96877d"
      stroke="#000"
      stroke-width=".4"
      d="M413 238.6c2.3 3.1 3 7.4 1.8 11.5h-3.6c1.5-5.3.6-10.4-5.7-11-9.5-1-20.5 20.8-37 23.5-5-6.9-4.7-20 1.5-26.2-3.2-11-9.9-23-14.5-28.1-3-.6-6.6-1-8.9-.8a33 33 0 0 1 15-15.4l2.7-4.4c.6-8.6 34.7-4.6 42 .7 0 9.6 3 41.5 6.6 50.2z"
    />
    <svg:path
      d="M371.6 244.4c-.8-14.8-5.8-27-12.8-35.3a17 17 0 0 0 14.9-2.9c6-4.8 22.1-13.4 28-9.7.5 1.2.7 4 .4 5.7-1.4-4.4-16.9 2.5-21.3 4.6-4.1 2.3-6 5.4-4.5 12.4-2.4-2.4-1.6-4.8-4.1-6.5 1 2.9 1.8 8 2.1 12.3-1-3-2.6-9.4-6.2-13.2a87 87 0 0 1 4.6 34.2c2.5 0 8-3 10.2-5-1.9 3.3-7.5 5.6-11.2 6.5a25 25 0 0 0-2.6 11.7c-.3-4.1.8-14.2 2.5-14.8m41.4-5.8c-3.2-4.1-9-6.3-16.3-4 1.2-.6 3.6-1.7 5.7-2.2-.2-2.3-2-12.3-2.3-14.7l2-1c1 6 2.4 12.8 3.2 15.6.7.2 2.2.6 3.5 1.4-.6-2.4-3.8-19.1-3.7-21l2.8-1.7a153 153 0 0 0 5 27.6z"
    />
    <svg:path
      fill="#96877d"
      stroke="#000"
      stroke-width=".4"
      d="M411.3 250.2c1.4-5.4.5-10.4-5.8-11.1-5-.5-10.2 5.2-16.5 11zm-41.2-47.9c-2.8.5-9-.2-12.2-1.4q.3-1.5 1-3.1c-2 1.5-5.7 4.5-7.1 6.7 4.4 1 13.7 1.6 18.3-2.2z"
    />
    <svg:path
      fill="none"
      stroke="#000"
      stroke-width=".4"
      d="M370 236.4q1.6 5.5 1.8 10m-10.2-54.3c-1.7 3-3.2 6.1-3.7 8.8 3.2 1.2 9.4 1.9 12.2 1.4"
    />
    <svg:path
      fill="none"
      stroke="#000"
    ...
    <svg:path
      ...
      stroke="#000"
      stroke-width=".4"
      d="M439 376.2c2.3 1.4 4.3 3.3 3 12.1-.5 3.7-.6 12.7 2.1 13-1.7.8-5.2 1.7-6.6-.6-1.5 2.7-4.7 1.7-5.8-1.8-1.7 1.5-4-1.3-3.8-3.7-1.5 1-4.4-.7-3.5-6-1.8.7-4-.9-4.8-2.3 2.6-.5 9.3-4.4 11-7.7s5.7-4.6 8.4-3z"
    />
    <svg:path
      fill="none"
      stroke="#000"
    ...
    <svg:path
      ...
      stroke="#000"
      stroke-width=".4"
      d="M380.7 122.5c-2.1-3.6-8-4.7-9.3 0-.5 2.2-1.4 4.4-2.8 5.4s-1 4-.4 5.3c1.4 3.3.1 6.4 3 8.5 0-2.6 3.2-5.2 5.9-5.9s6.8-3.5 7.3-6.8 1.5-5.9-3.7-6.5z"
    />
    <svg:path
      fill="#96877d"
      stroke="#000"
      stroke-width=".4"
      d="M367.3 154.4h.8v6l.4.3 4.4-3 .4.8-4.4 3v.6l4.4 3-.4.8-4.4-3-.4.3v6h-.8v-6l-.4-.3-4.4 3-.4-.7 4.4-3v-.6l-4.4-3 .4-.8 4.4 3 .4-.3z"
    />
    <svg:path
      fill="#96877d"
      stroke="#000"
      stroke-width=".4"
      d="M374 169.2a8 8 0 0 1-6.3 3.1c-4.9 0-8.8-4.7-8.8-10.5s3.9-10.5 8.8-10.5q4.4.2 7 4.1c-.5 1.4-1 4.3-1 5.7-.4-3.6-3-6.5-6-6.5-3.4 0-6 3.3-6 7.2s2.6 7.2 6 7.2c2.7 0 5.2-2.3 5.8-5.4 0 1.4.1 4.6.4 5.6z"
    />
    <svg:path
      fill="#337321"
      stroke="#000"
      stroke-width=".4"
      d="M364 179.3a8 8 0 0 1-1.5-4.5c.8 0 2.4.6 3.1 1.5 0-1.2-.4-3.6-.2-4.7 1 .5 3.1 1.9 3.9 3.5-.2-1-.6-4-.2-5.7 1.1.8 3 2.9 3.4 4.3 0-2.2.7-5.9 1.3-6.8.8 1 2.1 2 3 3.3.1-1.8.9-4 2-4.5a15 15 0 0 1 2.4 6.6c.8-.4 2-2 2.4-3q1 1.5.7 4.4a10 10 0 0 0 2.5-4c.7.7 2.1 2.3 2.5 4.1-.2-1.4-.1-4-.5-5.4q2.2 1.4 2.8 4c.4-1.5 1.2-4.2 2-5a14 14 0 0 1 1.3 5.7c.5-1 1.3-3 2-3.5.6 1.2.6 3.9.4 5.3a10 10 0 0 1 2.6-2.8c0 .6.2 2 0 3 .8-.6 2.2-3.6 2.7-5.2 1.3.8 2.6 3.5 2.7 4.8a11 11 0 0 0 3.3-3.5c0 .7.3 2.9 0 4.5.5-.7 1-2 1.3-2.6.4 1.2.1 3.8-.2 5.2q1.4-1.3 2.8-1.4c0 1.9-1 5.2-2.1 7.7-9-3-27.6-4.1-46.4-5.3z"
    />
    <svg:path
      fill="#f7e017"
      d="M395.1 120.5c0-.8 1.5-2.7 4.3-2.7 3.2 0 6.3 3 9 2.7 2.6-.2 1.3.9.7 1.1q-1 .4-.7 1.2.4.9-1.2.4c-2.4-1-4.7.4-7.8-.4-2.7-.7-4.2-1-4.3-2.3"
    />
    <svg:path
      fill="#f7e017"
      stroke="#000"
    ...
    <svg:path
      ...
      stroke="#000"
      stroke-width=".4"
      d="M368.7 179.6c-.5-1.2 2.3-3.4 4.2-1.7s4.6-1.4 5.7 1.5c2.3 6.1 2.4 6.5 1.8 7.7-.7 1.2-3.7.7-4.5-.9-.1 1.1-2.7 1-4 0-1.6-1-2.6-4.6-3.2-6.6zm19.6.2c-.7-1.7 3.7-3.2 5.6-.2 1-1 3.1-1.1 4.3 2.2q1.8 4.7.5 5.9c-.6.6-2.9 1-3.6-.5-1 .8-4.2.1-4.9-2q-1-3-2-5.4zm18.5 3.3c-.1-1.5 2.3-2.3 3.1 0 1 2.3 3.8.2 4 4 0 .7-.3 3.5-1.2 4.8-.9 1.4-5.2 0-5.5-2.8-.3-2.9-.4-4.5-.4-6z"
    />
    <svg:path
      fill="none"
      stroke="#000"
      stroke-width=".4"
      d="M366.9 186c-1-1.7-2.5-4.4-4.2-1.5m13.3 1.7a14 14 0 0 1-1.7-3.7m11.1 3.9a9 9 0 0 1-2.2-2.8m1.3-3c1.7.2 2.8 2 3.3 2.9s1.6 2.3 2.4 2.5m4.9 1.3q-1-1.6-1.2-2.8m0-4.9q.9 1.4 1.3 2.6m8.4 6.5a9 9 0 0 0-3-3.8m2.6-2.3c.1 3.3 3.8 3.5 4 5.8m2.8-5.3q.5 1.1.5 3"
    />
