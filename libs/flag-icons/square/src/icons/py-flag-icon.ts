...
@Component({
  ...
  imports: [],
  template: `
    <svg:path fill="#0038a8" d="M0 341h512v171H0z" />
    <svg:path fill="#fff" d="M0 170.7h512v170.6H0z" />
    <svg:path fill="#d52b1e" d="M0 0h512v170.7H0z" />
    <svg:g fill="none" stroke="#000" transform="translate(-209)scale(1.55152)">
      <svg:circle cx="300" cy="165" r="42.2" stroke-width="1.1" />
      <svg:circle cx="300" cy="165" r="34.7" stroke-width=".5" />
      <svg:circle cx="300" cy="165" r="26.6" stroke-width=".4" />
    </svg:g>
    <svg:path
    ...
    />
    <svg:g fill="#009b3a" stroke="#000" stroke-width=".1">
      <svg:path
        d="M265.2 225.4s24.9 10.8 20.5 33-18.2 22-23.6 24.4c-5.5 2.5-9.2 6-11.4 5.5-2.1-.5-5-2.2-5-2.2s-.2 3.7 4.2 4.3c4.4.7 10-5.7 12.9-6.4s19.6-2.6 23.8-25.1c4.8-24.1-21.3-32.8-21.4-33.5z"
      />
      <svg:path
      ...
      />
      <svg:path d="M274.8 231.1a3.5.8 34.2 1 1-.8 1.4 3.5.8 34.2 1 1 .7-1.4z" />
      <svg:path d="M275.8 230.7a3.6.8 46.2 1 1-1 1 3.6.8 46.2 0 1 1-1z" />
      <svg:path
        d="m277.5 233.8-1.1.6c-.3.1-.6-.3-1.2 0q-.9.7-1.2 1.3t1 .2q1-.7 1.3-1.2c.3-.3 1-.6 1.3-.7l1-1.5c.2-.4 1.2-1 1.6-1.9.3-.6.2-1.2-.3-1a4 4 0 0 0-1.2 1.4c-.3.5 0 1-.3 1.5zm7.8 2.6a1.1 5.1-1.6 1 1-2.4-.6 1.1 5.1-1.6 1 1 2.4.6z"
      />
      <svg:path d="M284 236.3a5.3 1.1 77.5 1 1-2.3.1 5.3 1.1 77.5 1 1 2.3 0z" />
      <svg:path d="M280 237.6a5 1.2 35 1 1-.8 2.3 5 1.2 35 1 1 .8-2.4z" />
      <svg:path
        d="M280.8 236.4a5.3 1.1 50.9 0 1-1.5 1.7 5.3 1.1 50.9 1 1 1.5-1.7z"
      />
      <svg:path d="M282.4 236.3a5.4 1 61.8 1 1-1.9 1 5.4 1 61.8 1 1 1.9-1z" />
      <svg:path
        d="m283.8 241.5-1.9.4c-.3 0-.6-.7-1.6-.5s-1.8.9-2 1.3q-.6.8 1.2.6c1.2-.2 1.6-1 2.2-1.1l2.1-.4 1.8-1.7c.5-.5 2-1 2.8-2 .7-.8.7-1.6 0-1.5a5 5 0 0 0-2.1 1.4c-.5.6-.4 1.5-1 2zm5.5 5.2a1.1 5.2 8.7 1 1-2.2-1 1.1 5.2 8.7 1 1 2.2 1z"
      />
      <svg:path d="M288 246.4a1.1 5.4-2 1 1-2.1-.3 1.1 5.4-2 1 1 2.2.3z" />
      <svg:path d="M284 246.8a5 1.2 46 1 1-1.2 2.2 5 1.2 46 1 1 1.1-2.2z" />
      <svg:path
        d="M285 245.9a5.4 1.1 61.8 1 1-1.8 1.4 5.4 1.1 61.8 1 1 1.7-1.4z"
      />
      <svg:path d="M286.5 246a5.5 1 72.5 1 1-2 .8 5.5 1 72.5 1 1 2-.8z" />
      <svg:path
        d="M287 251.5h-2c-.3 0-.4-.8-1.4-.8q-1.7.1-2.3.9-.6.6 1.1.8c1.2 0 1.8-.6 2.4-.7h2.1l2-1.3c.6-.4 2.3-.6 3.2-1.4.8-.6 1-1.5.3-1.4a5 5 0 0 0-2.4 1c-.6.4-.6 1.3-1.3 1.7l-1.8 1.2m2.7 6.7a1.1 5.2 31.3 0 1-1.6-1.8 1.1 5.2 31.3 0 1 1.6 1.8"
      />
      <svg:path
        d="M288.6 257.4a1 5.4 20.6 0 1-1.9-1.2 1 5.4 20.6 0 1 1.9 1.2m-3.9-1.3a5 1.2 70 0 1-2 1.6 5 1.2 70 0 1 2-1.6"
      />
      <svg:path d="M286 255.7a1 5.5-4.9 0 1-2.2.6 1 5.5-4.9 1 1 2.2-.6" />
      <svg:path d="M287.4 256.5a1 5.5 5.5 1 1-2.2-.2 1 5.5 5.5 1 1 2.2.2" />
      <svg:path
        d="m285.6 261.7-1.7-.8c-.3-.2-.1-.9-1-1.3q-1.7-.6-2.4-.2-.8.4.7 1.3c1 .5 1.8.1 2.4.4l2 .8 2.2-.4c.7 0 2.3.4 3.4 0 1-.2 1.5-1 .9-1.2a5 5 0 0 0-2.6-.1c-.7.2-1.1 1-1.8 1.2-.5 0-2 .4-2.1.3m1 8.2a1.3 5.9 48.5 1 1-1.2-2.6 1.3 5.9 48.5 1 1 1.1 2.6"
      />
      <svg:path
        d="M285.6 268.7a1.3 6.2 37.5 1 1-1.6-2 1.3 6.2 37.5 1 1 1.6 2"
      />
      <svg:path d="M281.8 265.8a1.3 6-3.5 1 1-2.6 1 1.3 6-3.5 1 1 2.6-1" />
      <svg:path
        d="M283.3 265.8a1.3 6.3 11.6 0 1-2.5-.2 1.3 6.3 11.6 1 1 2.5.2"
      />
      <svg:path
        d="M284.6 267.1a1.2 6.4 22.1 1 1-2.3-.9 1.2 6.4 22.1 1 1 2.3 1"
      />
      <svg:path
        d="m281 272.3-1.7-1.5c-.2-.3.2-1-.7-1.8a4 4 0 0 0-2.6-1q-1 0 .4 1.6c1.4 1.6 2 .8 2.5 1.3l1.9 1.6 2.7.4c.7.1 2.3 1.3 3.7 1.3 1.2 0 2-.6 1.3-1.1a6 6 0 0 0-2.7-1c-.9 0-1.6.7-2.5.6l-2.4-.4m-2.4 7.8a1.5 6.5 79.8 1 1 .3-3 1.5 6.5 79.8 1 1-.3 3"
      />
      <svg:path
        d="M278.4 278.4a1.4 6.8 68.5 0 1-.5-2.8 1.4 6.8 68.5 0 1 .5 2.8"
      />
      <svg:path d="M276.1 273.5a1.5 6.5 26.2 0 1-3-.6 1.5 6.5 26.2 1 1 3 .6" />
      <svg:path
        d="M277.7 274.4a1.4 6.9 41.8 0 1-2.4-1.6 1.4 6.9 41.8 0 1 2.4 1.6"
      />
      <svg:path
        d="M278.1 276.4a1.4 7 52.7 1 1-1.7-2.2 1.4 7 52.7 0 1 1.8 2.2"
      />
      <svg:path
        d="m271.8 279.2-.7-2.3c-.1-.5.7-1 .3-2.2a5 5 0 0 0-2-2.5c-.5-.3-1 .3-.5 1.8s1.5 2 1.8 2.7l.8 2.6c.6.3 1.7 1.4 2.4 2 .7.5 1.6 2.5 3 3.3 1 .7 2 .6 1.8-.3a7 7 0 0 0-2.1-2.5c-.8-.6-2-.3-2.7-.9-.5-.4-2.1-1.6-2-1.7"
      />
      <svg:path d="M268 285.9a1.9 6.5 89 0 1 0-3.8 1.9 6.5 89 0 1 0 3.8" />
      <svg:path
      ...
      />
      <svg:path
        d="M252.4 229.7c-2.1-.6-5.4-1.7-7.6-2.2l8-3.6c-1.7 1-4 2.4-5.3 3.4 1.2.8 3.4 1.7 5 2.4"
      />
      <svg:path d="m248 228.4 7.2-2-7.4 1-1.1.8 1.3.2" />
      <svg:path
        d="M252.8 230.3c-2.5-.3-6.4-.8-8.8-.8 1.8-1.6 4.4-4.4 6-6-1 1.5-2.8 3.6-3.5 5.1 1.7.7 4.4 1.1 6.3 1.7"
      />
      <svg:path d="m245.4 229 7.4-1-7.2-.1-1.4.6 1.2.4" />
      <svg:path
        d="M250.9 230.5c-2.3-.4-5.7-1.2-8-1.4 2.1-1 5.3-3 7.3-4-1.5 1-3.6 2.5-4.7 3.5 1.4.7 3.7 1.3 5.4 2"
      />
      <svg:path d="m244.8 228.8 6.5-2.8-7.2 2-.8.8h1.5" />
      <svg:path
      ...
      />
      <svg:path d="M242.8 277.6 232 275l10.3 5 2-.6-1.6-2" />
      <svg:path d="m244.5 278.3-10.6-.6 10.6 3.3 1.8-1-1.8-1.7" />
      <svg:path
        d="M237.8 270.8c2.7 3 6.9 7.9 9.8 10.6-3.6.5-9 2-12.2 2.8 2.6-1.2 6.3-2.7 8.4-4.2-1.4-2.8-4.2-6.4-6-9.2"
      />
      <svg:path d="m246 278.8-10.6-3.5 10 6 2-.5-1.4-2" />
      <svg:path
        d="M238.8 271.5c3 2.7 7.5 7.1 10.6 9.5-3.4 1-8.5 3.1-11.6 4.4 2.4-1.6 6-3.5 7.8-5.3-1.6-2.7-4.8-6-6.8-8.6"
      />
      <svg:path d="m246.8 279.5-10 2 10.6.7 1.5-1.5-2-1.2" />
      <svg:path d="m244.8 278.8-10.5.8 10.8 1.9 1.7-1.3-2-1.4" />
      <svg:path d="m246.7 279.4-10.9-1.7 10.7 4.3 2-.8z" />
      <svg:path d="m248.5 280-10.6.2 10.8 2.4 1.7-1.1z" />
      <svg:path
        d="M241.2 273c3 2.8 7.5 7.4 10.6 9.8-3.6.8-8.8 2.6-12 3.7 2.5-1.4 6.1-3 8.1-4.7-1.6-2.8-4.7-6.2-6.7-8.8z"
      />
      <svg:path d="m250 280.4-10.8-2.7 10.4 5.2 2-.6z" />
      <svg:path
        d="M242.2 273.6c3.3 2.5 8.1 6.6 11.4 8.7a168 168 0 0 0-11.3 5.2c2.3-1.7 5.7-3.9 7.4-5.8-1.8-2.6-5.2-5.6-7.5-8.1z"
      />
      <svg:path d="m251 281-10 2.7h10.7l1.3-1.6z" />
    </svg:g>
    <svg:path
      fill="#fedf00"
      stroke="#000"
