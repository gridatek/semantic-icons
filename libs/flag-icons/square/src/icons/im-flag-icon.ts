...
@Component({
  ...
  template: `
    <svg:defs>
      <svg:clipPath id="im-a">
        <svg:path fill-opacity=".7" d="M148.2 0h744.1v744h-744z" />
      </svg:clipPath>
    </svg:defs>
    <svg:g clip-path="url(#im-a)" transform="translate(-102)scale(.7)">
      <svg:path fill="#ba0000" fill-rule="evenodd" d="M1063 744H0V0h1063z" />
      <svg:path
        fill="#ffef00"
        fill-rule="evenodd"
        stroke="#000"
        stroke-width="3.2"
        d="M556.6 546.5c.3-1 1-10 .6-10s-13.7-15.8-13.4-15.8 17.2 3.8 17.2 3.2 6.8-16.6 6.8-17l8.2 19.7 16.6 7.3-11.7 9.6 2.7 19c0 .3-11.7-11-11.7-11l-13 1.4s-1.7-5.8-2.3-6.4z"
      />
      <svg:path
        fill="#fff"
        fill-rule="evenodd"
      ...
      <svg:path
        ...
        stroke="#000"
        stroke-width="3.5"
        d="M503.7 600.7c1.9-.5 10.1-3 12.5-3.3l7.6-2c2.9-.7 4.6-1.2 7.6-1.7q3.4-1.4 7-2.1m-40 26.9c.3-.3 2.3-2 3.7-2.9 1.7-.5 7.3-3 9.5-3.3l6.8-2c2.5-.6 4-1.2 6.7-1.7a44 44 0 0 1 6.4-2.1"
      />
      <svg:path
        fill="none"
        stroke="#000"
        stroke-width="3.2"
        d="M510.2 496.2h-.4c1.3 0 .5-.1-1.3 2-.6 1.7-5.9 5.4-9.9 5.4-2 .2-4.9.4-6.8.4l-1.9-.4m19.9 77.8h2q3.3.1 6.2.4c2.1 0 4.2.6 6.3.6 2 .3 4.6.2 6.7.5 2.4 0 4.4.5 6.9.5 2 0 3.1.4 5.4.4l-5.4-.4c2 0 3.1.4 5.4.4m-47.6 48c.2-.3 2-2 3.3-2.9 1.5-.5 6.7-2.9 8.7-3.3l6.2-2c2.3-.6 3.8-1.2 6.2-1.7q2.8-1.3 5.8-2m8.6-60c-1.2 3.4.3 4.3 1 5.7 1 1.4 3.8 3.6 8.2 5l5 1.6c1.3.2 1.9.5 2.9.9M370.8 435.3h.4c-1.3 0-.5.1 1.7-1.6 1.3-1.5 2.4-2.2 3.7-3.7m21 34.8c.2 0 24-12 26.6-14.6 1.8-1.3 3.1-2.6 5.3-4.1q2-1.2 3.7-2.5c1.1-1.6 2.5-2.5 3.3-4 1.5-1.2.9-2.6 2-4.1.6-1.6 1.7-4.2 2-5.7m30.3 17.8c.1.9-.4 3.5-.3 5.5-.1 2.3-3.1 9.5-6.7 11.7"
      />
      <svg:path
        fill="none"
        stroke="#000"
        stroke-width="3.2"
        d="m428 447.4 9.9 3a145 145 0 0 1 24 13.5c1.5 1.2 4.2 2.3 5.3 3.7q2.3 2.1 4 4.6a30 30 0 0 1 3.8 5c4.6 3.7 17 29.5 17.4 31l2 4.5q1.3 1.6 2.5 4.1c.9 2 1.9 3 3 4.6 1.3 1 3.1 2.7 4.9 3.7 1.8 1.6 3.6 2.2 5 3.3 1.9.8 23.7 14.6 24.7 15.3 2 1.6 8 8 3.8 12.5-1.8 1.5-3.4 3.6-5 4.5a16 16 0 0 1-5.6 3c-9.8 3-14.8 2-16.7 2h-2m-129-167c2.7 1 1.6.2 4.1 1.4 1.7.7 2.8.7 4.5 1.3s6.6 1.5 9 3.9c1.7 1.5 3 2.8 5 4a34 34 0 0 0 6.6 3.4c2.4.9 5 1.9 7.4 2H428h-6 5.8"
      />
      <svg:path
        fill="#ffe606"
        fill-rule="evenodd"
      ...
      <svg:path
        ...
        stroke="#000"
        stroke-width="3.2"
        d="M703.1 175.4c-.9.1-9 4-9 4.3s-7 19.8-7.1 19.5-5.2-17-5.7-16.6-17.8 2.3-18 2.4c-.3.2 13-16.7 13-16.7l-1.8-18.1 14.2 5.4L704 144c.2-.1-4 15.7-4 15.7l7.6 10.5s-4.3 4.4-4.5 5.2z"
      />
      <svg:path
        fill="#fff"
        fill-rule="evenodd"
      ...
      <svg:path
        ...
        stroke="#000"
        stroke-width="3.2"
        d="M301.2 245.2c.7.6 8.4 5.3 8.6 5s20.3-4.9 20.2-4.6-11.3 13.6-10.8 13.8 11.7 13.7 12 13.8l-21.2-1.8-14.2 11.5-3.2-14.9-18-6.4c-.3-.1 15.2-5.3 15.2-5.3l4.6-12s6 1.1 6.8.9z"
      />
      <svg:path
        fill="#fff"
        fill-rule="evenodd"
      ...
      <svg:path
        ...
        stroke="#000"
        stroke-width="3.5"
        d="M277.5 173.2c-.4 1.9-2 10.3-2.9 12.6l-1.6 7.7-2 7.5q-.5 3.6-1.5 7.2m-5.4-47.9c.2.4.8 3 .9 4.6-.3 1.7-.8 7.8-1.5 10l-1.2 6.9-1.7 6.8a44 44 0 0 1-1 6.5"
      />
      <svg:path
        fill="none"
        stroke="#000"
        stroke-width="3.2"
        d="m367.3 227 .1-.3c-.5 1.2 0 .5-1.2-2-1.2-1.4-2-7.8-.2-11.3l2.8-6.3c.2-.5 1-1 1.2-1.4m-78.2-18.2-.1.3-.8 1.5-3.2 5.3c-1 1.9-2.5 3.4-3.4 5.3-1.2 1.7-2.3 4-3.6 5.7-1.2 2.1-2.5 3.7-3.6 5.9-1 1.8-1.9 2.6-2.9 4.6l2.9-4.6c-1 1.8-1.9 2.6-2.9 4.6m-20.7-64.4c.2.4 1 2.8 1 4.3-.2 1.6-.4 7.3-1 9.2q-.7 3.3-1 6.5L251 178a38 38 0 0 1-.8 6m49.2 35.3c-2.5-2.6-4-1.7-5.5-1.8-1.8.3-5 1.8-8.3 5l-3.7 3.7q-1 1.3-2 2.2m205.5-97-.2.4c.6-1.2.1-.5.7 2.2.7 1.9.8 3.2 1.6 5m-40.6 2.6c-.1.2-.5 26.9.6 30.3.4 2.2 1 4 1.3 6.7l.4 4.4c1 1.7 1.1 3.4 2 4.8.5 1.9 2 2 2.8 3.7 1.2 1.2 3 3.4 4.1 4.3m-29.7 18.7c-.8-.3-3-2-4.7-2.8-2-1.2-7-7.1-7.3-11.3"
      />
      <svg:path
        fill="none"
        stroke="#000"
        stroke-width="3.2"
        d="m448.4 176.7-7.2 7.3a146 146 0 0 1-23 15c-1.8.8-4 2.8-5.8 3q-3 1.2-6 1.6-3.3.9-6 1c-5.5 2.4-34 1.5-35.6 1.2l-5-.3q-2 .3-4.8.3c-2.2-.2-3.5.2-5.4.5-1.4.7-3.9 1.6-5.5 2.7-2.3.9-3.7 2.1-5.3 2.8a661 661 0 0 1-25 15c-2.3 1-10.7 3.5-12.8-2.4-.5-2.3-1.6-4.7-1.7-6.5-.6-2.1-.3-4.4-.1-6.4 2-10 5.1-14 6-15.7l1-1.8m207-37-.2.3q.9-1.4-1.1 1.3c-1.5 1.2-3.2 3-4.5 4.2s-2.6 3.1-3.8 3.6c-1.2 1.6-2.7 2-4.3 3a29 29 0 0 0-5.6 2.6c-2.4 1.3-4 2.5-6.2 3.8-1.3 1.8-2.7 2.9-4 5l-3.3 5.6-2.7 5.2 2.7-5.2-2.7 5.2m17 106.2.5-.7q-1 2.1.2-1.3c0-2.7.6-6 .7-8.5q.7-3.9.8-8 0-4.4-.6-8.6l-.4-8.2a36 36 0 0 0-.8-7.4 43 43 0 0 0-.7-6.8c.3-1.9-.2-3.6-.6-5l-1.8-7.5-1.5-6c-.3-2.2-1.5-5-2-7a20 20 0 0 1-1.6-5q-1.2-2.4-2-5.2l-2.2-5.4-2-5.2c-.7-2-1.7-3.7-2.1-5.8q-.9-1-1.3-2"
      />
      <svg:path
        fill="#ffe606"
        fill-rule="evenodd"
      ...
      <svg:path
        ...
        stroke="#000"
        stroke-width="3.2"
        d="M512.7 336.1c.8-.5-8 4.2-10.4 5.3-41 21.9-62 53.7-63.3 54.9l-3.2 4.9c-1 1.5-2.4 3-3.3 4.5a88 88 0 0 1-5.3 6.7c-.2 1 .7-.3.4.3m113.1-102.5c-.8-.4 7.4 5.3 9.5 6.8 38.2 26.4 76 30.7 77.7 31.3q2.6 0 5.9.6c1.7.1 3.7.7 5.5.8 2 .3 6.4 1 8.4 1.7 1-.3-.6-.5 0-.5"
      />
    </svg:g>
  `,
  host: {
