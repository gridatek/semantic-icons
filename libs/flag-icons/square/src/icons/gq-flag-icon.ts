...
@Component({
  ...
  imports: [],
  template: `
    <svg:path fill="#e32118" d="M0 0h512v512H0z" />
    <svg:path fill="#fff" d="M0 0h512v341.3H0z" />
    <svg:path fill="#3e9a00" d="M0 0h512v170.7H0z" />
    <svg:path fill="#0073ce" d="M0 0v512l160-256z" />
    <svg:g stroke="#000">
      <svg:path
        fill="#fff"
        d="M215 204.5h81.7v85.6c0 28.8-37.5 6.6-40.7 22-5.6-15.8-40.8 7-40.8-23.7z"
      />
      <svg:path
        fill="#73452b"
        stroke-width=".2"
      ...
      <svg:path
        fill="gold"
        stroke-width=".8"
        d="m253.2 192.6-4.7.2-2.3 4.2-2.6-4-4.7.2 2.1-4.3-2.5-4 4.9-.2 2.1-4.2 2.6 4 4.7-.2-2.2 4.2zm-20 1.5-4.8 1.2-1.2 4.5-3.4-3.4-4.5 1.1 1.2-4.5-3.1-3.5 4.4-1.1 1.3-4.6 3.4 3.4 4.7-1-1.5 4.5zm-19.5 4-4.2 2.1-.3 4.8-4-2.6-4.3 2 .4-4.7-4-2.6 4.3-2.2.4-4.7 3.8 2.6 4.3-2-.2 4.7zm45.7-5.5 4.7.2 2.1 4.2 2.6-4 4.7.2-2.2-4.3 2.6-4-4.7-.2-2.4-4.2-2.5 4-4.7-.2 2.1 4.2zm20 1.5 4.5 1.2 1.3 4.5 3.4-3.4 4.5 1.1-1.3-4.5 3.4-3.5-4.7-1.1-1.3-4.6-3.4 3.4-4.4-1 1.2 4.5zm19.2 4 4.3 2.1.2 4.8 4-2.6 4.3 2-.2-4.7 3.8-2.6-4.2-2.2-.2-4.7-4 2.6-4.4-2 .5 4.7z"
      />
      <svg:g fill="#fff" stroke-width=".8">
        <svg:path
          d="m304.4 288.4 5.3 7.7 5-7.3-3.5-6.1zm-34 22.4.5 7.7s2.1 0 4-.6 3.3-2 3.3-2l-.3-4zm-28.5 0-.5 7.5s-1.9 0-3.8-.4a11 11 0 0 1-3.2-1.5l-2.1-5.2zm-34.4-22.4-5.5 7.7-6-9.8 4.5-4.7z"
        />
        <svg:path d="M234.2 326.2c0 7.2 44 7.2 44 0V316c0 5.3-44 4.2-44 0z" />
        <svg:path
