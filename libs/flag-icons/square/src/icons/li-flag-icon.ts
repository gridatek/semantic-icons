...
@Component({
  ...
  imports: [],
  template: `
    <svg:path fill="#002b7f" d="M0 0h512.1v256H0z" />
    <svg:path fill="#ce1126" d="M0 256h512.1v256H0z" />
    <svg:g
      fill="#ffd83d"
      stroke="#000"
    ...
    >
      <svg:g id="li-a">
        ...
        <svg:circle cx="212.8" cy="113" r="4.9" />
        <svg:circle cx="201.7" cy="110.3" r="4.9" />
        <svg:circle cx="190.4" cy="107.5" r="4.9" />
        <svg:circle cx="179.1" cy="105.6" r="4.9" />
        <svg:circle cx="167.8" cy="104.5" r="4.9" />
        <svg:circle cx="156.8" cy="105.1" r="4.9" />
        <svg:circle cx="146.2" cy="108.7" r="4.9" />
        <svg:circle cx="137.3" cy="115.3" r="4.9" />
        <svg:circle cx="131" cy="124.4" r="4.9" />
        <svg:circle cx="127.9" cy="135.2" r="4.9" />
        <svg:circle cx="128" cy="146.3" r="4.9" />
        <svg:circle cx="130.2" cy="157.2" r="4.9" />
        <svg:path
      ...
      />
      <svg:circle cx="222" cy="75.1" r="3.9" />
      <svg:circle cx="222" cy="100" r="10.5" />
      <svg:path
        fill="none"
        stroke-width="1.5"
      ...
      <svg:g stroke-width="1.5">
        ...
        />
        <svg:circle cx="222" cy="114.4" r="3.5" />
        <svg:circle cx="222" cy="122" r="3.7" />
        <svg:circle cx="222" cy="130.2" r="4.1" />
        <svg:circle cx="222" cy="139.3" r="4.7" />
        <svg:circle cx="222" cy="149.4" r="5.1" />
        <svg:path
          fill="#000001"
          stroke="none"
