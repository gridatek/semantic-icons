...
@Component({
  ...
  template: `
    ...
    <svg:g font-size="12">
      ...
      <svg:path
        fill="#d81126"
        d="M251.5 150.3s-14.1-6.8-27.4 3.2c0 0-24-3.4-25.9 19.6 0 .9-.2 2.6.3 3.2q.8.8.9 2c.1 1.2.3 1 .6 1.3l.5 1.9c0 1.2-.2 1.8 1 3s1.2 4.7 1.2 5.8.7 3.7 1.1 4.3c.6.6 1.5 2 1.5 3.3 0 1.1.5 4.5.2 5.3-.2 1 1.4 2 2.8 2.4 1.3.5 18.2 6 42.7 5.5 24.6-.3 33.5-1.7 43.7-5.3a2.5 2.5 0 0 0 1.7-2.7c-.2-.7 0-3 .4-3.5s3.4-5.2 2.7-6c-.6-1-.6-2.8 0-3.4.6-.8 2.4-4.3 2.7-5.7s.5-3.1 1.2-3.6c.5-.4.8-2.1.9-2.5a5 5 0 0 1 1.4-1.8s1-5.8.4-8.7c-.8-2.8-5.1-15.1-22.5-12.5 0 0-13-9.9-32.1-5.1"
      />
      <svg:path
        fill="none"
        stroke="#000"
      ...
      <svg:path
        fill="#bcac0b"
        d="M298.7 193.1c-53.5-17-94.9-.8-94.9-.8s.5 1.8 1 2.4 1 2 1 3v3.2c0 .8-.4 4.2 2.6 4 0 0 37.3-14.5 85.8.9 0 0 1.3-1.2 1.3-2.9a9 9 0 0 1 1.2-4.6c.5-.9 2-3.8 2-5.2"
      />
      <svg:path
        fill="#c8b100"
        fill-opacity=".9"
        d="M249.1 282.5h-23.3s-2.3 20.8 15.7 27.2v1.8h3.7v2.5s-6.6 6-.8 12.8v2h1v3.5h1v5.3s-.8 19.4-20 28.7v1.2h51v-1.2a36 36 0 0 1-20-28.7v-5.3h1.2v-3.4h.9v-2.1c5.7-6.8-1-12.8-1-12.8v-2.5h4v-1.8c17.8-6.4 15.5-27.2 15.5-27.2z"
      />
      <svg:path
        fill="none"
        stroke="#000"
      ...
      <svg:path
        fill="#fc0"
        d="M260.3 120H253v-11.8h2.8v-2.3H253V103h-2.3v2.8h-2.8v2.4h2.7V120h-6.8v1.6h16.5z"
      />
      <svg:path
        fill="#bcac0b"
        stroke="#000"
      ...
      <svg:path
        fill="#fc0"
        d="M287.5 141.9s-6.5-.8-10.4.7a17 17 0 0 1 1.4 18.2c-1 1.7-2 5-1.5 7.6h-1.2s-1.3-5.4.8-8.4a11 11 0 0 0 1-11.6 14 14 0 0 0-5-6.2c-3.6 1.5-11 0-13.1-1.5s-3.2-3.5.8-3.7c3.8-.3 10.5-.1 15 3.4 0 0 2.4-2.9 14.4-1.5s20.5 6.4 23.1 17c1.4 5.6-3.6 17-8.3 19.8 0 0 0-1.8-.3-3.2 0 0 8-8.9 5.6-17.2s-12-13.7-22.3-13.4"
      />
      <svg:path
        fill="#bcac0b"
        stroke="#000"
      ...
      <svg:path
        fill="#fff"
        d="M265 140.2c-2-.2-3.6-.5-3.6-.8s1.7-.4 3.8-.3c2 .3 3.7.6 3.7.8 0 .4-1.7.5-3.9.3"
      />
      <svg:path
        fill="none"
        stroke="#000"
      ...
      <svg:path
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M189.7 169.2a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M187.8 162.3a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M188.8 153.8a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M193.5 146.8a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M199 141.6a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M206.3 138.8a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M213.8 137.5a3 3 0 1 0 0-6.1 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M221 137a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M227.5 137.5a3 3 0 1 0 0-6 3 3 0 0 0 0 6.2" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M245.7 135.3a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M251.6 136.9a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M251.6 159.4a3 3 0 1 0 0-6.1 3 3 0 0 0 0 6.1" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M314.3 171.1a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M315.9 163.7a3 3 0 1 0 0-6.1 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M314.6 155.8a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M311.3 148.4a3 3 0 1 0 0-6.2 3 3 0 0 0 0 6.2" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M305.8 143.2a3 3 0 1 0 0-6.1 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M299 139.8a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M291.3 138.1a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M284.4 137.5a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M278 136.7a3 3 0 1 0 0-6.1 3 3 0 0 0 0 6.1" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M282.1 161.5a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M283.7 155.8a3 3 0 1 0 0-6.2 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M258.2 136.3a3 3 0 1 0 0-6.2 3 3 0 0 0 0 6.2" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M243.4 135.4a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M239.8 135.3a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M220.4 161.6a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M219.5 154.4a3 3 0 1 0 0-6.2 3 3 0 0 0 0 6.2" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M221.8 147.3a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M235.1 136a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M230 138a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M225.2 142a3 3 0 1 0 0-6 3 3 0 0 0 0 6.1" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M251.6 140.3a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M251.6 146a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M251.6 152.2a3 3 0 1 0 0-6.1 3 3 0 0 0 0 6.1" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M262 135.5a3 3 0 1 0 0-6.2 3 3 0 0 0 0 6.2" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M266.2 134.6a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M271 135.3a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M282.7 148.2a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M275.6 138.1a3 3 0 1 0 0-6.1 3 3 0 0 0 0 6.1" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M280 142.2a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
      <svg:path
        fill="none"
        stroke="#000"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="m251.4 187.6-8 4.1 7.2 4.6 8.5-4.3z" />
      <svg:path
        fill="none"
        stroke="#000"
        stroke-width=".5"
      ...
      <svg:path
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="red" d="m205.9 201 4.8-3.9-5.4-1s.7.8.6 1.6z" />
      <svg:path
        fill="none"
        stroke="#000"
        stroke-width=".5"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="red" d="m296.1 201.3-3.3-3.4 4.8-.5s-1.4.8-1.4 1.6v2.3" />
      <svg:path
        fill="none"
        stroke="#000"
        stroke-width=".5"
      ...
      <svg:path
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fc0" d="M214.2 182.3a2 2 0 1 0 0-3.8 2 2 0 0 0 0 3.8" />
      <svg:path
        fill="#bcac0b"
        stroke="#000"
        stroke-width=".7"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fc0" d="M239 178.3a2 2 0 1 0 0-3.8 2 2 0 0 0 0 3.8" />
      <svg:path
        fill="#bcac0b"
        stroke="#000"
        stroke-width=".7"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fc0" d="M264.2 179.1a2 2 0 1 0 0-3.8 2 2 0 0 0 0 3.8" />
      <svg:path
        fill="#bcac0b"
        stroke="#000"
        stroke-width=".7"
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fc0" d="M289.2 183a2 2 0 1 0 0-3.7 2 2 0 0 0 0 3.8" />
      <svg:path
        fill="#bcac0b"
        stroke="#000"
        stroke-width=".7"
      ...
      <svg:path
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="#fff" d="M251.4 175.7a2 2 0 1 0 0-3.9 2 2 0 0 0 0 3.9" />
      <svg:path
        fill="none"
        stroke="#000"
        stroke-width=".3"
      ...
      <svg:path
        fill="#fff"
        d="M298.8 181a3.4 3.4 0 0 1 5.5-2.1c0 .5-.4 1.5-1 2-.6.7-.7 1.8-.7 2.3a3 3 0 0 1-.5 1.8h-.5a3.4 3.4 0 0 1-2.8-4"
      />
      <svg:path
        fill="none"
        stroke="#000"
      ...
      <svg:path
        fill="#fff"
        d="M204.5 180.1a3.4 3.4 0 0 0-5.2-2.2q0 1 .8 2c.7.7.7 1.8.5 2.3q-.1.5.5 2h.4a3.4 3.4 0 0 0 3-4"
      />
      <svg:path
        fill="none"
        stroke="#000"
      ...
      <svg:path
        ...
        transform="matrix(1.13778 0 0 1.13875 -85.4 -81.1)"
      />
      <svg:path fill="red" d="m251.4 189.7-4.3 2.2 3.8 2.3 4.6-2.2z" />
      <svg:path
        fill="none"
        stroke="#000"
        stroke-width=".5"
