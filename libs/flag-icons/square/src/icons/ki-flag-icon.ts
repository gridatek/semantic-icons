...
@Component({
  selector: 'svg[siKiFlagIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:defs>
      <svg:clipPath id="ki-a">
    ...
    <svg:g clip-path="url(#ki-a)" transform="translate(-168.5 -6)scale(1.0413)">
      ...
      <svg:path
        ...
        stroke-width="1.6"
        d="M329.7 109.5c7.4-3.8 11-2.2 17.4-2.5 4.4 8 8.5 8.7 18.1 9.7a48 48 0 0 0 38.3 20.9c28.7-.8 37.8-20.9 57.1-23.1H481c-3.4-5.8-6-9.1-13.4-9.4a195 195 0 0 0-52 3.4l-24 6c-7-3.4-24.3-21.5-35.3-21.1-6.5 1.7-6.5 4-9.7 6.4-6.2 2.7-12.4 1.4-17 9.7z"
      />
      <svg:path
        fill="#ffc84b"
        fill-rule="evenodd"
