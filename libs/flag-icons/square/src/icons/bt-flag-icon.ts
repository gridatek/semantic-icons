...
@Component({
  ...
  imports: [],
  template: `
    <svg:path fill="#ffd520" d="M0 0h512v512H0z" />
    <svg:path fill="#ff4e12" d="M0 512h512V0z" />
    <svg:g stroke="#000" stroke-width=".5">
      <svg:g fill="#fff" stroke-width=".4">
        <svg:path d="M281.9 162.5c-4-1.4-6.4.6-6.3 5.7.1 5 2.8 7.9 6.7 6z" />
        <svg:path d="M285.3 153.1c-3.2-2.6-6.3-1.5-7.8 3.3s.1 8.4 4.4 7.9z" />
        <svg:path
          d="M290.7 144c-2.8-3-6-2.5-8.2 2s-1.3 8.3 3 8.5zm-3.5 44.2c-4.8 1.8-5.3 8.3-2.3 12.3s8.5 4.8 11.6 0z"
        />
        <svg:path
          d="M281.6 174.4c-4.5-1.5-8.6 4.6-9.3 10-.8 7-10.6 9.2-5.2 19.7 1.1-6.7 5.5-10.3 9-10.6s8.8-1 11-5.3zm14.3 26.9c-5.2 1.3-6 8.3-2.2 13.3 3.2 4.3 13.3 3.3 13-1L296 201.3zm15 42.3c.2-4.5-7-6.3-10.5-5.4-3.6.9-10.3-.1-11.9-3.9-1.2 3 .6 6.3 5.7 8 3.8 1.2 3.8 4 2.6 5.2 3 .5 11.5.5 14-3.9z"
        />
        <svg:path
          d="M306.8 214.7c-5.2-2.2-8.3 1.2-10.2 4.6-3 4.9-11.8-1.4-14.8 5.1 4-1.7 8.2 2 10.1 3.3 5.6 3.6 16.2 2.5 17.7-6z"
        />
        <svg:path
          d="M309.8 220.8c-5.2 3.8-7.2 8.5-7 11.6 0 3.2 4.5 10 9.2 10.5 2.8-5.7 4.2-17.6-2.2-22.1zM288.4 245c0-1.9 2.8-2.6 4.7-2 1.8.6 4.7 2.5 3.7 4.5zM260 234.7c-.5-2.3 3.2-6.2 8-4 5 2.1 5.6 6.3 3.6 7.9z"
        />
        <svg:path
          d="M272 238.8c-.4-1.2 3.1-3.7 9.1-2.2s7.5 5.4 7.3 8.4zm-12.6-4.1c3.1-2.4 2-7-.9-8.3-5.1-2.5-3.2-9-6.5-10.3-3.3-1.2-6.4-3.5-6.5-5.8-1.7 3.2-.7 6 1.6 8s-1.8 10.2 1.1 12.4zm-67.3-1.8c-2.6-4.1-9-3.3-11.5-.5-2.7 3-2.3 7.2.2 9zm15-6.1c-1-5.5-7.6-6.2-11.2-4.8-3.7 1.4-6.2 7-3.8 11z"
        />
        <svg:path
          d="M217.2 226c2.4-4.6-2.2-11.5-7.5-12.5-4.4-.9-9.6-.8-11.3-5.2-1 3.8 1.7 6.2 5 8.3s-.6 7.7 4.7 10.8z"
        />
        <svg:path d="M216.7 226.2c-1-3.3 1.2-7.8 5.7-7.5 4.5.4 7 3.6 5 7.7z" />
        <svg:path d="M226.8 226.4c-.7-3.4 2.2-7.5 6.6-6.5s6.5 4.5 4 8.3z" />
        <svg:path
          d="M236.7 228c-.4-3.4 2.6-7.4 7-6.2 4.4 1.1 6.3 4.8 3.5 8.5zM161 285.6c-8.4 0-10.5 2-11.7 10.6-1.5 10.8 13.2 12 11.7-10.6z"
        />
        <svg:path
        ...
        />
        <svg:path
          d="M137.6 336.3c-5.5-4.3-13.2.9-18.4-1.2 0 3.6 1.7 8.8 7.5 10.8a139 139 0 0 0 11-9.6z"
        />
        <svg:path
          d="M146.3 324.1c-8.7-4.4-10.2 6.5-17 4.3.3 3.1 2.8 7 8.3 7.9z"
        />
        <svg:path
          d="M151.4 314.2c-12.8-5-14.4 7.3-22 4.9 1.8 4.2 12.6 6.5 18.1 5l4-10zm17.6-53.9c-3.4-4.8-10.5-.9-11.7 4.8-1.1 5.6 1.7 13.5 6.4 11.8z"
        />
        <svg:path
          d="M177.7 245.2c-6-1.3-12.7-.7-12 5-2.2 1-2.9 8.5 3.3 10.1l8.7-15z"
        />
        <svg:path
          d="M181.6 241.3c-5.8-6.7-12.3-6.6-15.9-3.7-6.6 5.3-13 2.2-13.3 7.5 4-3 7.6.6 10.8-.5s5.7 5.2 14.7 2.5zm-14 101.4c.9 1.6 6.3 2.4 9-.4 3.4-3.7-.4-13.8-6-14.6s-6 11.5-3 15z"
        />
        <svg:path d="M161.3 343c8 2.8 11.3-3.7 7-7.9a80 80 0 0 1-7 7.8z" />
        <svg:path
        ...
        />
        <svg:path
          d="M234.8 259.3c-1.8 1.8 2.8 16 14.6 13.6s1.9-15.9-14.6-13.6z"
        />
        <svg:path
      ...
      <svg:g fill="none" stroke-width=".4">
        ...
        />
        <svg:path
          d="M230.7 226.3c-4.4 1.9-7 7.4-4.6 10.8s7.2 2.3 9.8.5m-8.3 1c-3.6 5.5-.3 9.7 3.6 11.3"
        />
        <svg:path
      ...
      <svg:g fill="#fff" stroke-width=".4">
        ...
        />
        <svg:path
          d="M359.2 112.9c-10.3-12.8-26-24.1-33.4-19.8 9.6.5 12.6 7.1 19.4 11.4s3.7 10.4 14 8.4zm-49 22.6c-10.7-4-31.8-6-41.6 6.3 16.3 2.7 41 1.2 41.7-6.3z"
        />
        <svg:path
          d="M308.3 140.3c-10.8-5-19.3 2-29.4 1-19.4-1.9-33.2-.8-35 8.5 11.1-9.9 29.7-1.7 37.2-3.8s35.4-.2 44.2 3.6c-4.5-5.6-11.5-7-17-9.3zm33.9-28.8c-2.6-8.3-2.4-17 10-16.4-3.1-4-14.7-6-16.6 8.6-13.7-10-28.6-11.8-31.4-3.1 7-6 18-1.6 31 13.2a23 23 0 0 1 7-2.3z"
        />
        <svg:path
          d="M323.3 123c-7.8-5-18.3-13.2.1-16.5-7.8-4.3-19.4-2.4-18.1 12.2-21.2-8.6-36.3-5.7-39.5 2.7-3.5 9.3 9.6 14.5 11.8 8.6-2.4 1-10.5-1.8-6.3-7s26.2-1.4 47 9.5c5.8 3 25.6 2.5 5-9.5z"
        />
        <svg:path
        ...
        />
        <svg:path
          d="M449.1 134.3c8.8-7 15.3-2.4 21.4-6 15.3-9.4 21.5 1.8 35.1-2.6-3.6 8.8-23.8 1.3-32.6 7.8s-39.7 12.8-23.9.8zm-25.6 50a11 11 0 0 0-9.1-9.8c-5.3-.6-7.6-6.1-11.6-6.4-4-.2-6.7-8.2-12.2-8.1s-7.8 7.3 5.2 13.8 27.2 14 27.7 10.5zm-16.3 3.4c-5.5.3-6.3 8.3-11.6 8.6 7.3 3.9 12.6-1.8 16.4-6.8z"
        />
        <svg:path
          d="M411.7 188.7c-4.7 4-6.1 12.5.8 14.9-4.2-5.7 7.3-8.3 3.7-13.6z"
        />
        <svg:path
          d="M416.5 189c-3.8 7.3 5.9 8.2 3.4 13.7 5.5-1.3 6.4-11.7 1.4-14.5z"
        />
        <svg:path
          d="M379.6 173.4c9-.5 17.3 4.4 22.8 12.3 3.5 5 15.3 7 19.4 3s1.7-12.5-8.3-9.8c-2.5-4.2-9.8-2.7-13.3-6.2-3.5-3.6-17.1-13.6-20.6.7z"
        />
        <svg:path
        ...
        />
        <svg:path
          d="M390.8 162.4c16 4 28.8 7.5 36.7 12a43 43 0 0 0 30.8 2.8c10.7-3 31.3-5.8 30.3 7.5 5.6-6.6-1.5-13.8-15.8-15 .3-6.6-6.7-12.5-11.7-8.6 4.6-.6 8.6 8-.5 11.6A8.2 8.2 0 0 0 449 163c4.3 1.3 8.7 8.5-1 11.3-6.1 1.8-15-.5-21.6-4.5s-43.8-18.6-35.7-7.5z"
        />
        <svg:path
          d="M431.3 155.8c-5 2.3-1.8 7.6-9.5 10.6s-13.2 10-11.5 15.8c5.3-11.5 14.6-11 17.9-15.6s8-11.1 3.1-10.8z"
        />
        <svg:path
          d="M432.7 156.6c-.3 9.2-7.5 5.8-4.7 18.7a26 26 0 0 1-.2 17c8-5.8 2.9-18.2 6.5-22.9a33 33 0 0 0 5-8.8c-2 5.3-1.8 15 3.3 17.6-4.1-9.8 11.2-17.8.6-29.1-1.5 2.7-6.2 7.6-10.5 7.5zm-25.6-9.2c1.2 2 2.5 6.7 1.4 9.3a22 22 0 0 0 7.2-8c5.2.7 7.2 7.1 2.3 10 3 0 8.2 0 11-3.5-3.5-3.9-14.4-9.9-22-7.8z"
        />
        <svg:path
          d="M329 129.4a10 10 0 0 0-4.7-2c-7.6-1.5-3.6-8.3 2.8-8.3 13.8-15 21.6-3.4 38.4-8.2 6-1.7 10-1.2 13.2.2 7.5-5 16.3-3.6 22.7 2.3q1-1.7 3-2.4c6-1.6 10.7 3.4 12.3 10 4.6-1 9.9 1.4 13.4 4.5q7.2-3.8 9.2 0c4.3-2 9.8-3.3 12.6 3.5s-6.5 4.7-8 19c-1 8.9-10.8 12.4-18.6 7-12.5-8.3-24.6-9.7-30.7 3.1s-10.7 20.3-25.3 16c-5.3-1.4-12 .6-16.3 6.4-4.3 5.7-10.8.3-18.6 1 9.8-1.5 6-4 14.5-4.6 7.8-.5 5.8-7.7 10.8-8.8-19.5 5-18.8-2.2-34.9 2.8 7-9 18.1-4 23.6-9.3-14.5-.2-21-9.7-27.6-5.8-10.3 6.3-5.8 24.2-32.6 22.6-13-.7-21.4 1-29.2 8.8 13.6-28 32-12.6 41-21.6a66 66 0 0 0 12-14.3 6 6 0 0 1 4-3.1c-22.4-7-8.9-18 13-18.8z"
        />
        <svg:path
          stroke-linecap="round"
          d="M439.3 125.5q.6 1 .5 2.7c0 5.6-8.2 5.8-8.7 14-.3 4.2-.8 6.6-3.7 6.1s-5.4-5-2.6-10.3"
        />
        <svg:path
          d="M333.1 121.2a11 11 0 0 0-6-2m51.5-8.1c6.7 2.9 9.9 9.8 19.6 10 9.3.4 15 13.9 30.6 5.1l1.2-.6m-28.6-12.2a12 12 0 0 0-1.3 8m-29 20.4c-11.9 0-14.9 6-14.9 11.8s5.6 13.3 15.3 13.3 15.1-6 15.1-12.6-6-12.5-15.6-12.5z"
        />
        <svg:path
          d="M373.2 166.6c-.3-3.2-6.2-2.7-6-5.2s3.3-3.6 3.3-7 5.3-3.8 7-1 7.1 8 8.2 5.3m-8.1-5.4a10 10 0 0 0-.4 12.8m4.1-8.5c-.8 1.9-1 4.8 0 6.5"
        />
        <svg:path
          fill="none"
      ...
      <svg:path
        stroke="none"
        d="M416.9 121c-2.8-3-8.8-.7-7.1 5.3a9 9 0 0 1 7-5.4zm-17.1 16a21 21 0 0 1 5.5-3 12 12 0 0 0-3.7-5.1c-1.4-1-5.6 4.6-1.8 8.1"
      />
      <svg:path
        fill="none"
        stroke-linecap="round"
      ...
      <svg:path
        fill="#fff"
        stroke-width=".4"
        d="M416.6 121a9 9 0 0 0-6.8 5.3"
      />
    </svg:g>
  `,
  host: {
