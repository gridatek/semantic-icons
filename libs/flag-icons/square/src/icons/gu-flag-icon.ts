...
@Component({
  ...
  imports: [],
  template: `
    <svg:path fill="#be0027" fill-rule="evenodd" d="M0 0h512v512H0z" />
    <svg:path fill="#3b5aa3" fill-rule="evenodd" d="M20.5 20.5h470v471h-470z" />
    <svg:path
      fill="#cbe0e5"
      fill-rule="evenodd"
      d="M251.9 396.1c1.8 1 4.7 1 6.3.1 103.3-55 103.4-205.8.1-260a8 8 0 0 0-6.6.1c-100.7 55.1-101 204.2.2 259.8"
    />
    <svg:path
      fill="#add2d9"
      fill-rule="evenodd"
    ...
    />
    <svg:path fill-rule="evenodd" d="M238.7 319.8h3.6v6h-3.6z" />
    <svg:path
      fill="#fdf9ff"
      fill-rule="evenodd"
    ...
    <svg:path
      fill="#bd0728"
      d="M218.7 255.7q2.6 0 4.5 1 2.7 1.4 3.3 5h-2.4q-.5-2-2-3-1.3-.9-3.5-.9-2.5 0-4.3 2-1.7 1.9-1.7 5.7 0 3.2 1.4 5.3 1.5 2 4.7 2 2.5 0 4.1-1.4 1.7-1.4 1.7-4.7h-5.7v-2h8v9.8h-1.6l-.6-2.4q-1.2 1.4-2.2 2-1.7.9-4.2.9-3.2 0-5.6-2.1-2.6-2.7-2.6-7.3t2.5-7.3 6.2-2.6m-.4 0"
      aria-label="G"
