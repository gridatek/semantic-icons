...
@Component({
  ...
  template: `
    ...
    <svg:circle cx="75.2" cy="189.2" r="64.2" fill="#ffe000" />
    <svg:path
      fill="#802000"
      stroke="#7b3100"
      stroke-width="1.4"
      d="M70.7 237.6h16s.8-1.5-.1-2.2-4.3-1-3.4-3.5c2-5.4 2.2-3.7 3.4-16.4s1.7-32.6 1.7-32.6H86s.5 6.2-.9 14.3c-1.3 8-1.7 8.7-3.2 15-1.4 6.1-1.7 6.6-3 10.3-1.3 3.6-1.5 3.7-3.5 7l-2.5 4.2c-.6 1-1.3.7-1.7 1.4-.4.8-.5 2.5-.5 2.5z"
    />
    <svg:path
      fill="green"
    ...
    />
    <svg:g fill="#ffe000" transform="translate(-25.8 103.5)scale(.05833)">
      <svg:use
        xlink:href="#cc-a"
        width="100%"
        height="100%"
      ...
      <svg:use
        ...
        y="2205"
      />
      <svg:use xlink:href="#cc-a" width="100%" height="100%" x="7560" y="840" />
      <svg:use
        xlink:href="#cc-a"
        width="100%"
        height="100%"
