...
@Component({
  ...
  template: `
    ...
    />
    <svg:use xlink:href="#hk-a" transform="rotate(72 248.5 259.5)" />
    <svg:use xlink:href="#hk-a" transform="rotate(144 248.5 259.5)" />
    <svg:use xlink:href="#hk-a" transform="rotate(216 248.5 259.5)" />
