...
@Component({
  selector: 'svg[siLsFlagIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:path fill="#fff" d="M0 0h512v512H0z" />
    <svg:path fill="#009543" d="M0 358.4h512V512H0z" />
    <svg:path fill="#00209f" d="M0 0h512v153.6H0z" />
    <svg:path
      stroke="#000"
      stroke-width="1.7"
