...
@Component({
  ...
  imports: [],
  template: `
    <svg:path fill="#ffb700" d="M0 0h512v512H0z" />
    <svg:path fill="#ff5b00" d="M21.3 256 91.4 21.3h70.1v469.4h-70z" />
    <svg:path fill="#005641" d="M21.3 21.3h70.1v469.4h-70z" />
    <svg:path fill="#8d2029" d="M182.7 21.3h308v469.4h-308z" />
    <svg:path
      id="lk-a"
      fill="#ffb700"
      stroke="#000"
    ...
    />
    <svg:g transform="matrix(.8 0 0 .8 0 3.2)">
      <svg:use
        xlink:href="#lk-b"
        width="100%"
        height="100%"
