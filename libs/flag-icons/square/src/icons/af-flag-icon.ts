...
@Component({
  ...
  template: `
    <svg:g fill-rule="evenodd" stroke-width="1pt">
      ...
      <svg:path fill="#bf0000" d="M170.7 0h170.6v512H170.7z" />
    </svg:g>
    <svg:g
      fill="#fff"
      fill-rule="evenodd"
    ...
    >
      ...
      />
      <svg:path stroke="none" d="M257.7 242.8H342l-7.5-6.1h-69.4z" />
      <svg:path
      ...
      />
      <svg:path fill="none" d="M289.4 211.7h3.3v7.6h-3.3z" />
      <svg:path
        fill="none"
      ...
      />
      <svg:path d="M315.4 210.3h1v7.1h-1z" />
      <svg:g id="af-a">
        <svg:path
        ...
        />
        <svg:path d="m255.6 184.5 1-.6 17.7 29.9-1 .6z" />
        <svg:path
        ...
        />
        <svg:path d="M242 166.6c-4.2-2-1.5-7.2 0-10.3-.6 4.1 2.8 7.2 0 10.2z" />
        <svg:path
        ...
        />
        <svg:path d="M252.8 268.6c1 2.7-8.3 2-11.6.5 5.3 0 10.8-2.4 11.6-.5z" />
        <svg:path
        ...
        />
        <svg:path d="M247.4 239.6c2.7.8 3.5-4 1.8-7.8.3 4.1-4.3 6.6-1.8 7.8z" />
        <svg:path
          d="M249.5 243.4c2.6 1.3 3.5-3.6 1.7-7.1.2 4.5-3.7 5.9-1.7 7z"
        />
        <svg:path d="M248.4 243.7c-1 3-7-2.7-8-5.8 3.7 3.7 8.7 3.2 8 5.7z" />
        <svg:path
        ...
        />
        <svg:path d="M221.7 228c-1.9 2-7.7-3.5-9.7-6.3 3 2.7 10.5 3 9.7 6.3z" />
        <svg:path
