...
@Component({
  ...
  imports: [],
  template: `
    <svg:path fill="red" d="M204.8 0H512v512H204.7z" />
    <svg:path fill="#060" d="M0 0h204.8v512H-.1z" />
    <svg:g
      fill="#ff0"
      fill-rule="evenodd"
      stroke="#000"
    ...
    >
      ...
      />
      <svg:path
        d="m299.5 317.1-3 4.4a259 259 0 0 1-34.7 8.9 315 315 0 0 1-57.2 5.2c-43.1-.6-78.4-9-95-16.2l-1.4-2.3.3-.4 2.2.9a306 306 0 0 0 94.1 15.5c20 .1 40-2.3 56.1-5.1 24.8-5 34.8-8.7 37.9-10.4zm5.7-9.4h.1l-2.2 3.8c-5.7 2-21.3 6.6-44 9.8-15 2-24.3 4-54 4.6a371 371 0 0 1-100.5-15l-1.2-2.5a424 424 0 0 0 101.7 15c27.2-.6 38.8-2.6 53.6-4.7 26.5-4 39.8-8.4 43.8-9.7l-.1-.2z"
      />
      <svg:path
        stroke-width=".7"
        d="M305.8 253.4c.2 32-16.2 60.8-29.4 73.5a106 106 0 0 1-72.3 30c-32.3.6-62.7-20.5-70.9-29.7-16-18.1-29-41-29.4-72 2-35 15.7-59.3 35.6-76a106 106 0 0 1 68.4-24.2c25.4.7 55.2 13.2 75.7 38 13.4 16.2 19.3 33.8 22.3 60.5zM204.4 143.8c62 0 113 50.5 113 112.3a113 113 0 0 1-113 112.3c-62 0-112.6-50.4-112.6-112.3s50.6-112.3 112.6-112.3"
      />
      <svg:path
        stroke-width=".7"
        d="M204.7 143.4c62 0 112.6 50.7 112.6 112.7s-50.6 112.7-112.6 112.7A113 113 0 0 1 92 256a113 113 0 0 1 112.7-112.7zM94.5 256.1c0 60.6 49.8 110.2 110.2 110.2s110.1-49.6 110.1-110.2S265.1 146 204.7 146A110.6 110.6 0 0 0 94.5 256.1"
      />
      <svg:path
        stroke-width=".7"
        d="M204.8 152.8c56.5 0 103.1 46.5 103.1 103.2s-46.6 103.2-103.1 103.2A103.6 103.6 0 0 1 101.5 256c0-56.7 46.6-103.2 103.2-103.2zM104 256c0 55.4 45.5 100.7 100.8 100.7S305.5 311.4 305.5 256 260 155.3 204.7 155.3 104 200.6 104 256"
      />
      <svg:path stroke-width=".7" d="M209.3 143h-9.7v226.4h9.7z" />
      <svg:path
        stroke-width=".7"
        d="M208.3 141.7h2.5v229h-2.5zm-9.6 0h2.5v229h-2.5z"
      />
      <svg:path
        stroke-width=".7"
      ...
      />
      <svg:path
        d="M204.3 297.5c19.4.3 38.5 1 57 4.5l-1.4 2.4a298 298 0 0 0-55.5-4.3c-25.8-.2-52 2.2-74.6 8.7-7.2 2-19 6.6-20.3 10.4l-1.3-2.2c.4-2.2 7.6-6.9 21-10.6 26-7.5 50.3-8.7 75-9zm.9-9.8a351 351 0 0 1 61.1 5.3l-1.4 2.5a319 319 0 0 0-59.6-5.2c-25.9 0-53.3 1.9-78.3 9.1-8 2.4-22 7.4-22.4 11.4l-1.3-2.3c.3-3.6 12.3-8.4 23.2-11.6a285 285 0 0 1 78.7-9.2"
      />
      <svg:path
        stroke-width=".7"
      ...
      <svg:path
        stroke-width=".7"
        d="M100.8 208.5c6.5-4.3 53.7 16.7 103 46.5s96.4 63.6 92.2 70l-1.4 2.1-.7.5c.2 0 .9-1 0-3.3-2.2-6.9-35.5-33.5-91-67-54-32.2-99-51.6-103.5-46zm205.3 101.2c4-8-39.7-41-94-73.1-55.5-31.5-95.6-50-102.9-44.5l-1.6 3 .4-.5c1.3-1.1 3.5-1 4.5-1 12.6.1 48.6 16.6 99 45.6 22.1 12.8 93.4 58.6 93.1 71.4 0 1.1.1 1.3-.3 1.9z"
      />
    </svg:g>
    <svg:g transform="translate(-68.3 28.4)scale(1.13778)">
      <svg:path
        fill="#fff"
        stroke="#000"
        stroke-width=".7"
      ...
      <svg:g id="pt-f" fill="#fff">
        ...
        />
        <svg:circle cx="236.1" cy="195.7" r="1.5" />
        <svg:circle cx="244.4" cy="195.7" r="1.5" />
