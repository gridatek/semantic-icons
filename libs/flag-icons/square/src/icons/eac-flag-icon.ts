...
@Component({
  ...
  template: `
    ...
    />
    <svg:path fill="red" d="M0 309.8h512v38.4H0z" />
    <svg:path fill="#000001" d="M0 163.8h512v38.4H0z" />
    <svg:path fill="#ff0" d="M0 220.2h512v71.7H0z" />
    <svg:path
      id="eac-c"
      fill="#008300"
      fill-opacity="1"
    ...
    />
    <svg:g transform="translate(-41.5 719.6)scale(.9309)">
      <svg:path
        fill="#fff"
        stroke="#000"
        stroke-width="2"
      ...
      />
      <svg:g id="eac-d" fill-rule="evenodd">
        <svg:path
          fill="#008300"
      ...
      />
      <svg:g fill-rule="evenodd" stroke="#000" stroke-width=".4">
        <svg:path
          fill="#0087ff"
