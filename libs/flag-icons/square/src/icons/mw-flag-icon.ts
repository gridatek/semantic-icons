...
@Component({
  ...
  template: `
    <svg:defs>
      <svg:clipPath id="mw-a">
        <svg:path fill-opacity=".7" d="M179.7 0h708.7v708.7H179.7z" />
      </svg:clipPath>
    </svg:defs>
    <svg:g
      fill-rule="evenodd"
    ...
    >
      <svg:path fill="#f41408" d="M0 0h1063v708.7H0z" />
      <svg:path fill="#21873b" d="M0 472.4h1063v236.3H0z" />
      <svg:path fill="#000001" d="M0 0h1063v236.2H0z" />
      <svg:path
        fill="#f31509"
      ...
      <svg:path
        fill="#f31509"
        d="M365.5 223.8c-32.5-2.5-67-9.9-72.6-12s-5.9-5.4-5.2-8a7 7 0 0 1 8.5-4.5c7.9 2 39.9 10.5 69.3 24.5"
      />
      <svg:path d="M275.3 214.7H803V234H275.3z" />
    </svg:g>
  `,
  host: {
