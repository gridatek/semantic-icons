...
@Component({
  ...
  template: `
    ...
    <svg:path
      ...
      stroke="#000"
      stroke-width=".9"
      d="M373.4 348.6s-2.3 6-3.6 6-6-2.5-6-2.5-3.5 5.5-5.3 5.8c-1.8.4-6.6-.8-6.6-.8s-4.5 0-4.7-.6.2-2 .2-2-6.6 5.2-8 4.9-6.4-6.5-6.4-6.5l-.8 3.2-9.3-.3-8.2-5.2s-4.6 7.5-4.8 7.3c-.1-.1-8 1.8-8 1.8l-.5-1.4-5.2-3.1s4-5.8 4-6l-1.9-.7-3 2.4-6 4-6-2.8 2.6-5 .3-3.6 4.8-7.1 58-56.4 28.6 52.8z"
    />
    <svg:path
      fill="#fff"
      stroke="#000"
    ...
    <svg:path
      ...
      stroke="#000"
      stroke-width=".9"
      d="m355.8 182.9 1.5-5.2s2.7-4.5 2.7-6.5 2-4.3 2-4.3 6-1.7 7.4 2c6.5-9.9 14.2-.5 14.2-.5l2.1-2.5 4.3-5.3s6.2 5.8 6.3 6.8 1 .3 1 .3l6.7-.6a8 8 0 0 0 2.6 7.3c2.3 1.4 4.4 9.6 4.4 9.6z"
    />
    <svg:path
      fill="#656263"
      stroke="#000"
    ...
    <svg:path
      ...
      stroke="#000"
      stroke-width=".9"
      d="m347.3 247.2 21.3-.4s14 0 15.5 4.6c2.7-6.1 14.9-5.7 14.9-5.7l22-.8.4 53.2a57 57 0 0 1-35.7 41.4 55 55 0 0 1-36.1-41.8z"
    />
    <svg:path
      fill="#006b00"
      stroke="#000"
    ...
    <svg:path
      ...
      stroke-linecap="round"
      stroke-width=".5"
      d="M376 291.7c1.2.6 1.1-22.4 2.7-23.1l1.2-4.8c-1.3-2.4-7.4-2.2-9.6-.2l1.5 4.3c3 4.9 2.4 24.3 4.2 23.8z"
    />
    <svg:path
      fill="#cdad56"
      stroke="#000"
    ...
    <svg:path
      ...
      stroke-linecap="round"
      stroke-width=".5"
      d="M387.6 276.8s.3 2.4 1 2.4-1.1.6-1.8.1c.8 1 1.2 3 0 3.7"
    />
    <svg:path
      fill="#e80000"
      stroke="#006b00"
    ...
    <svg:path
      fill="#006b00"
      d="M389.2 267.3s2.4-1 2.8-1.5a7 7 0 0 0 1.5-2.1c.2-.7-1.6-1.8-.7-3.4q.8-1.1 2.7 0c1.3.9-1.2-2.6-2.6-2.7-1.3-.1-2.2 1-2.5.7-.4-.2 0 1-.5 1s1.1 1 1 1.5c0 .6 1.8 2.6 1.7 3.1s-2.8 3.2-3.4 3.4"
    />
    <svg:path
      fill="#ffc900"
      stroke="#ffc900"
      ...
      stroke-linejoin="round"
      stroke-width=".5"
      d="M391 259.4q1.3-.5 1 1-.6-.4-1-1"
    />
    <svg:path
      fill="#e80000"
      stroke="#006b00"
    ...
    <svg:path
      fill="none"
      d="M371.3 267.7c-.2.7.8 1.6 1.4 1.4.2-.7-1.1-2-1.4-1.4"
    />
    <svg:path
      fill="#e80000"
      stroke="#006b00"
    ...
    <svg:path
      fill="url(#gs-d)"
      d="M371.8 262.1s4.8-1.3 7.3.7c2.6 2 2.6.2 2.6.2s3.7 1.4 4.8 1.1-.8.1.7-.8-3 .2-3.4-1.7c-.6-1.1.1-2.6-1.4-2.1-1.1-1.4.7-2.4.3-3.8-1.1.7-1.7-.3-2.6 1.6-2-.4-.3-3.2-2.5-3.5 0 2-1.7 2.2-1.8 3.3-1 .7-5.3 3.3-4 5"
    />
    <svg:path
      fill="#c01500"
      stroke="#000"
    ...
    <svg:path
      ...
      stroke="#000"
      stroke-width=".9"
      d="M305.3 407.9s10.6 7.3 10.8 10.7c28.7-42.6 101.9-55.8 143.6-3a31 31 0 0 1 11.3-9.7c-44-57.3-131.3-50.2-165.7 2z"
    />
    <svg:path
      fill="#1e5aa6"
      stroke="#000"
      stroke-width=".9"
      d="M414 245.2h4.2l-7.4 9.4 9 10.4-17.7 22.2 16.6 20q-2.7 6.8-6.8 12.3l-9.5-10.6 17.3-21.6-14.2-16.1zm-59.7 1.9-4.4.1 8.3 9-8.8 11.1 18.4 20-15.3 20.4a60 60 0 0 0 7.3 13.1l9-11.4-18.5-20.7 13.6-17.3z"
    />
    <svg:path
      fill="#1e5aa6"
      stroke="#000"
      stroke-width=".9"
      d="m375 300.8-6.5 8.8 23.4 27.2c4.2-2.1 7.4-4.5 11-7.4l-12.2-14.1 5-14.7 7.1 8.3-22.4 28.6a49 49 0 0 1-11.6-7.2l11.8-15zm-7.2-13.6 4.2 5.4-2.7-7.3zm30.6 4.8 3.5-4.6-1.3-1.8z"
    />
    <svg:path
      fill="none"
      stroke="#fff700"
    ...
    <svg:path
      ...
      stroke="#000"
      stroke-width=".9"
      d="M442 228.7s14.2.6 14.2 2-10.5 4-10.7 9.8 8 6.3 8.6 13.6c.6 7.4-6.3 8.5-7.7 10.5-1.4 1-4.8 11.3-4.3 17.5.4 6 2.2 26.8 5.4 31 2.5 1.9 6.2 8.1 10.3 6.2 4-2 1.2-9 .8-11s1.7-5.1 1.7-8-1.6-5.3-1.4-6c.1-.7 11.2 2.6 10.5 13.6s-5.1 7.6-5.1 7.6 1.4 13.5-2.1 15.3c-6.2 3.4-10.8-.7-10.8-.7l.6 2.8-4.8-2.5s-6.1-8.7-7.5-12.6a110 110 0 0 1-2.5-25c.6-3.8 1-25.7.7-26.9-.3-1-1.4-19.4-.7-22.2s5-15 4.9-15z"
    />
    <svg:path
      fill="#ff7000"
      stroke="#000"
      stroke-width=".9"
      d="M426.8 225s9.8-9.5 15.5-8.4c3 0 .2 2.1.2 2.1s5 .4 5.7 2.6c.1 1-2.4 1.3-2.4 1.3s2 .4 2.2 2.2-21 .4-21.2.3z"
    />
    <svg:path
      fill="none"
      stroke="#000"
    ...
    <svg:path
      ...
      stroke-linecap="round"
      stroke-width=".9"
      d="M463.9 280.3s.8 5.1-1.6 8.6c-1.2 1.4-5 3.7-5 5.4s1.4 3.9 1.2 5.8c-.3 2-2.4 4-2.3 5.6 0 1.6 2.4 10.5 2.1 10.7m-6.6-52.8s-5.3 1.8-6.4 7"
    />
    <svg:path
      fill="#c75b00"
      stroke="#000"
    ...
    />
    <svg:path d="M453.7 221.6q0 .3-.6.4-.5 0-.6-.4t.6-.5q.6 0 .6.5" />
    <svg:path
      fill="#fff"
      stroke="#000"
      stroke-width=".9"
    ...
    <svg:path
      ...
      stroke="#000"
      stroke-width=".9"
      d="M400.9 181.4s11 .3 11.1 6.2-3.3 4.3-3.4 4.3l-8-1z"
    />
    <svg:path
      fill="#fffeff"
      stroke="#000"
    ...
    <svg:path
      ...
      stroke="#000"
      stroke-width=".9"
      d="m382.5 179.1 8 .7s4.7.6 4.5 5.2-4.9 4.7-4.9 4.7l-7.7-.5z"
    />
    <svg:path
      fill="#fff"
      stroke="#000"
    ...
    <svg:path
      ...
      stroke="#000"
      stroke-width=".9"
      d="m382.3 179.1-7.9.7s-4.8.6-4.5 5.2 4.8 4.7 4.8 4.7l7.7-.5z"
    />
    <svg:path
      fill="#5e0043"
      stroke="#000"
    ...
    <svg:path
      ...
      stroke="#000"
      stroke-width=".9"
      d="M368.3 229.9s11 6.8 14.7 7 15.2-8.9 15.2-8.9"
    />
    <svg:path
      fill="#5e0043"
      stroke="#000"
    ...
    <svg:path
      ...
      stroke-linejoin="round"
      stroke-width=".9"
      d="M360.9 203c.9 1 7.7 9.4 9 16.3s-.7-9.5-.7-9.5 8.5 4.2 8.8 6.9c.2 2.6 4-.2 4.2-.7l-24.6-16zm42.1-.5s-9 11.8-8 24.6c-1.8-6.1-.3-16.3-.3-16.3l-2 1.3s-2 8.6-4.5 10q-.6-1.5-.4-1.4c.2.1-2.7 3.5-3.3 3.9s.2 12 .2 12 1 8.4 2 8.3l-2.7 1.5-1.1-22.5 2.5-2.5s3.4-4.1 3.6-8.1a8 8 0 0 1-3 1.6s-.5 5.7-1.8 6.5-1.4 2.2-1.4 2.2l-.3-7.4z"
    />
    <svg:path
      fill="none"
      stroke="#000"
    ...
    <svg:path
      ...
      stroke="#000"
      stroke-width=".9"
      d="m355 198.3 27.5 18 24.6-16.7s5.2-2.8 4.7-4.8-2.2-1.3-3-1c-1 .4-25.9 18-25.9 18l-26.5-16.7s-2-.6-2.3.6c-.4 1.3.7 2 1 2.6z"
    />
    <svg:path
      fill="#474747"
      stroke="#474747"
      stroke-linejoin="round"
      stroke-width=".9"
      d="M404 193.6s-7-3-7-.4.3 2.9 1.4 4.5-.9 2.7-.9 2.7l-.6-1.8c-.4-1.1-4.2-2-4.5-3.2-.4-1.4.8-3.5-1.5-3.7s-4.4.9-4.9 3.5c-.4 2.5-3.3 8.6-3.3 8.6l.3-13.7c5 .3 14.2 1.4 21.2 2.2-2.1-.3.8.2.7.9s-.9.6-.8.4zm-24.7-3.4c-1.3 0-7.6.7-9.1 1.7-1.6.9 2.5 2.3 2 3.6-.5 1.2-.6 3.8-2.6 3.2s-8.6-3.8-8.8-5c-.2-1-1.6-1.1-1.6-1.1s19.2-2.6 20-2.4z"
    />
    <svg:path
      fill="none"
      stroke="#000"
    ...
    />
    <svg:path
      d="M359.4 119.3q-.3 1-2 .5t-1.5-1.6q.4-1 2-.5t1.5 1.6m2.9-.3q.4 1 2.1.6 1.6-.6 1.5-1.6-.5-1-2-.5-1.6.6-1.6 1.6z"
    />
    <svg:path
      fill="#ff7000"
      stroke="#000"
      stroke-linejoin="round"
      stroke-width=".9"
      d="M447 330.2s-2.8.5-2.7.8c.1.2-7.8.5-8 .2-.1-.2-1.1 1.4-1.1 1.4l1.2-.8s2 2 2.6 1.8c.5-.1-.3.8-.1 1s.7-.4.7-.4l13-.2zm4.8 4.1-10.7.3s-2.6 2.4-2.8 3 1.7.7 1.7.7l.6 2 1.4-.5s9 1.4 17.3-.5c4.2-1.4 5-3.2 2-4.3s-9.5-.7-9.5-.7z"
    />
    <svg:path
      fill="url(#gs-g)"
      stroke="#000"
    ...
    <svg:path
      ...
      stroke="#2b2b2b"
      stroke-width=".9"
      d="M320.2 220c.3.5-.4 1.5-1.6 2.2-1.2.6-2.4.7-2.7 0-.3-.5.4-1.5 1.6-2.1s2.4-.7 2.7-.1z"
    />
    <svg:path d="M318.5 221q0 .5-.7.6t-.7-.6.7-.7.7.7" />
    <svg:path
      fill="none"
      stroke="#2b2b2b"
      stroke-width=".4"
    ...
    <svg:path
      ...
      stroke="#2b2b2b"
      stroke-width=".9"
      d="M327.5 214.5s-2.8.7-3.1 1.9c-.4 1-2 2.2-2.9 1.8s-2.5-1.7-2.5-1.7"
    />
    <svg:path
      fill="#2b2b2b"
      stroke="#2b2b2b"
    ...
    <svg:path
      ...
      stroke="#2b2b2b"
      stroke-width=".9"
      d="M335.2 218.3s-7.6-2.2-10.2 1.5-2 5.9-.6 6.2"
    />
    <svg:path
      d="M336.3 218.1q-.1 1.5-1.4 1.6-1.3-.1-1.4-1.6.1-1.5 1.4-1.6 1.3.1 1.4 1.6"
    />
    <svg:path
      fill="#2b2b2b"
      stroke="#2b2b2b"
      stroke-width=".9"
      d="M314.3 237.5s3 4.7 6.8 6-2.6 2.5-6.3 0c-2.6-3.7-2-6.3-2-6.3s.8-.7 1.5.3zm26.4 28s-8.6-12-11.1-12.7 1.9-1.2 4.5 1.4c2.7 2.5-.7-4.2-.7-4.2z"
    />
    <svg:path
      fill="#2b2b2b"
      stroke="#2b2b2b"
    ...
    <svg:path
      ...
      stroke="#2b2b2b"
      stroke-width=".9"
      d="M283.3 292.6s9.2-2.4 11.6-2.3c2.3 0 11.3 4.2 14 6.8 2.5 2.5 7.9 8.6 11.4 8s4.5-1.2 4.5-1.2l-1.4 2.6s-2.8.8-4.2.4c-1.5-.3-4.2-1.2-7-4s-11.4-10-18.8-9.5c-7.3.5-11.5 7.7-11.5 7.7s0-3.5.4-4.3c.3-.8-1.6 1.7-1.6 1.7z"
    />
    <svg:path
      fill="#2b2b2b"
      stroke="#2b2b2b"
      stroke-width=".9"
      d="M317.2 299.7s2.3.7 6.1.7 5.9-1.7 5.9-1.7l-.3-1.5.6-2s3 3 2.9 3.5-1.2.9-1.2.9l-.4-1.5-1 1.3s-5.6 4.4-8.6 3.7c-3-.6-5.8-2.6-5-3q1.1-.6 1-.4zm-13.4 7.8s-3.3 0-4.8.7-2 1.6-3 1.4c-1 0-1.8-1.4-1.5-2s2.3-1.8 6-1.5 3.3 1.4 3.3 1.4zm11.6 9c0-.1-.2-4.8-2-6.7a6 6 0 0 0-5.2-1.7c-1 .2 3.8 2.3 4.3 3.7s2 5.2 1.6 6.1c-.5 1-1.2-2.7-4.1-3.7-3-1-7-.4-6.2.9.9 1.3 4.1 0 5.8 2.9 1.7 2.8 3 5.7 3 5.7l.5-2 1.4-.4.2-3.9z"
    />
    <svg:path
      fill="#2b2b2b"
      stroke="#2b2b2b"
    ...
    <svg:path
      ...
      stroke-linejoin="round"
      stroke-width=".9"
      d="M300.3 331.8s4 .5 5 2.5c1.1 2 1.6 5.1 1.6 5.1.6-1.3 1-2.4 2.2-3.4s2.3-1 2.2-1.8c0-.7-4.1-5-6.2-5.2-2-.3-5.7 2.2-5.7 2.2s-.7 1 1 .6z"
    />
    <svg:path
      fill="none"
      stroke="#8a9396"
