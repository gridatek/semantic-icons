...
@Component({
  selector: 'svg[siBaFlagIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:defs>
      <svg:clipPath id="ba-a">
        <svg:path fill-opacity=".7" d="M0 0h512v512H0z" />
      </svg:clipPath>
    </svg:defs>
    <svg:g fill-rule="evenodd" clip-path="url(#ba-a)">
      <svg:path fill="#009" d="M0 0h512v512H0z" />
      <svg:path fill="#fc0" d="m77 0 437 437V0z" />
      <svg:path
        fill="#FFF"
