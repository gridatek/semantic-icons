...
@Component({
  selector: 'svg[siIrFlagIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:defs>
      <svg:clipPath id="ir-a">
    ...
    >
      ...
      <svg:g fill="#fff" stroke-width="1pt">
        <svg:path
      ...
      <svg:g fill="#da0000">
        <svg:path
          d="M457 191.4c8.3 10 33.5 65.5-15.2 101.9-22.9 17.2-8.7 18-8 21 36.8-19.6 48.8-46 48.5-69.8s-12.8-44.6-25.2-53.1z"
        />
        <svg:path
          d="M462 188.8a71 71 0 0 1 15 108.8c26.4-5.8 60-83.7-15.2-108.8zm-55.9 0a71 71 0 0 0-15 108.8c-26.5-5.8-60.1-83.7 15-108.8"
        />
        <svg:path
          d="M411 191.4c-8.2 10-33.5 65.5 15.2 101.9 22.9 17.2 8.7 18 8 21-36.7-19.6-48.8-46-48.5-69.8s12.9-44.6 25.3-53.1"
        />
        <svg:path
