...
@Component({
  ...
  imports: [],
  template: `
    <svg:path fill="#3e5eb9" d="M0 0h512v512H0Z" />
    <svg:path fill="#ffd900" d="M0 96h512v320H0Z" />
    <svg:path fill="#b10c0c" d="M0 128h512v256H0Z" />
    <svg:g
      fill="#ffd900"
      stroke="#000"
    ...
    />
    <svg:g stroke="#fff" transform="translate(-42.4 58.8)scale(.98607)">
    ...
    <svg:g fill="#a70000">
      ...
      <svg:path
        ...
        stroke="#000"
        stroke-width=".8"
        d="M207.9 186.5c-4 7.5 6.8-2.5 23.6 10.2a29 29 0 0 1 7.6 15.9 51 51 0 0 1-9.9-4.4s7.5 7.5 7.5 16.1c-2.7-1.6-4-1.4-5-3.4 0 2.8 2.5 4.5 2.5 8.8a35 35 0 0 0-5.2-3.4c2.5 4.3-4.5 12.7-1 15.4a22 22 0 0 1-14.9-9c-1.3.8-1.4 2.2-1.5 3.7.2.2-9.3-7-8.4-9.8a8 8 0 0 0-1.8 4.8 26 26 0 0 1-7.9-11.4l-3.2 4c-1.1-7-1.1-6.8 1.2-12.8l-4.6 3.5a41 41 0 0 1 21-28.2z"
      />
      <svg:path
        fill="#b3b3b3"
        d="M198.2 223.3c.7-5.2 2-7 2.4-10.5.8-5.8-.1-10.2 2-10 2 .1 2.6 2.3 1.6 8.1-1 6-2 7.3-6 12.5zm11 9.6c-.5-4.4.3-6.3 0-9.1-.4-5-2-8.3-.2-8.6s2.8 1.3 3 6.4c.2 5-.3 6.3-2.9 11.3zm17 7.8c-1.9-3.8-3.5-5-4.7-7.4-2-4.3-2.6-7.8-4.2-7.2-1.6.7-1.5 2.5.8 6.7 2.4 4.2 3.4 5 8 7.9zm5.9-34c-4.8-2.5-7.2-2.6-10.2-4.1-5.4-2.9-8.5-6-9.6-4.2s.4 3.4 5.9 6c5.5 2.5 7.2 2.6 13.8 2.2zm1.7 14.1c-3.5-2.8-5.5-3.2-7.7-5-4-3.3-5.9-6.4-7.1-5.1-1.3 1.3-.5 3 3.6 6s5.5 3.4 11.2 4.1"
      />
    </svg:g>
  `,
  host: {
