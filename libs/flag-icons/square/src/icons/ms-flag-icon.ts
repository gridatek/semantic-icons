...
@Component({
  ...
  imports: [],
  template: `
    <svg:path fill="#012169" d="M.2 0h512v512H.2z" />
    <svg:path
      fill="#fff"
    ...
    <svg:path
      ...
      stroke="#000"
      stroke-width="1.8"
      d="M286.1 131.4h196.4l-.2 140.2c1.6 56.3-33.4 91.2-97.8 107-45.8-11.4-98.6-35-98.6-105.4z"
    />
    <svg:path
      fill="#a53d08"
    ...
    />
    <svg:path
      d="m376.7 157.5-.3-17.6 14 .1.1 17.5h38.2l.1 13.7-38.3.2-.3 161.4-13.6.1-.2-161.7-38 .2v-14z"
    />
    <svg:path
      fill="#ff9a08"
      fill-rule="evenodd"
      stroke="#000"
      stroke-width=".8"
      d="m345.8 294.8 35 36.3c12-13.3 3.6-63-12.3-72.1-1.9 5.9-5.1 13-8.6 15.2-7.6 5.2-26.1 11.2-20 15 1.5-1.9 5.2-3.7 7 .6 2 6.9-7.8 7.3-7.8 7.3s-6.2-.8-7.3-7c-1-6.4 9.3-12.2 10.1-12.6 1-.3 14.4-4 16.7-15.9 2.8-11.8 5.8-10 6.3-10.2 17.7 1.7 29.2 33.3 29.9 55.5s-9 37-10.8 38-42-47.9-42-47.9z"
    />
    <svg:path
      fill="#ff9a08"
      stroke="#000"
    ...
    <svg:path
      ...
      stroke="#000"
      stroke-width=".3"
      d="M390.6 191.4c2.4-2 3.7-3.3 5.2-3s3.5 0 5-.4a31 31 0 0 1 12-.4c1 .2 2.4.7 4.6 2.5s5.2 5 4.2 13.6-.7 12.3-1.2 17.2c-.8 8.5-2.7 15.5-6 15 4.5 8 5 15 8 20.5s4.8 16.8 3.7 29c-1.2 12.3-4.4 39.7 5.3 58.2-1.6 1.1-5.5 0-9-3.7s-5-3.6-7.9-1.4c-8.7 6.7-17 14.8-29 6.7-2.8-1.8-3.7-4-1.6-9.7 5-14 7.5-33.4 6.7-42.4z"
    />
    <svg:path
      fill="#ffe1cf"
      stroke="#000"
    ...
    <svg:path
      ...
      stroke="#000"
      stroke-width=".3"
      d="M398 165c.7-4 3.6-4 5.4-3.5.8.1 2.6.3 4.3-.2 3.5-.9 6 .3 5.7 3.6 1 .7 1.9 2.3 1.7 3.7q-.4 2 1.4 2.1c1.3.2 4 1.8 2.2 4 1.7 1 3 3.7 2.1 5.4s-3.7 2.1-4.8.5c-1.3.6-3.4.7-4.6-.6-.9 1-3 .9-3.5 0q-.6-1.4-1.9-1.7c-1-.3-1-2.8.4-3.1q-.3-1.3.2-2t-.7-1.8c-.8-.7-1.5-3-.7-4.4-1.4.5-4.4-.9-5-1.8q-1.2-1.4-2.1-.2z"
    />
    <svg:path
      fill="none"
      stroke="#000"
      stroke-width=".3"
      d="M399 182.8c2.2-.3 3-1.7 4.6-1.6m-9.5-4.7.6.4q.7.3 1.4.3m-1.3-3.1 1 .6m4.2-9.7c-1.3-1.2 2.3-3.8 6-.1.7.6 2.5.7 3 .5m-3.8 1.6c1.7-.4 4.3-.4 5 1.5.8 2 2.3.7 3.5 3 1.2 2.4 3.2 5 5 3.2m-7.3 5.3a4 4 0 0 1-.4-3.3c-.7-.8-.4-2.4 0-3.2m-4.6 1.7c0 .7 1 2 2.4 2.2m7.2 3.2q-1-1.4-.5-3.2"
    />
    <svg:path
      fill="none"
      stroke="#000"
      stroke-width=".3"
      d="M407.6 169.1c0 1 .5 2.4 1.6 3 .3.5 1.4 2.1 3.7 1.9m.5-9a11 11 0 0 0-5.3-2.6m-8.8 35.6c-2 2.7-3.2 6.4-2.3 11.6s2.4 12.8-1.4 16.2m18.7 10.1c-2.6-.6-6.4-.6-8.5.9a8 8 0 0 1-7.9.4"
    />
    <svg:path
      fill="none"
      stroke="#000"
      stroke-width=".3"
      d="M408.7 235.7c-2.3.4-3.4 2-3.4 6.3s-.9 10.5-.1 16.6m-.7-21.1c-1.5.4-3 .4-2.8 4.5m-5 0c0-2.4 1-4.7 2.6-4.3m14 4.8c.2-5.4-1-7-2.7-7 2.2.1 3.7.4 4.6 9.4.7 6.6 2.1 9 3.7 14.3 4.2 13.6 2.1 34.6 4.2 42m-12.9-57a72 72 0 0 1-.5 49.3c4.8 13.4 9.7 23.1 10.6 28.6m-24-48c.8-2.8-2-3.2.5-13.3q1.6-6.4.6-8.5"
    />
    <svg:path
      fill="none"
      stroke="#000"
    ...
    />
    <svg:path
      d="M397.2 168.7c.8 1 1.7 1 1.8 1.7l.4 1h-.6l-1.4-.1c-.4 0-.9-.5-.6-.6q.4 0 .2-.3l.3-.6q.1 0 0-.4c-.2-.3-.3-1-.1-.7m.5-1a6 6 0 0 1 3.4 1.5c.7.8.1.6-.2.6q-.7 0-1.4-.6c-.3-.4-1.4-1-2-1.1-.2-.1-.5-.5.2-.4"
    />
    <svg:path fill="#012169" d="M.2 0h256v256H.2z" />
    <svg:path
      fill="#FFF"
    ...
    />
    <svg:path fill="#FFF" d="M88.2 0v256h80V0zM.2 88v80h256V88z" />
    <svg:path fill="#C8102E" d="M.2 104v48h256v-48zm104-104v256h48V0z" />
  `,
  host: {
