...
@Component({
  ...
  template: `
    ...
    <svg:g
      ...
      stroke-width="9.6"
      transform="translate(-272 37.8)scale(.72781)"
    >
    ...
    >
      ...
      <svg:g fill="#f9d050" stroke-width=".6">
        <svg:g id="ky-f">
          <svg:path
          ...
          />
          <svg:path
            d="M912.6 140.5A48 48 0 0 1 937 115a101 101 0 0 0-18.2 35"
          />
          <svg:path
          ...
          />
          <svg:path fill="none" d="M869 149.6a58 58 0 0 1 17.2 16.7" />
          <svg:path
        ...
        <svg:g id="ky-g">
          ...
          />
          <svg:path fill="none" d="M909.7 122.2a8 8 0 0 0-3.4 4.4" />
        </svg:g>
      </svg:g>
      <svg:g id="ky-e" fill="#059334">
        <svg:path
    ...
    <svg:g stroke-width="1.4" transform="translate(-272 37.8)scale(.72781)">
      <svg:path
        id="ky-a"
        fill="#fff"
      ...
      <svg:g stroke="#000">
        ...
        />
        <svg:g fill="none">
          <svg:path d="M858 262.2c-3.4 1.4-4.4 4.8-4.9 6.7" />
          <svg:path
            d="M857.5 265.5c-4.8 3-6.8 5.3-5.8 10.6m8.1 3.9c3-1 4.8-2 7.2-6.3"
          />
          <svg:path d="M865.6 275.6c-1 2 0 5.3-1.4 6.7a9 9 0 0 0 4.8-6.7" />
          <svg:path
          ...
          />
          <svg:path d="M883.8 249.2c-1 .5-2-1-3.3-.4-.5 0-2 .4-2.4 0" />
          <svg:path
