...
@Component({
  ...
  imports: [],
  template: `
    <svg:path fill="#f7e017" d="M0 0h512v512H0z" />
    <svg:path fill="#fff" d="M0 35.6V263l512 106.7v-121z" />
    <svg:path fill="#000001" d="M0 156.4v106.7l512 213.3V369.8z" />
    <svg:g fill="#cf1126" transform="translate(-256)scale(.71111)">
      <svg:path
      ...
      />
      <svg:path d="m726.7 233-5.2 4-4.6-3.4v27.8h9.8z" />
      <svg:path
      ...
      />
      <svg:path d="M724.9 154h-6.3v49.4h6.4z" />
      <svg:path
