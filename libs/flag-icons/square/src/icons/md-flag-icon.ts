...
@Component({
  ...
  template: `
    ...
    <svg:path
      ...
      stroke="#000"
      stroke-width="3.1"
      d="m336.6 467.7 53.2 17.7a38 38 0 0 0 35.4-35.4c.6-39.4-14.2-53.2-17.7-53.2l7-7L404 379s3.6-18.4 39-17.7 35.4 17.7 35.4 35.4c0 17.8-17.7 17.8-17.7 53.2a38 38 0 0 0 35.5 35.4l53.1-17.7V645H336.6z"
    ...
    />
    <svg:path fill="red" fill-rule="evenodd" d="M198.4 203.8h119v56.9h-119z" />
    <svg:path
      fill="#564dff"
      fill-rule="evenodd"
    ...
    <svg:path
      fill-rule="evenodd"
      d="M270.4 311c0 1.2-1.6 2.2-3.5 2.2s-3.4-1-3.4-2.2 1.5-2.2 3.4-2.2 3.5 1 3.5 2.2m-18 0c0 1.2-1.6 2.2-3.5 2.2s-3.5-1-3.5-2.2 1.6-2.2 3.5-2.2 3.4 1 3.4 2.2z"
    />
    <svg:path
      fill="#ff0"
      fill-rule="evenodd"
