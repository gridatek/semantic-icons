  ...
  template: `
    ...
    <svg:g clip-path="url(#mz-a)" transform="scale(1.0321)">
      ...
      <svg:path
        ...
        stroke-width="1.1"
        d="M99.6 281.9h35.8c2.9 3.2 9.3 4.5 15.4 0 11.2-6.2 32.9 0 32.9 0l4.3-4.6-10.4-34.1-3.8-4s-8-4.8-23.2-3.2-20.5-.6-20.5-.6-13.4 1.6-17.1 3.6l-4.3 4.3-9 38.7z"
      />
      <svg:path
        fill="none"
        stroke="#000"
