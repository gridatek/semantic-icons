...
@Component({
  ...
  template: `
    ...
    >
      <svg:path fill="#198a00" d="M0 0h744v496H0z" />
      ...
      <svg:g fill="#ef7d00" stroke="#000">
        ...
        <svg:path
          stroke-linejoin="round"
          stroke-width=".9"
          d="M630 116.5c.1.2 5 5.5 9.6 5.2 1.7-1.4-3.7-4.6-3.7-5.3 2 1.7 9.9 8.5 15 6 2-2.8-3.7-2.4-9.9-10.2 4.3 2.9 15.2 9.3 20.3 6.8 2.1-2.3-11.3-9.6-15.8-15.2l-11.6-6-15.8 13z"
        />
        <svg:path
          stroke-linecap="round"
          stroke-linejoin="round"
          stroke-width=".9"
          d="M612.2 72.5s5.4-3.2 26.8-1.6c2.3.3 14.6-4.2 18.5-5.5 6.2-1.1 26-5.5 31.4-9.5 3.8-.5-1 7-5.8 8.7-5 2.3-23.4 8.7-30 7.8 7.9.1 3.5 6.5-9.5 3.4 6.2 3.5 4 4.1 4 4.1s-11 .6-14-1.9c7.4 2.8 4.4 3.8 4.4 3.8s-7.6.7-11-.9c5.3 1.6 2.6 2.6 2.6 2.6s-4.4.7-8-.6-9.1-10.4-9.4-10.4"
        />
        <svg:path
          stroke-linejoin="round"
          stroke-width=".9"
        ...
        <svg:path
          stroke-linecap="round"
          stroke-linejoin="round"
          d="M543.9 65.6s-3.7 2.8-8.3 2.6c1.1 4.6 10.7 1.1 10.7 1.1s-4.6 5.1-8 6c2 1.5 10.3 1 11.7.2s3.9-4 3.9-4-8.5 9.8-9.8 9.7c-.1 1.1 9 .7 10.9-1s6.6-4.3 6.6-4.3-12.5 8.7-13 8.7c4.6 1.3 14-1.4 20-5.1-8.9 5.9-9.7 7-14.2 9 4 .8 6 3.5 19.7-2.4 7.8-3.7 12.2-10.4 12.2-10.4a79 79 0 0 1-21 17.4c-.4 1 9.1 5 21.3-7.6"
        />
        <svg:path
          stroke-linecap="round"
        ...
        />
        <svg:path d="M608.3 55.7c0-.4-1.6-3.8-7.5.4 3.2.2 6.3 2 7.5-.4z" />
        <svg:path
          stroke-linejoin="round"
        ...
        />
        <svg:path stroke-linecap="round" d="M669.2 87.9c-2 .3-8 .3-9 .1" />
        <svg:path
          stroke-linecap="round"
          stroke-linejoin="round"
          d="M538.8 63s13.2 7 18.8 6.5c-1.5 1.4-3.7 2-3.7 2 1.4.5 5.2 2.6 11 1.2-1.3 1.4-3.1 3-3.1 3s5 1.9 10.6-1l-2.7 3.6 4 .3"
        />
      </svg:g>
    </svg:g>
  `,
