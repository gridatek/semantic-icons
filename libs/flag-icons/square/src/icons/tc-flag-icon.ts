...
@Component({
  ...
  imports: [],
  template: `
    <svg:path fill="#002868" d="M512 512V0H0v512z" />
    <svg:g fill="none" stroke="#000">
      <svg:path
        fill="#fcd116"
        stroke-width="8"
        d="M491 191.5v90c0 60-30 124.6-105 159.6-75-35-105-99.6-105-159.6v-90z"
      />
      <svg:path
        stroke="#fff"
        stroke-width="7"
        d="M491 191.5v90c0 60-30 124.6-105 159.6-75-35-105-99.6-105-159.6v-90z"
      />
      <svg:g stroke-linecap="round" stroke-linejoin="round" stroke-width="2.2">
        <svg:path
          fill="#fcad56"
          stroke-width=".3"
        ...
        <svg:path
          fill="#ffa1a1"
          stroke-width=".3"
          d="M355 222.9a8 8 0 0 0 3.1 6.3c1.9 1.6 3.5 2.8 3.1 4.7s.4 3.2 2 4.5c1.8 1.2 3 2.7 2.6 5.2s-.2 4 .8 5.9 2.8 3.4 2 6.4-.4 7 .6 9c1 1.9 0 3.4-1.7 6.7-1.8 3.3-2.8 4.5-6.4 5.8-3.7 1.1-4 3.4-4 7.2q0 6.2-7.5 5.3c-5 4.1-8.1-.8-9.4-6.9s-1.4-12.8-8.8-18.1c-7.3-5.5-4.4-14.8 1.7-18.5s5.4-14.4 4.6-21c-.6-6.7 3.8-10.4 7.2-14 4.5 1.7 10.1 8.6 10.1 11.5"
        />
        <svg:path
          fill="#f1b2dc"
          stroke-width=".3"
          d="M344.4 265.5c-1.4-3.3-2.9-6.5.7-13.5 3.8-7.1 1.4-12.5.3-16.1-1.1-3.5-1.4-6.8 0-8.3 1.5-1.3 2.1-2.2 2.2-4.6s2-1.5 2.3-.4.5 3-1.5 6.4 5.6 12 2.1 21.1c-2.4 6.4.8 14.5 2 20.2s2 19-6.3 21c5.7-2.7.4-20.6-1.8-25.8"
        />
        <svg:path
          stroke-width=".3"
          d="M307.3 264.5c1.3.3 2-.5 2.4-1.4s.7-1.4 2-1.5c1.2 0 3.2-.4 3.7-1.4s1.9 0 3.2-2.6 2.1-5.6 5.5-6.7m9.3-21.8c-1.3 0-4.9.2-6.4 3.4m-10.4-18.9c3 .9 1.8 2.9 3.3 4 2.7 2.2.2 4.4 2.5 5s2.1 1 1.6 3.5c-.8 2.9 2 3 1 4.9m-13 9.9c1.8-1.7 6.1-2.9 7.1-4.7m-7.2-4c2.6 0 6.1 1 6.6 0m-7-2.8c1.3 0 3.9-.9 4.4-2.7m-6.3-1.3a9 9 0 0 0 5.3-1.5m-7.3-3.4c1.1-.9 3.1.1 5-1.1m-3.1-4.9c.9 0 2.8-.3 2.8.9"
        />
        <svg:g fill="#9e540a" transform="translate(436 266.5)scale(.125)">
          <svg:g id="tc-b">
            <svg:path
        ...
        <svg:g transform="translate(386 316.5)scale(.125)">
          <svg:g id="tc-d">
            <svg:path
              fill="#009e49"
          ...
          <svg:use
            ...
            transform="scale(-1 1)"
          />
          <svg:path stroke="#009e49" d="M0 712V12" />
          <svg:path
    ...
    <svg:path fill="#012169" d="M0-.5h256v256H0Z" />
    <svg:path
      fill="#fff"
