...
@Component({
  ...
  imports: [],
  template: `
    <svg:path fill="#68bfe5" d="M0 0v512h512V.2H322V0z" />
    <svg:g stroke-miterlimit="4.8">
      <svg:path
        fill="#fff"
      ...
      />
      <svg:path fill="#d21034" d="M310.2 254h161.2v52.7H310.2z" />
      <svg:g stroke-miterlimit="3">
        <svg:g
          fill="#fff"
          stroke="#000"
          stroke-width=".8"
        ...
        >
          <svg:ellipse cx="798.2" cy="192.2" rx="13.6" ry="11" />
          <svg:ellipse cx="798.2" cy="186.5" rx="12.1" ry="6.1" />
          <svg:ellipse cx="798.2" cy="198.8" rx="12.1" ry="6.1" />
          <svg:ellipse cx="798.2" cy="192.2" rx="12.1" ry="6.1" />
        </svg:g>
        <svg:path
          fill="#ffd100"
          stroke="#000"
        ...
        />
        <svg:path
          d="M319 277.6s.2-.6.7-.7q.5 0 1.2.8l.2-.2s-1.2-1.8-.7-3q.4-.9 1.6-1v-.4q-1.5.3-1.9 1.3l-.1.8q0 1 .4 1.6l-.8-.2q-.6.2-.8.6zm141 23.9c-3 .5-7.6.7-8-.2 0-.1 0-.8 2.5-2.4l-.3-.5q-3.1 2-2.6 3.1c.6 1.7 7.2.7 8.5.5zm-58.4 1.8q-1-1.7 1-4.4l-.5-.3q-2.2 3-1 5z"
        />
        <svg:path
          d="M397.5 298.7q0 2.7 3.8 5l.3-.4q-3.4-2.1-3.6-4.7c0-2.5 2.6-4.4 2.6-4.5l-.3-.4c-.1 0-3 2.1-2.8 5m52 .6c-.8 1.3-.5 2.8-.5 2.8h.5s-.2-1.4.5-2.5a3 3 0 0 1 2-1.2v-.5q-1.7.3-2.5 1.4M330.3 276h-.2v.1s-.3 1.6-1 2l-.7.1-1.2-.7q-.4-.4-.8-.3a2 2 0 0 1-.4-1.3q.2-1.2 1.5-2.1l-.1-.3q-1.5 1-1.7 2.3c-.1 1 .4 1.6.5 1.7h.1q.4-.1.7.2l1.3.8h1c.7-.5 1-1.9 1-2.2 3.3.7 6-3.3 6-3.4l-.2-.2s-2.7 4-5.8 3.3"
        />
        <svg:path
          d="M322.5 275.4q-.2 1 .3 1.9t1.1 1q.7 0 1.1-.6t.6-.4l.3.2.3-.2-.5-.3q-.5 0-.9.4-.4.6-.9.5-.3 0-.8-.8a2 2 0 0 1-.3-1.7c.3-1.4 2-2.5 2-2.5v-.2c-.1 0-2 1-2.3 2.7M318 296q.3-.9 1.3-1.4c-.1 0 .7.7 1.4.6l.4-.2c.2.1 1.4 1.2 1.4 2.6q0 .5-.2.9l.3.1c1-2-1.3-4-1.3-4h-.2l-.5.3c-.5 0-1.2-.6-1.3-.6q-1.3.6-1.6 1.6zm10.4-5.3c-.7 0-2.6.4-3.2 1.3q-.3.6 0 1.2l.2.7c.6 1.5 1.2 3.1 1.8 3.5l.2-.3c-.6-.3-1.2-2-1.7-3.4l-.3-.6a1 1 0 0 1 0-.9c.6-.8 2.2-1.2 3-1.2.4 0 .5 1.5.6 2.5h.3c0-1.5-.2-2.9-1-2.8z"
        />
        <svg:path
          d="M323.3 292.2a1 1 0 0 0-.3.9c0 .1.1 4 2 4.8l.1-.3c-1.7-.7-1.8-4.5-1.8-4.5s-.1-.4.2-.7q.4-.3 1.6 0v-.3q-1.3-.4-1.8.1"
        />
        <svg:path
          d="M321.8 292.5c-.8.6-.8 2.2-.8 2.3h.3s0-1.6.7-2q.4-.3 1 0v-.3q-.7-.3-1.2 0"
        />
        <svg:g transform="translate(-207.6 158.4)scale(.66486)">
          <svg:path
          ...
          />
          <svg:circle cx="848" cy="177.8" r=".3" />
          <svg:path
            d="M848.8 179.4a.3.3 0 1 1-.6 0q0-.2.3-.2zm-7.1-7.3a.3.3 0 0 1-.6 0 .3.3 0 0 1 .5 0z"
          />
          <svg:circle cx="841.6" cy="173.2" r=".3" />
          <svg:circle cx="840.1" cy="172.7" r=".3" />
          <svg:path
          ...
          />
          <svg:path d="M854.4 172.6a2 2 0 0 1-2.4-1.9s.7 1.8 2.6 1.5z" />
          <svg:path
        ...
        <svg:g fill="#fff" stroke="#000" stroke-width=".2">
          <svg:path
            d="M319 277.1s0 1.7 1.4 2.7c0 0-.2-1.8.2-2.6 0 0-.7-.8-1.7 0zm2.6 1.1s.3 1.5 1.2 2.2l.5-.1s.3-2 .6-2.2-1.3.7-2.3.1z"
          />
          <svg:path d="m323.9 278.1 1 1.6 1.2-.6-.3-1.9s-.7-.2-2 1z" />
          <svg:path
            d="m328.6 278.4-1.3 1.1s-.7-.5-1.3-.4l.3-1.7s1-.7 2.3 1zm-9.4 16s-.2-2.3.1-2.5c0 0 1 .3 1.3 0 0 0 .6 1.9.4 2.6s-1 .5-1.8 0zm6-2.4s0-2 .3-2.3c0 0 2 .3 2.4-.7l.7 1.9s-2.2-.2-3.4 1z"
          />
          <svg:path
            d="M323.1 292.4s.4-2.1.8-2.2c0 0 1 .3 1.3 0v2.5s0-1.1-2-.3zm-2.2.3s.4-1.9.7-1.9 1.1.5 1.5.2v1.4s-1.7-.4-2 2z"
          />
        </svg:g>
      </svg:g>
      <svg:g fill="#00a651" stroke="#000" stroke-width=".8">
        <svg:path
          stroke-width=".5"
        ...
        <svg:path
          stroke-width=".5"
          d="M345.9 329.8s-6.3-12-10.7-12.5-4.6-4.8-4.6-4.8.5 2 4 2 10.3 5 11 8.7c.8 3.8 1.5 3.3 1.5 3.3z"
        />
        <svg:path
          stroke-width=".5"
          d="M345.9 329s2.3-15.2 12.2-15.5 6.6.8 9-.8c0 0-6.7 3.5-10.8 4s-7.5 8.5-7.4 10-2.2 4.4-3.4 3.4.4-1.1.4-1.1z"
        />
        <svg:path
          stroke-width=".5"
        ...
        <svg:path
          stroke-width=".5"
          d="m330.7 347.7-1.4-1.1c-.8-.5-7.3-2.3-8.2 4 0 0-2.3-6.2 1.1-7 3.4-1 6.2 1 8.5 4m-5.1-12.7s2.4 5 3.3 5.4c.8.2 1.5-.7 1.5-.7s-3.2-4.6-4.8-4.7zm-1.8-8s-2-6.6-4.3-4.8c-2.4 1.7-1.8 6.5-1.8 6.5s-4.8-4.9-2-8.8 8.2.4 8.2 7.2z"
        />
        <svg:path
          fill="#964b36"
          stroke-width=".5"
          d="M329.2 340.6s0 1.3 1 1.6c.8.4 2.4 1 2.4.3s-1.2-3.6-1.7-3.3-1.4.4-1.7 1.4z"
        />
        <svg:path
          stroke-width=".5"
        ...
        <svg:path
          stroke-width=".5"
          d="M324.9 331s-2-9.4-3.3-10.7-3.4-2.6-5.9-.5c0 0 4.4-3.9 9-.6 4.7 3.3 3.7 8.4 3.7 8.4l-.5 6.5-3.2-2.9"
        />
        <svg:path
          stroke-width=".5"
          d="M332.1 342.1s-8.3-15.6-13.6-4.5c0 0-1 2.9 0 4 0 0-3-2.2-1.6-7.8 1.4-5.4 10.6-3 13.2 1.6q3.8 6.6 3 7c-.4.2-1-.3-1-.3zm23.3 4.5s6-12.4 9.6-6.7c0 0 1 2.7-.6 3.9 0 0-2.3-3-4.5.6-2 3.5-1.2 3.2-1.2 3.2s-2.3.7-3.3-1z"
        />
        <svg:path
          stroke-width=".5"
        ...
        <svg:path
          stroke-width=".5"
          d="M362.3 328.8s-4.8-9.7-8-10.7 1.8-2.5 3.8-.7c2 2 5.7 4.3 5.3 9.3l-1 2.1zm-4.9 13.4s1.4-6.6 5.2-8.6c3.7-2 7.2-1.3 7.2-1.3s-4.5 1-5.2 3.3-2 2.4-2 2.4z"
        />
        <svg:path
          fill="#964b36"
          stroke-width=".5"
      ...
      />
      <svg:path
        d="m436.5 330.5.4.3s1.3-1.3 3.3.4l.4-.4c-2.5-2.1-4.1-.3-4.1-.3m-.6-6.8-.1.4 1-.4-.7 1.2 1.4-.5-1.8 2.3.5.4 2.8-3.8-1.8.6.8-1.3-1.5.7.3-2h-.5z"
      />
      <svg:path
        d="m433.2 323.8.6 1.4-1-.4 3 5 .3-.4-.6 1.5.5.2 1.3-3.2-.5-.3-1 1.3-1.7-3 .8.3-.8-1.8 1 .7v-2h-.5v1L433 323l.3.8zm-1.8 6.4.2.5q1.1-.5 2-.1c.5.2.7.8.7.8l.5-.1s-.2-.8-1-1.2q-1-.5-2.4.1m2.2 5.4-.4-2.8h.5l.5 2.8zm3.9-.4-.7-2.2.5-.1.7 2.1zm1.4 1.6-.5-2.2.5-.1.5 2.1z"
      />
      <svg:path
        fill="#00a651"
        stroke="#000"
      ...
      />
      <svg:path d="m332.3 402.1.3 2.3h.4l-.3-2.3 1-4.9h-.5z" />
      <svg:path
        d="m329.9 401.4-.2.3c1.3.5 3.1-1 3.2-1l-.2-.3s-1.8 1.4-2.8 1m3.3-2.9-6-3 .2-.5 6 3z"
      />
      <svg:path
        d="m328.9 397.8-.4-.3 1.2-1.3.4.4zm2-.6-1.2-2.7.5-.3 1.3 2.8zm1.9 3.4v.6c1.6-.1 2 1 2 1l.6-.2c0-.3-.7-1.5-2.6-1.4"
      />
      <svg:path
        fill="#fff"
        stroke="#000"
        stroke-width=".7"
        d="M360.5 401.9c2-1.1 2.4-5.1 2.4-5.1-.4 1.4-4.1 2.9-4.1 2.9 2.7-1.7 6-9.4 6-9.4-.9 2.8-8 5-12.7 7.6s-2.2 10-2.2 10a16 16 0 0 1-4.2-8.3c-.5-3.5-1.9-4.8-5-5.2-3.2-.4-5 3.1-5 3.1L331 400l4.7.2s3.4 1.1 3.4 3.8-3 13.3 2 19.3c3.4 4.1 16 6.5 16 6.5"
      />
      <svg:path
        fill="#fff"
        stroke="#000"
      ...
      <svg:path
        ...
        stroke="#000"
        stroke-width=".7"
        d="M358.4 417.3s4 6.8 4.5 10.4c0 0 7.7 8.6 10.6 9 0 0-1.3.6-3.8-1.5 0 0 2 2.2 2.5 2.3s-1.7-.2-2-.8c0 0 .8 1.3 1.4 1.5l-.6-.2s-1-.1-1.5-.5-.2 1-.2 1-1.2-.3-1.6-.7.2.9.2.9l-1-.3-.8.5s0 .5-.6.1c-.4-.4-1.3 0-1.3 0s-.7.6-1 .2-1.5 1.5-1.5 1.5l-5.1-12.3"
      />
      <svg:path
        d="m363.2 439.6-6.4-12.3.7-.3 6.4 12.2zm5.6-.9-11-12.3.6-.5 11 12.3zm2.6-1L358.8 426l.5-.6L372 437z"
      />
      <svg:g transform="translate(-207.6 158.4)scale(.66486)">
        <svg:path
          d="M823.4 360.8s-1.2-2.2-2.3-1.3q-1.5 1.1-1.8.9s1 0 1.7-.5q1-1 2.4 1zm-6.6-1 .7 1.4-.8 2.3.6.2.7-2.5-.7-1.6z"
        />
        <svg:path d="M823.2 360.5s-1 1-2.2.8l-1.3-.3h1.8c.7 0 1.6-.3 1.7-.5" />
        <svg:path d="M822.9 360.7s-1.2-1.2-2-.8c0 0 1.4-.5 2.2.7z" />
        <svg:path d="M822.7 360.5s-1.3.9-2.7 0l-.1-.2h.2s1.7.7 2.6.2" />
        <svg:circle cx="821.6" cy="360.3" r=".4" />
      </svg:g>
      <svg:path
        d="M339.4 420.4s-.7 1.3-.3 2 1.9 1.1 2 2.1q.4 1.3 1.5.8l1-.1s-3.1-1.7-4-4.3z"
      />
      <svg:g fill="#964b36" stroke="#000" stroke-width=".5">
        <svg:path
          stroke-width=".3"
          d="M438.8 395.6s5.5-7.4 10.5-5.4 8.2 2.9 8.2 2.9.1 5-2.5 5c-2.7 0-5.2-5-7.6-3.6-2.4 1.5-4.4 3.5-4.5 4.2-.2.7-6.4.9-4.1-3z"
        />
        <svg:path d="M417.5 431.2s-1.5 1.6-.8 2 2 0 2-.6-.9-1.6-1.2-1.4z" />
        <svg:path
          d="M416.3 432.8s-2.9-1.7-5.1 2.2c-2.3 3.9-4.2 10.2-5.5 11s12.8-6.2 13-9.1c0 0 1-3.8-.6-3.8-1.4.1-1.5.3-1.8-.4z"
        />
        <svg:path
          stroke-width=".3"
      ...
      />
      <svg:path
        d="M447.2 402.8s1.2 8.3-3.5 11.3l.2.2c4.8-3 3.6-11.5 3.6-11.6h-.3zm-5.6 9 .2.2c3-2.9 3.6-10.6 3.6-11h-.3c0 .1-.6 8-3.5 10.8m-2.8-1.9h.3c.4-4.7 4.2-10.2 4.2-10.2l-.3-.2s-3.8 5.6-4.2 10.4m-2.1-1.4h.3c.5-5.7 4.3-10 4.3-10l-.2-.3s-3.9 4.5-4.4 10.3m-3-1.9h.2c.3-6.8 4.8-10.1 4.9-10.2l-.2-.2s-4.7 3.4-5 10.4zm-2.9-1.7h.4c-.3-6.2 4.5-10 4.5-10l-.1-.2s-5 3.9-4.8 10.2m-5-2.2h.3a10 10 0 0 1 6.9-8.5l-.1-.3a11 11 0 0 0-7 8.8z"
      />
      <svg:path
        fill="#00a651"
        stroke="#000"
      ...
      <svg:path
        ...
        stroke="#000"
        stroke-width=".3"
        d="M414.8 425s-2.4-8.3 2.2-10.4c0 0 .8-.2 1 .6 0 0 1-1.3 1.8-.1 0 0 2.3-1.1 2.8.6 0 0 1.6-1.3 2.4.6 0 0 1.4-.6 1.4 1 0 0 2-1 2 1 0 0 2-.8 1.6 1.3 0 0 3 .4 2 1.8 0 0 2.7.7 1.7 1.8 0 0 2.9-.3 1.3 1.6 0 0 2.2-.7 1 1.7s-5.1 5-7.9 5.4"
      />
      <svg:path
        fill="#00a651"
        stroke="#000"
