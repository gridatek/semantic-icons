...
@Component({
  ...
  template: `
    ...
    <svg:path fill="#d21034" d="M0 0h512v256H0z" />
    <svg:g clip-path="url(#vu-a)" transform="scale(.56889 1.0779)">
      <svg:path
        stroke="#fdce12"
        stroke-width="110"
    ...
    <svg:g fill="#fdce12" transform="translate(-35.6 26.7)scale(.96552)">
      <svg:path
