...
@Component({
  ...
  template: `
    ...
    <svg:g clip-path="url(#ni-c)" transform="translate(-170.7)scale(.85333)">
      ...
      <svg:path
        fill="#fff"
        d="m550 324.6 4 .3 2.9.3-.4-.5c-.6.2-4.4-.2-6.4 0z"
      />
    </svg:g>
    <svg:path
      fill="#c8a400"
      d="m256 191.9-27.4 47.5-28 48.6h110.8L284 240.5zm0 2.5 27 46.7 26.3 45.6H202.8l26.9-46.6z"
    />
  `,
  host: {
    '[attr.xmlns]': 'xmlns',
