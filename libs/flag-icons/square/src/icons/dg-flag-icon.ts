...
@Component({
  ...
  template: `
    ...
    <svg:path
      ...
      stroke="#fff"
      stroke-width="1.7"
      d="m410.1 281-10-11-2.4 11.1-4.4-16-4 8-.7-17-4 8.1-.8-17-4 8-2.4-20-4 8-2.3-20-4 8-2.4-20-1.1-10 2-4 5.2 2 8.4 7.9 16.7 15.9-10.4-4 16.8 16-10.4-4 16.8 16-10.4-4 15.1 13-10.4-4 15.2 12.9-10.4-4 11.5 14-12-7z"
    />
    <svg:path
      fill="none"
      stroke="#000"
    ...
    <svg:path
      ...
      stroke="#fff"
      stroke-width="1.8"
      d="M482.5 159 469 169l15 1.7-21 5 11.2 3.2-22.6 1.7 11.1 3.3-22.6 1.6 11.1 3.3-26.4 3.3 11.1 3.3-26.4 3.3 11.1 3.4-26.4 3.3L381 207l-5.6-1.6 2-5 9.8-8.3 19.5-16.5-4.2 9.9L422 169l-4.2 9.9 19.5-16.5-4.2 9.9 15.7-14.9-4.2 10 15.6-15-4.1 10 17.4-11.6-8 11.6z"
    />
    <svg:path
      fill="none"
      stroke="#000"
    ...
    <svg:path
      ...
      stroke="#fff"
      stroke-width="1.7"
      d="m304.4 265 8.5-11.8-13 1.9 16-9-10.2-.5 18.4-6.6-10.2-.4 18.3-6.5-10.2-.5 21-8.8-10.1-.5 21-8.8-10.2-.4 21.1-8.9 10.5-4.4 5.1.2-.3 5-5.7 9.4-11.6 19 .7-9.7-11.5 19 .6-9.7-11.5 19 .7-9.7L333 259l.6-9.7-8.8 16.7.7-9.8-11.2 14.2 3.4-12.1z"
    />
    <svg:path
      fill="none"
      stroke="#000"
    ...
    <svg:g fill-rule="evenodd">
      ...
      />
      <svg:g stroke="#000" stroke-width="1pt">
        <svg:path
          fill="#fff100"
      ...
      <svg:path
        fill="gray"
        d="M425.8 382.8c0 3.9-35 3.9-42 3.9-7.6 0-41.9 1-41.9-4 0-3.8 34.6-3.8 42-3.8 7.2 0 41.9.8 41.9 3.9"
      />
      <svg:path
        fill="#c00"
        d="M346 368.9q-.1 2.1-2 2.3c-1.9.2-2.1-1-2.1-2.3q.2-2.1 2-2.3c1.2 0 2.2 1 2.2 2.3zm79.8 0c0 1.3-1 2.3-2.2 2.3q-1.8-.2-2-2.3.2-2.1 2-2.3 2 .2 2.1 2.3z"
      />
      <svg:path
        d="M388 367.8c0 1.2-1.9 2.2-4.2 2.2-2.2 0-4.2-1-4.2-2.3s2-2.3 4.2-2.3 4.2 1 4.2 2.3z"
      />
      <svg:path
        fill="#006300"
        d="M408.1 367.8c0 1.2-1.4 2.2-3.1 2.2s-3.1-1-3.1-2.3 1.4-2.3 3-2.3 3.2 1 3.2 2.3zm-43.1 0c0 1.2-1.4 2.2-3.2 2.2s-3.2-1-3.2-2.3 1.4-2.3 3.2-2.3 3.2 1 3.2 2.3z"
      />
      <svg:path
        fill="#fff100"
        stroke="#000"
