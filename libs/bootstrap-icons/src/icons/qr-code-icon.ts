...
@Component({
  ...
  imports: [],
  template: `
    <svg:path d="M2 2h2v2H2z" />
    <svg:path d="M6 0v6H0V0zM5 1H1v4h4zM4 12H2v2h2z" />
    <svg:path d="M6 10v6H0v-6zm-5 1v4h4v-4zm11-9h2v2h-2z" />
    <svg:path
    ...
    />
    <svg:path d="M7 12h1v3h4v1H7zm9 2v2h-3v-1h2v-1z" />
  `,
  host: {
