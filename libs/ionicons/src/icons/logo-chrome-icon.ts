...
@Component({
  selector: 'svg[siLogoChromeIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:path
      d="M188.8 255.93a67.2 67.2 0 1 0 67.2-67.18 67.38 67.38 0 0 0-67.2 67.18"
    />
    <svg:path
    ...
    />
    <svg:path
      d="m91.29 104.57 77.35 133.25A89.19 89.19 0 0 1 256 166h205.17a246.5 246.5 0 0 0-25.78-43.94l.12.08A245.3 245.3 0 0 1 461.17 166h.17a246 246 0 0 0-25.66-44 2.6 2.6 0 0 1-.35-.26 223.93 223.93 0 0 0-344.19-17.4l.14.24Z"
    />
  `,
  host: {
    '[attr.xmlns]': 'xmlns',
