...
@Component({
  ...
  template: `
    ...
    />
    <svg:ellipse cx="256.26" cy="160" rx="48.01" ry="48" />
    <svg:path
      d="M256.26 16c-79.42 0-144 64.59-144 144s64.61 144 144 144 144-64.6 144-144-64.59-144-144-144m0 224a80 80 0 1 1 80-80 80.1 80.1 0 0 1-80 80"
    />
  `,
  host: {
