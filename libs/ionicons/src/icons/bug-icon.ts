...
@Component({
  ...
  template: `
    ...
    />
    <svg:path
      d="m321.39 104 .32.09c13.57 3.8 25.07-10.55 18.2-22.85A95.86 95.86 0 0 0 256.21 32h-.42a95.87 95.87 0 0 0-84.19 50.13c-6.84 12.58 5.14 27 18.84 22.86 19.71-6 41.79-9.06 65.56-9.06 24.09 0 46.09 2.72 65.39 8.07"
    />
  `,
  host: {
    '[attr.xmlns]': 'xmlns',
