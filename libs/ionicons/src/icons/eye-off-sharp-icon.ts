...
@Component({
  selector: 'svg[siEyeOffSharpIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:path
      d="m63.998 86.004 21.998-21.998L448 426.01l-21.998 21.998zM259.34 192.09l60.57 60.57a64.07 64.07 0 0 0-60.57-60.57M252.66 319.91l-60.57-60.57a64.07 64.07 0 0 0 60.57 60.57"
    />
    <svg:path
...
export class SiEyeOffSharpIcon {
