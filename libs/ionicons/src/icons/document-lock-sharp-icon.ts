...
@Component({
  selector: 'svg[siDocumentLockSharpIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:path
      d="M276 192h146.31a2 2 0 0 0 1.42-3.41L275.41 40.27a2 2 0 0 0-3.41 1.42V188a4 4 0 0 0 4 4M256 272c-8.82 0-16 6.28-16 14v18h32v-18c0-7.72-7.18-14-16-14"
    />
    <svg:path
