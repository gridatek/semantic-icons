...
@Component({
  selector: 'svg[siCutIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:path
      d="M103.48 224a71.64 71.64 0 0 0 44.76-15.66l41.5 16.89 6.82-12.63a39 39 0 0 1 4.32-6.37l14.22-14.42-41.17-24.94A72 72 0 1 0 103.48 224m0-112a40 40 0 1 1-40 40 40 40 0 0 1 40-40"
    />
    <svg:path
