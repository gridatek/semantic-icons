...
@Component({
  selector: 'svg[siLogoWordpressIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:path
    ...
    />
    <svg:path
      d="M256 48a208.06 208.06 0 0 1 81 399.66A208.06 208.06 0 0 1 175 64.34 206.7 206.7 0 0 1 256 48m0-16C132.29 32 32 132.29 32 256s100.29 224 224 224 224-100.29 224-224S379.71 32 256 32"
    />
  `,
  host: {
    '[attr.xmlns]': 'xmlns',
...
export class SiLogoWordpressIcon {
