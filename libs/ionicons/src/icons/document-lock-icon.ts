...
@Component({
  selector: 'svg[siDocumentLockIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:path
      d="M288 192h129.81a2 2 0 0 0 1.41-3.41L275.41 44.78a2 2 0 0 0-3.41 1.41V176a16 16 0 0 0 16 16M256 272c-8.82 0-16 6.28-16 14v18h32v-18c0-7.72-7.18-14-16-14"
    />
    <svg:path
...
export class SiDocumentLockIcon {
