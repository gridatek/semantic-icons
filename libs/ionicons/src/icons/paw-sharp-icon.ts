...
@Component({
  ...
  template: `
    ...
    />
    <svg:ellipse cx="72" cy="216" rx="56" ry="72" />
    <svg:ellipse cx="184" cy="120" rx="56" ry="72" />
    <svg:ellipse cx="328" cy="120" rx="56" ry="72" />
    <svg:ellipse cx="440" cy="216" rx="56" ry="72" />
  `,
  host: {
    '[attr.xmlns]': 'xmlns',
