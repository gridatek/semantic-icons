...
@Component({
  ...
  template: `
    ...
    />
    <svg:path
      d="M133.55 238.06A15.85 15.85 0 0 1 126 240a15.8 15.8 0 0 0 7.51-1.92ZM174.14 168.78l.13-.23zc-20.5 35.51-30.36 54.95-33.82 62 3.47-7.07 13.34-26.51 33.82-62"
      fill="none"
    />
    <svg:path
      d="m139.34 232.84 1-2a16.27 16.27 0 0 1-6.77 7.25 16.35 16.35 0 0 0 5.77-5.25"
    />
    <svg:path
