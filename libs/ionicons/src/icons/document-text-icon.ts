...
@Component({
  selector: 'svg[siDocumentTextIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:path
    ...
    />
    <svg:path
      d="M419.22 188.59 275.41 44.78a2 2 0 0 0-3.41 1.41V176a16 16 0 0 0 16 16h129.81a2 2 0 0 0 1.41-3.41"
    />
  `,
  host: {
...
export class SiDocumentTextIcon {
