...
@Component({
  selector: 'svg[siHeartDislikeCircleOutlineIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:path
...
export class SiHeartDislikeCircleOutlineIcon {
