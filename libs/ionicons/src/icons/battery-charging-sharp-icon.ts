...
@Component({
  selector: 'svg[siBatteryChargingSharpIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:path
    ...
    />
    <svg:path
      d="M264.76 329.08h130.55V182.92H276.28l-9.73 34.7H346l-23.16 31.78zM160 294.26h-39.31l23.15-31.78 57.95-79.56H70.69v146.16h119.6l9.77-34.82zM465 202.67h32v106.67h-32z"
    />
  `,
  host: {
    '[attr.xmlns]': 'xmlns',
...
export class SiBatteryChargingSharpIcon {
