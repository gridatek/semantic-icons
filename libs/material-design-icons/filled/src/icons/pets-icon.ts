...
@Component({
  selector: 'svg[siPetsIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:circle cx="4.5" cy="9.5" r="2.5" />
    <svg:circle cx="9" cy="5.5" r="2.5" />
    <svg:circle cx="15" cy="5.5" r="2.5" />
    <svg:circle cx="19.5" cy="9.5" r="2.5" />
    <svg:path
