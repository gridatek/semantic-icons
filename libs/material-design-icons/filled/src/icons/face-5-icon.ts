...
@Component({
  ...
  template: `
    ...
    <svg:circle cx="12" cy="5.5" r=".5" />
    <svg:circle cx="14" cy="5.5" r=".5" />
    <svg:circle cx="10" cy="5.5" r=".5" />
    <svg:circle cx="17" cy="6.5" r=".5" />
    <svg:circle cx="9" cy="6.5" r=".5" />
    <svg:circle cx="7" cy="6.5" r=".5" />
    <svg:circle cx="11" cy="6.5" r=".5" />
    <svg:circle cx="13" cy="6.5" r=".5" />
    <svg:circle cx="15" cy="6.5" r=".5" />
    <svg:circle cx="12" cy="7.5" r=".5" />
    <svg:circle cx="14" cy="7.5" r=".5" />
    <svg:circle cx="16" cy="7.5" r=".5" />
    <svg:circle cx="10" cy="7.5" r=".5" />
    <svg:circle cx="8" cy="7.5" r=".5" />
    <svg:circle cx="9" cy="8.5" r=".5" />
    <svg:circle cx="7" cy="8.5" r=".5" />
    <svg:circle cx="11" cy="8.5" r=".5" />
    <svg:circle cx="13" cy="8.5" r=".5" />
    <svg:circle cx="15" cy="8.5" r=".5" />
    <svg:circle cx="17" cy="8.5" r=".5" />
