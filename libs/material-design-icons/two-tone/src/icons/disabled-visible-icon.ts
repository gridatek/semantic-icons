...
@Component({
  selector: 'svg[siDisabledVisibleIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:path
...
export class SiDisabledVisibleIcon {
