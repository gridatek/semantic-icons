...
@Component({
  selector: 'svg[siAirplaneTicketIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:path
    ...
    />
    <svg:path
      d="M17.73 13.3c.52-.15.82-.68.69-1.19a.967.967 0 0 0-1.18-.68l-2.44.65-4.01-3.74-1.4.38 2.4 4.16-2.39.64-1.26-.99-.93.25 1.66 2.88 8.86-2.36z"
    />
  `,
  host: {
    '[attr.xmlns]': 'xmlns',
