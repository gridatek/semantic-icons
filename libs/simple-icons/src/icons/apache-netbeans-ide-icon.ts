...
@Component({
  selector: 'svg[si-apache-netbeans-ide-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Apache NetBeans IDE</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Apache NetBeans IDE icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#1B6AC6',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiApacheNetbeansIDEIcon {
  ...
  readonly fill = input<string>('#1B6AC6');
}
