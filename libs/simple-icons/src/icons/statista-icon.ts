...
@Component({
  selector: 'svg[siStatistaIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Statista</svg:title>
    <svg:path
...
export class SiStatistaIcon {
  ...
  readonly ariaLabel = input<string>('Statista icon');
  readonly ariaHidden = input<boolean | string>(true);

  readonly viewBox = input<string>('0 0 24 24');

  readonly fill = input<string>('#001327');
}
