...
@Component({
  selector: 'svg[si-mariadb-foundation-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>MariaDB Foundation</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "MariaDB Foundation icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#1F305F',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiMariadbFoundationIcon {
  ...
  readonly fill = input<string>('#1F305F');
}
