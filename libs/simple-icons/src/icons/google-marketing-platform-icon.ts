...
@Component({
  selector: 'svg[siGoogleMarketingPlatformIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Google Marketing Platform</svg:title>
    <svg:path
...
export class SiGoogleMarketingPlatformIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('Google Marketing Platform icon');
