...
@Component({
  selector: 'svg[si-semantic-ui-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Semantic UI</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Semantic UI icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#00B5AD',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiSemanticUIIcon {
  ...
  readonly fill = input<string>('#00B5AD');
}
