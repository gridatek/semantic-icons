...
@Component({
  selector: 'svg[si-playstation-vita-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>PlayStation Vita</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "PlayStation Vita icon"',
...
export class SiPlaystationVitaIcon {
