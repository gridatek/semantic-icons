...
@Component({
  selector: 'svg[si-google-tag-manager-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Google Tag Manager</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Google Tag Manager icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#246FDB',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiGoogleTagManagerIcon {
  ...
  readonly fill = input<string>('#246FDB');
}
