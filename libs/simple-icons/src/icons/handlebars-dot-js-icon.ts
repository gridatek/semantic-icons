...
@Component({
  selector: 'svg[siHandlebarsDotJsIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Handlebars.js</svg:title>
    <svg:path
...
export class SiHandlebarsDotJsIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('Handlebars.js icon');
