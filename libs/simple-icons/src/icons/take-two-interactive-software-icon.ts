...
@Component({
  selector: 'svg[siTakeTwoInteractiveSoftwareIcon]',
  standalone: true,
  imports: [],
  template: `
...
export class SiTakeTwoInteractiveSoftwareIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('Take-Two Interactive Software icon');
