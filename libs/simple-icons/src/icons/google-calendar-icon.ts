...
@Component({
  selector: 'svg[siGoogleCalendarIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Google Calendar</svg:title>
    <svg:path
...
export class SiGoogleCalendarIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('Google Calendar icon');
