...
@Component({
  selector: 'svg[si-apache-airflow-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Apache Airflow</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Apache Airflow icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#017CEE',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiApacheAirflowIcon {
  ...
  readonly fill = input<string>('#017CEE');
}
