...
@Component({
  selector: 'svg[si-spring-security-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Spring Security</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Spring Security icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#6DB33F',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiSpringSecurityIcon {
  ...
  readonly fill = input<string>('#6DB33F');
}
