...
@Component({
  selector: 'svg[siCreativeTechnologyIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Creative Technology</svg:title>
    <svg:path
...
export class SiCreativeTechnologyIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('Creative Technology icon');
