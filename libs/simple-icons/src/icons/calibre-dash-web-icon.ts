...
@Component({
  selector: 'svg[si-calibre-dash-web-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Calibre-Web</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Calibre-Web icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#45B29D',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiCalibreDashWebIcon {
  ...
  readonly fill = input<string>('#45B29D');
}
