...
@Component({
  selector: 'svg[siDazhongDianpingIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Dazhong Dianping</svg:title>
    <svg:path
...
export class SiDazhongDianpingIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('Dazhong Dianping icon');
