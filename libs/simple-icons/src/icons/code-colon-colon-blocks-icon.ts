...
@Component({
  selector: 'svg[si-code-colon-colon-blocks-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Code::Blocks</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Code::Blocks icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#41AD48',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiCodeColonColonBlocksIcon {
  ...
  readonly fill = input<string>('#41AD48');
}
