...
@Component({
  selector: 'svg[si-robot-framework-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Robot Framework</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Robot Framework icon"',
...
export class SiRobotFrameworkIcon {
