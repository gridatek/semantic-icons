...
@Component({
  selector: 'svg[siPagespeedInsightsIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>PageSpeed Insights</svg:title>
    <svg:path
...
export class SiPagespeedInsightsIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('PageSpeed Insights icon');
