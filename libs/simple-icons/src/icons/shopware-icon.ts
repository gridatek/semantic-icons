...
@Component({
  selector: 'svg[siShopwareIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Shopware</svg:title>
    <svg:path
...
export class SiShopwareIcon {
  ...
  readonly ariaLabel = input<string>('Shopware icon');
  readonly ariaHidden = input<boolean | string>(true);

  readonly viewBox = input<string>('0 0 24 24');

  readonly fill = input<string>('#189EFF');
}
