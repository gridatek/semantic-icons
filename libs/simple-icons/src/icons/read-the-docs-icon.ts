...
@Component({
  selector: 'svg[si-read-the-docs-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Read the Docs</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Read the Docs icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#8CA1AF',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiReadTheDocsIcon {
  ...
  readonly fill = input<string>('#8CA1AF');
}
