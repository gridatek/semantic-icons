...
@Component({
  selector: 'svg[si-apache-nifi-icon]',
  standalone: true,
  imports: [],
  template: `
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Apache NiFi icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#728E9B',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiApacheNifiIcon {
  ...
  readonly fill = input<string>('#728E9B');
}
