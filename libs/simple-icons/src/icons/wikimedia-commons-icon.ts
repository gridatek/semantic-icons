...
@Component({
  selector: 'svg[siWikimediaCommonsIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Wikimedia Commons</svg:title>
    <svg:path
...
export class SiWikimediaCommonsIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('Wikimedia Commons icon');
