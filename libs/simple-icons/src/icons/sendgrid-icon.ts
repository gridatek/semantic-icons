...
@Component({
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "SendGrid icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#51A9E3',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiSendgridIcon {
  ...
  readonly fill = input<string>('#51A9E3');
}
