...
@Component({
  selector: 'svg[si-debrid-dash-link-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Debrid-Link</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Debrid-Link icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#264E70',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiDebridDashLinkIcon {
  ...
  readonly fill = input<string>('#264E70');
}
