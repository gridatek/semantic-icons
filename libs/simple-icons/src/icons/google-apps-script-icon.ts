...
@Component({
  selector: 'svg[siGoogleAppsScriptIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Google Apps Script</svg:title>
    <svg:path
...
export class SiGoogleAppsScriptIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('Google Apps Script icon');
