...
@Component({
  selector: 'svg[siTheIrishTimesIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>The Irish Times</svg:title>
    <svg:path
...
export class SiTheIrishTimesIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('The Irish Times icon');
