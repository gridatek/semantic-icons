...
@Component({
  selector: 'svg[siWikimediaFoundationIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Wikimedia Foundation</svg:title>
    <svg:path
...
export class SiWikimediaFoundationIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('Wikimedia Foundation icon');
