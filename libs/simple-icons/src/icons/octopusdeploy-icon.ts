...
@Component({
  selector: 'svg[si-octopusdeploy-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Octopus Deploy</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Octopus Deploy icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#2F93E0',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiOctopusdeployIcon {
  ...
  readonly fill = input<string>('#2F93E0');
}
