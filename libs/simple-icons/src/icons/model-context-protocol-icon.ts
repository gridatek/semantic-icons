...
@Component({
  selector: 'svg[si-model-context-protocol-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Model Context Protocol</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Model Context Protocol icon"',
...
export class SiModelContextProtocolIcon {
