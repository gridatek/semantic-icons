...
@Component({
  selector: 'svg[siGoogleAuthenticatorIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Google Authenticator</svg:title>
    <svg:path
...
export class SiGoogleAuthenticatorIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('Google Authenticator icon');
