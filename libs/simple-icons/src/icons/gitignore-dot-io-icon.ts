...
@Component({
  selector: 'svg[si-gitignore-dot-io-icon]',
  standalone: true,
  imports: [],
  template: `
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "gitignore.io icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#204ECF',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiGitignoreDotIoIcon {
  ...
  readonly fill = input<string>('#204ECF');
}
