...
@Component({
  selector: 'svg[siGatsbyIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Gatsby</svg:title>
    <svg:path
...
export class SiGatsbyIcon {
  ...
  readonly ariaLabel = input<string>('Gatsby icon');
  readonly ariaHidden = input<boolean | string>(true);

  readonly viewBox = input<string>('0 0 24 24');

  readonly fill = input<string>('#663399');
}
