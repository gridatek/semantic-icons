...
@Component({
  selector: 'svg[si-wolfram-mathematica-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Wolfram Mathematica</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Wolfram Mathematica icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#DD1100',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiWolframMathematicaIcon {
  ...
  readonly fill = input<string>('#DD1100');
}
