...
@Component({
  selector: 'svg[siGoodreadsIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Goodreads</svg:title>
    <svg:path
...
export class SiGoodreadsIcon {
  ...
  readonly ariaLabel = input<string>('Goodreads icon');
  readonly ariaHidden = input<boolean | string>(true);

  readonly viewBox = input<string>('0 0 24 24');

  readonly fill = input<string>('#1E1914');
}
