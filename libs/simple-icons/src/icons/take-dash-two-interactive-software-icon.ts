...
@Component({
  selector: 'svg[si-take-dash-two-interactive-software-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Take-Two Interactive Software</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Take-Two Interactive Software icon"',
...
export class SiTakeDashTwoInteractiveSoftwareIcon {
