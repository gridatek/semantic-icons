...
@Component({
  selector: 'svg[si-semantic-ui-react-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Semantic UI React</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Semantic UI React icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#35BDB2',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiSemanticUIReactIcon {
  ...
  readonly fill = input<string>('#35BDB2');
}
