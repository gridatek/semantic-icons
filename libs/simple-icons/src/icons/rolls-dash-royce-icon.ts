...
@Component({
  selector: 'svg[si-rolls-dash-royce-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Rolls-Royce</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Rolls-Royce icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#281432',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiRollsDashRoyceIcon {
  ...
  readonly fill = input<string>('#281432');
}
