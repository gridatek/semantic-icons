...
@Component({
  selector: 'svg[si-chakra-ui-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Chakra UI</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Chakra UI icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#1BB2A9',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiChakraUIIcon {
  ...
  readonly fill = input<string>('#1BB2A9');
}
