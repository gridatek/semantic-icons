...
@Component({
  selector: 'svg[si-redux-dash-saga-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Redux-Saga</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Redux-Saga icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#999999',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiReduxDashSagaIcon {
  ...
  readonly fill = input<string>('#999999');
}
