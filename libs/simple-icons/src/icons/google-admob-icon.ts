...
@Component({
  selector: 'svg[si-google-admob-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Google AdMob</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Google AdMob icon"',
...
export class SiGoogleAdmobIcon {
  ...
  readonly fill = input<string>('#EA4335');
}
