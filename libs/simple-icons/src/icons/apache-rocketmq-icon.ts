...
@Component({
  selector: 'svg[si-apache-rocketmq-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Apache RocketMQ</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Apache RocketMQ icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#D77310',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiApacheRocketmqIcon {
  ...
  readonly fill = input<string>('#D77310');
}
