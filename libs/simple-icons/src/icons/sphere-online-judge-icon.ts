...
export class SiSphereOnlineJudgeIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('Sphere Online Judge icon');
