...
@Component({
  selector: 'svg[siGoogleBigtableIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Google Bigtable</svg:title>
    <svg:path
...
export class SiGoogleBigtableIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('Google Bigtable icon');
