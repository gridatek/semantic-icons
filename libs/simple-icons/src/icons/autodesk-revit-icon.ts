...
@Component({
  selector: 'svg[si-autodesk-revit-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Autodesk Revit</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Autodesk Revit icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#186BFF',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiAutodeskRevitIcon {
  ...
  readonly fill = input<string>('#186BFF');
}
