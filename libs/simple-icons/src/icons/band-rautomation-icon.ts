...
@Component({
  selector: 'svg[siBAndRAutomationIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>B&amp;R Automation</svg:title>
    <svg:path
  ...
  host: {
    ...
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#FF8800',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiBAndRAutomationIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('B&amp;R Automation icon');
