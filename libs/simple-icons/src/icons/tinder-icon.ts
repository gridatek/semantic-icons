...
@Component({
  selector: 'svg[siTinderIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Tinder</svg:title>
    <svg:path
...
export class SiTinderIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('Tinder icon');
  readonly ariaHidden = input<boolean | string>(true);

  readonly viewBox = input<string>('0 0 24 24');

  readonly fill = input<string>('#FF6B6B');
}
