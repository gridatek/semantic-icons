...
@Component({
  selector: 'svg[siZebraTechnologiesIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Zebra Technologies</svg:title>
    <svg:path
...
export class SiZebraTechnologiesIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('Zebra Technologies icon');
