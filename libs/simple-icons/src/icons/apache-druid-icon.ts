...
@Component({
  selector: 'svg[si-apache-druid-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Apache Druid</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Apache Druid icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#29F1FB',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiApacheDruidIcon {
  ...
  readonly fill = input<string>('#29F1FB');
}
