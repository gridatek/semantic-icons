...
@Component({
  selector: 'svg[si-affinity-publisher-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Affinity Publisher</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Affinity Publisher icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#891B26',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiAffinityPublisherIcon {
  ...
  readonly fill = input<string>('#891B26');
}
