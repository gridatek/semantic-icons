...
@Component({
  selector: 'svg[siSketchIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Sketch</svg:title>
    <svg:path
...
export class SiSketchIcon {
  ...
  readonly ariaLabel = input<string>('Sketch icon');
  readonly ariaHidden = input<boolean | string>(true);

  readonly viewBox = input<string>('0 0 24 24');

  readonly fill = input<string>('#F7B500');
}
