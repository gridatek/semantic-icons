...
@Component({
  selector: 'svg[si-pop-exclamation-underscore-os-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Pop!_OS</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Pop!_OS icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#48B9C7',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiPopExclamationUnderscoreOSIcon {
  ...
  readonly fill = input<string>('#48B9C7');
}
