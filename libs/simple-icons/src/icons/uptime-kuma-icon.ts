...
@Component({
  selector: 'svg[si-uptime-kuma-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Uptime Kuma</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Uptime Kuma icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#5CDD8B',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiUptimeKumaIcon {
  ...
  readonly fill = input<string>('#5CDD8B');
}
