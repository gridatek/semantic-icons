...
@Component({
  selector: 'svg[siPlanetIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Planet</svg:title>
    <svg:path
...
export class SiPlanetIcon {
  ...
  readonly ariaLabel = input<string>('Planet icon');
  readonly ariaHidden = input<boolean | string>(true);

  readonly viewBox = input<string>('0 0 24 24');

  readonly fill = input<string>('#009DB1');
}
