...
@Component({
  selector: 'svg[si-css-wizardry-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>CSS Wizardry</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "CSS Wizardry icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#F43059',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiCSSWizardryIcon {
  ...
  readonly fill = input<string>('#F43059');
}
