...
@Component({
  selector: 'svg[si-player-fm-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Player FM</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Player FM icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#C8122A',
  },
  styles: ``,
...
export class SiPlayerFMIcon {
  ...
  readonly fill = input<string>('#C8122A');
}
