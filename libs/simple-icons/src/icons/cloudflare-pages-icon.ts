...
@Component({
  selector: 'svg[siCloudflarePagesIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Cloudflare Pages</svg:title>
    <svg:path
...
export class SiCloudflarePagesIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('Cloudflare Pages icon');
