...
@Component({
  selector: 'svg[si-google-dataproc-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Google Dataproc</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Google Dataproc icon"',
...
export class SiGoogleDataprocIcon {
