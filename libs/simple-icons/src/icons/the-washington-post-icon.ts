...
@Component({
  selector: 'svg[siTheWashingtonPostIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>The Washington Post</svg:title>
    <svg:path
...
export class SiTheWashingtonPostIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('The Washington Post icon');
