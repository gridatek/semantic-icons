...
@Component({
  selector: 'svg[siArchiveOfOurOwnIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Archive of Our Own</svg:title>
    <svg:path
...
export class SiArchiveOfOurOwnIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('Archive of Our Own icon');
