...
@Component({
  selector: 'svg[siYamahaMotorCorporationIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Yamaha Motor Corporation</svg:title>
    <svg:path
...
export class SiYamahaMotorCorporationIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('Yamaha Motor Corporation icon');
