...
@Component({
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Cognizant icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#1A4CA1',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiCognizantIcon {
  ...
  readonly fill = input<string>('#1A4CA1');
}
