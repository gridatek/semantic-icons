...
@Component({
  selector: 'svg[siPretzelIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Pretzel</svg:title>
    <svg:path
...
export class SiPretzelIcon {
  ...
  readonly ariaLabel = input<string>('Pretzel icon');
  readonly ariaHidden = input<boolean | string>(true);

  readonly viewBox = input<string>('0 0 24 24');

  readonly fill = input<string>('#1BB3A4');
}
