...
@Component({
  selector: 'svg[si-mobx-dash-state-dash-tree-icon]',
  standalone: true,
  imports: [],
  template: `
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "MobX-State-Tree icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#FF7102',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiMobxDashStateDashTreeIcon {
  ...
  readonly fill = input<string>('#FF7102');
}
