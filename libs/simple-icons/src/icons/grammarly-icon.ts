...
@Component({
  selector: 'svg[siGrammarlyIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Grammarly</svg:title>
    <svg:path
...
export class SiGrammarlyIcon {
  ...
  readonly ariaLabel = input<string>('Grammarly icon');
  readonly ariaHidden = input<boolean | string>(true);

  readonly viewBox = input<string>('0 0 24 24');

  readonly fill = input<string>('#027E6F');
}
