...
@Component({
  selector: 'svg[siGoogleEarthEngineIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Google Earth Engine</svg:title>
    <svg:path
...
export class SiGoogleEarthEngineIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('Google Earth Engine icon');
