...
@Component({
  selector: 'svg[siJetpackComposeIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Jetpack Compose</svg:title>
    <svg:path
...
export class SiJetpackComposeIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('Jetpack Compose icon');
