...
@Component({
  selector: 'svg[siLemonSqueezyIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Lemon Squeezy</svg:title>
    <svg:path
...
export class SiLemonSqueezyIcon {
  ...
  readonly ariaLabel = input<string>('Lemon Squeezy icon');
  readonly ariaHidden = input<boolean | string>(true);

  readonly viewBox = input<string>('0 0 24 24');

  readonly fill = input<string>('#FFC233');
}
