...
@Component({
  selector: 'svg[si-tilda-publishing-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Tilda Publishing</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Tilda Publishing icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#FFA282',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiTildaPublishingIcon {
  ...
  readonly fill = input<string>('#FFA282');
}
