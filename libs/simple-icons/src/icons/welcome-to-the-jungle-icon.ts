...
@Component({
  selector: 'svg[siWelcomeToTheJungleIcon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Welcome to the Jungle</svg:title>
    <svg:path
...
export class SiWelcomeToTheJungleIcon {
  protected readonly xmlns = 'http://www.w3.org/2000/svg';

  // Accessibility inputs
  readonly ariaLabel = input<string>('Welcome to the Jungle icon');
