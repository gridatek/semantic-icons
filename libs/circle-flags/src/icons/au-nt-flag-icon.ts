...
@Component({
  ...
  template: `
    ...
    <svg:g mask="url(#a)">
      <svg:path fill="#333" d="M0 0h171l64 256-64 256H0Z" />
      <svg:path fill="#ff9811" d="M171 0h341v512H171z" />
      <svg:path
        fill="#333"
      ...
      />
      <svg:path fill="#eee" d="M358 237c14 18 75 0 45-37-29-37-60 18-45 37z" />
      <svg:path fill="#eee" d="M330 224c23 0 47-59 0-59s-23 59 0 59z" />
      <svg:path
        fill="#eee"
