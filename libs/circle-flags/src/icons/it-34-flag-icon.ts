...
@Component({
  selector: 'svg[si-it-34-flag-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:mask id="a">
    ...
    <svg:g mask="url(#a)">
      <svg:path fill="#0052b4" d="M512 0v256l-256 64L0 256V0h512Z" />
      <svg:path fill="#ff9811" d="M512 256v256H0V256h512Z" />
      <svg:path
        fill="#ffda44"
      ...
      />
      <svg:circle cx="216" cy="152" r="48" fill="#ff9811" />
      <svg:path
        fill="#ffda45"
