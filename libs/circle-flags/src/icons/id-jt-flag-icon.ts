...
@Component({
  ...
  template: `
    ...
    <svg:g mask="url(#a)">
      ...
      />
      <svg:path fill="#eee" d="M278 231h-1zm-43 0z" />
      <svg:path
        fill="#6da544"
      ...
      />
      <svg:path fill="#338af3" d="m183 290 11 32h124l11-32h-73z" />
      <svg:path
        fill="#eee"
      ...
      <svg:rect
        ...
        ry="12"
      />
      <svg:path fill="#ffda44" d="m242 191 14-42 14 42-36-26h44z" />
    </svg:g>
  `,
  host: {
    '[attr.xmlns]': 'xmlns',
