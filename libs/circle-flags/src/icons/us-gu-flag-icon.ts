...
@Component({
  ...
  template: `
    ...
    <svg:g mask="url(#a)">
      ...
      />
      <svg:path fill="#0052b4" d="M0 44.6h512v423H0z" />
      <svg:path
        fill="#d80027"
      ...
      />
      <svg:path fill="#6da544" d="M206 211.6h100l-50 50z" />
      <svg:path fill="#a2001d" d="M239.3 245h33.4v100.1h-33.4z" />
    </svg:g>
  `,
  host: {
