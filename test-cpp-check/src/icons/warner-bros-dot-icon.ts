...
@Component({
  selector: 'svg[si-warner-bros-dot-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Warner Bros.</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Warner Bros. icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#004DB4',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiWarnerBrosDotIcon {
  ...
  readonly fill = input<string>('#004DB4');
}
