...
@Component({
  selector: 'svg[si-altium-designer-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Altium Designer</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Altium Designer icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#A5915F',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiAltiumDesignerIcon {
  ...
  readonly fill = input<string>('#A5915F');
}
