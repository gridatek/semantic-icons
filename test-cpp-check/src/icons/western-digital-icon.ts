...
@Component({
  selector: 'svg[si-western-digital-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Western Digital</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Western Digital icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#995DFF',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiWesternDigitalIcon {
  ...
  readonly fill = input<string>('#995DFF');
}
