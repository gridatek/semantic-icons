...
@Component({
  selector: 'svg[si-digi-dash-key-electronics-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Digi-Key Electronics</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Digi-Key Electronics icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#CC0000',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiDigiDashKeyElectronicsIcon {
