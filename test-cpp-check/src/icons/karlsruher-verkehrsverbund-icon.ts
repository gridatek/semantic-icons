...
@Component({
  selector: 'svg[si-karlsruher-verkehrsverbund-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Karlsruher Verkehrsverbund</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Karlsruher Verkehrsverbund icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#9B2321',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiKarlsruherVerkehrsverbundIcon {
  ...
  readonly fill = input<string>('#9B2321');
}
