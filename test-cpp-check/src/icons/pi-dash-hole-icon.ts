...
@Component({
  selector: 'svg[si-pi-dash-hole-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Pi-hole</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Pi-hole icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#96060C',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiPiDashHoleIcon {
  ...
  readonly fill = input<string>('#96060C');
}
