...
@Component({
  selector: 'svg[si-tunein-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>TuneIn</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "TuneIn icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#14D8CC',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiTuneinIcon {
  ...
  readonly fill = input<string>('#14D8CC');
}
