...
@Component({
  selector: 'svg[si-graph-ql-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>GraphQL</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "GraphQL icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#E10098',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiGraphQlIcon {
  ...
  readonly fill = input<string>('#E10098');
}
