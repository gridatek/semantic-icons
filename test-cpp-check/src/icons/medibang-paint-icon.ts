...
@Component({
  selector: 'svg[si-medibang-paint-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>MediBang Paint</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "MediBang Paint icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#00DBDE',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiMedibangPaintIcon {
  ...
  readonly fill = input<string>('#00DBDE');
}
