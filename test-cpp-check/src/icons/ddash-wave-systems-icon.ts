...
@Component({
  selector: 'svg[si-d-dash-wave-systems-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>D-Wave Systems</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "D-Wave Systems icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#008CD7',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiDDashWaveSystemsIcon {
  ...
  readonly fill = input<string>('#008CD7');
}
