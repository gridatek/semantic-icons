...
@Component({
  selector: 'svg[si-mediafire-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>MediaFire</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "MediaFire icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#1299F3',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiMediafireIcon {
  ...
  readonly fill = input<string>('#1299F3');
}
