...
@Component({
  selector: 'svg[si-wolfram-language-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Wolfram Language</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Wolfram Language icon"',
...
export class SiWolframLanguageIcon {
