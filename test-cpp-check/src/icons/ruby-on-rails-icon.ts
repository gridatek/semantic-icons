...
@Component({
  selector: 'svg[si-ruby-on-rails-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Ruby on Rails</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Ruby on Rails icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#D30001',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiRubyOnRailsIcon {
  ...
  readonly fill = input<string>('#D30001');
}
