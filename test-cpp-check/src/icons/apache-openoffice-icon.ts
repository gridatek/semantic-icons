...
@Component({
  selector: 'svg[si-apache-openoffice-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Apache OpenOffice</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Apache OpenOffice icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#0E85CD',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiApacheOpenofficeIcon {
  ...
  readonly fill = input<string>('#0E85CD');
}
