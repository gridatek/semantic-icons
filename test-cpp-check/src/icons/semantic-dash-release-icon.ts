...
@Component({
  selector: 'svg[si-semantic-dash-release-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>semantic-release</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "semantic-release icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#494949',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiSemanticDashReleaseIcon {
  ...
  readonly fill = input<string>('#494949');
}
