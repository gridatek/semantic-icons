...
@Component({
  selector: 'svg[si-salesforce-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Salesforce</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Salesforce icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#00A1E0',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiSalesforceIcon {
  ...
  readonly fill = input<string>('#00A1E0');
}
