...
@Component({
  selector: 'svg[si-num1001-tracklists-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>1001Tracklists</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "1001Tracklists icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#40AEF0',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiNum1001TracklistsIcon {
  ...
  readonly fill = input<string>('#40AEF0');
}
