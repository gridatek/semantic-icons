...
@Component({
  selector: 'svg[si-namu-wiki-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Namu Wiki</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Namu Wiki icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#008275',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiNamuWikiIcon {
  ...
  readonly fill = input<string>('#008275');
}
