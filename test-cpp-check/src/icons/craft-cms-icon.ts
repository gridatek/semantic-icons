...
@Component({
  selector: 'svg[si-craft-cms-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Craft CMS</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Craft CMS icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#E5422B',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiCraftCMSIcon {
  ...
  readonly fill = input<string>('#E5422B');
}
