...
@Component({
  selector: 'svg[si-st-microelectronics-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>STMicroelectronics</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "STMicroelectronics icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#03234B',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiSTMicroelectronicsIcon {
  ...
  readonly fill = input<string>('#03234B');
}
