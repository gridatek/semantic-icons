...
@Component({
  selector: 'svg[si-affinity-photo-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Affinity Photo</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Affinity Photo icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#4E3188',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiAffinityPhotoIcon {
  ...
  readonly fill = input<string>('#4E3188');
}
