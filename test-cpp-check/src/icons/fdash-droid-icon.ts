...
@Component({
  selector: 'svg[si-f-dash-droid-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>F-Droid</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "F-Droid icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#1976D2',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiFDashDroidIcon {
  ...
  readonly fill = input<string>('#1976D2');
}
