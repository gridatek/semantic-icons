...
@Component({
  selector: 'svg[si-booking-dot-com-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Booking.com</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Booking.com icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#003A9A',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiBookingDotComIcon {
  ...
  readonly fill = input<string>('#003A9A');
}
