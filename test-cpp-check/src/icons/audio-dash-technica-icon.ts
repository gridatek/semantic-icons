...
@Component({
  selector: 'svg[si-audio-dash-technica-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Audio-Technica</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Audio-Technica icon"',
...
export class SiAudioDashTechnicaIcon {
