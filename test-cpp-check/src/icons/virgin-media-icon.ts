...
@Component({
  selector: 'svg[si-virgin-media-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Virgin Media</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Virgin Media icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#ED1A37',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiVirginMediaIcon {
  ...
  readonly fill = input<string>('#ED1A37');
}
