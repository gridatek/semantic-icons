...
@Component({
  selector: 'svg[si-ubuntu-mate-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Ubuntu MATE</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Ubuntu MATE icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#84A454',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiUbuntuMATEIcon {
  ...
  readonly fill = input<string>('#84A454');
}
