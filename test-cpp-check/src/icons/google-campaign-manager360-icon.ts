...
@Component({
  selector: 'svg[si-google-campaign-manager360-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Google Campaign Manager 360</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Google Campaign Manager 360 icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#1E8E3E',
  },
  styles: ``,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SiGoogleCampaignManager360Icon {
  ...
  readonly fill = input<string>('#1E8E3E');
}
