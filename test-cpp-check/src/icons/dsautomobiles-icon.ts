...
@Component({
  selector: 'svg[si-ds-automobiles-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>DS Automobiles</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "DS Automobiles icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#1D1717',
  },
  styles: ``,
...
export class SiDSAutomobilesIcon {
  ...
  readonly fill = input<string>('#1D1717');
}
