...
@Component({
  selector: 'svg[si-dolibarr-icon]',
  standalone: true,
  imports: [],
  template: `
    <svg:title>Dolibarr</svg:title>
    <svg:path
  ...
  host: {
    role: 'img',
    '[attr.aria-label]': 'ariaLabel() || "Dolibarr icon"',
    '[attr.aria-hidden]': 'ariaHidden()',
    '[attr.xmlns]': 'xmlns',
    '[attr.viewBox]': 'viewBox()',
    '[attr.fill]': 'fill()',
    'data-slot': 'icon',
    'data-brand-color': '#263C5C',
  },
  styles: ``,
...
export class SiDolibarrIcon {
  ...
  readonly fill = input<string>('#263C5C');
}
